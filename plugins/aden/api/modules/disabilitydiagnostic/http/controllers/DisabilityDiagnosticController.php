...
namespace AdeN\Api\Modules\DisabilityDiagnostic\Http\Controllers;
...
use AdeN\Api\Modules\DisabilityDiagnostic\DisabilityDiagnosticRepository;
...
class DisabilityDiagnosticController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new DisabilityDiagnosticRepository();
    ...
    public function indexEmployee()
    {
        ...
        try {
            ...
            $result = $this->repository->allEmployee($criteria);
    ...
    public function indexSourceEmployee()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $result = $this->repository->allSourceEmployee($criteria);
