...
namespace AdeN\Api\Modules\ResourceLibrary\Http\Controllers;
...
class ResourceLibraryController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new ResourceLibraryRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'author', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'subject', "operator" => 'like', "value" => $criteria->search),
