...
namespace AdeN\Api\Modules\PositivaFgn\Campus\Professional\Http\Controllers;
...
use AdeN\Api\Modules\PositivaFgn\Campus\Professional\ProfessionalRepository;
...
class ProfessionalController extends BaseController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'campusId', "operator" => 'eq')
            ];
