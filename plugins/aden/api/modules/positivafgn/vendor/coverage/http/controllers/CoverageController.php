...
namespace AdeN\Api\Modules\PositivaFgn\Vendor\Coverage\Http\Controllers;
...
use AdeN\Api\Modules\PositivaFgn\Vendor\Coverage\CoverageRepository;
...
class CoverageController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CoverageRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'town', "operator" => 'like', "value" => $criteria->search)
            ];
