...
class AgentModel extends Model
{
    ...
    {
        return $this->getParameterByValue($this->legalType, "wg_professor_event_xxx");
    }

    public function  getEmergencyContactPhone()
    {
        return $this->getParameterByValue($this->emergencyContactPhone, "wg_professor_event_xxx");
    }
    ...
    {
        return $this->getParameterByValue("IN", "professor_provider_type");
    }
