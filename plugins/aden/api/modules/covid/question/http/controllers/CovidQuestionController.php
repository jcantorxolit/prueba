...
namespace AdeN\Api\Modules\Covid\Question\Http\Controllers;
...
class CovidQuestionController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CovidQuestionRepository();
