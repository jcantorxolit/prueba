...
namespace AdeN\Api\Modules\Config\JobActivityHazardType\Http\Controllers;
...
class ConfigJobActivityHazardTypeController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ConfigJobActivityHazardTypeRepository();
...
array( "field" => 'classificationId', "operator" => 'like', "value" => $criteria->search ),
