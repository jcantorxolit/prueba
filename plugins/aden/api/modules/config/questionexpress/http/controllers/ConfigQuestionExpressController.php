...
namespace AdeN\Api\Modules\Config\QuestionExpress\Http\Controllers;
...
use AdeN\Api\Modules\Config\QuestionExpress\ConfigQuestionExpressRepository;

class ConfigQuestionExpressController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ConfigQuestionExpressRepository();
...
array( "field" => 'classificationExpressId', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'description', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'prority', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'isMaster', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'sort', "operator" => 'like', "value" => $criteria->search ),
