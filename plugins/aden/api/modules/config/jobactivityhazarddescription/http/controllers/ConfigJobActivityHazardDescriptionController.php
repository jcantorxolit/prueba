...
namespace AdeN\Api\Modules\Config\JobActivityHazardDescription\Http\Controllers;
...
class ConfigJobActivityHazardDescriptionController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ConfigJobActivityHazardDescriptionRepository();
...
array( "field" => 'typeId', "operator" => 'like', "value" => $criteria->search ),
