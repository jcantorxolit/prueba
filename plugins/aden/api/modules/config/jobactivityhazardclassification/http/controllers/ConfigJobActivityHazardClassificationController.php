...
namespace AdeN\Api\Modules\Config\JobActivityHazardClassification\Http\Controllers;
...
class ConfigJobActivityHazardClassificationController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ConfigJobActivityHazardClassificationRepository();
