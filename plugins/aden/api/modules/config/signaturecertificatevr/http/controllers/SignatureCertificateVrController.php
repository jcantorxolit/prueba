...
namespace AdeN\Api\Modules\Config\SignatureCertificateVr\Http\Controllers;

use AdeN\Api\Helpers\HttpHelper;
use AdeN\Api\Modules\Config\SignatureCertificateVr\SignatureCertificateVrModel;
use AdeN\Api\Modules\Config\SignatureCertificateVr\SignatureCertificateVrRepository;
use Exception;
use Request;
use Log;
use Response;
...
class SignatureCertificateVrController extends BaseController
{
    ...
    public function upload()
    {
        try {
            ...
            $model = SignatureCertificateVrModel::first();
