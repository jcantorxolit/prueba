...
namespace AdeN\Api\Modules\Config\General\Http\Controllers;
...
class ConfigGeneralController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ConfigGeneralRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'format', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'description', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'isMandatory', "operator" => 'like', "value" => $criteria->search),
