...
namespace AdeN\Api\Modules\Config\ClassificationExpress\Http\Controllers;
...
use AdeN\Api\Modules\Config\ClassificationExpress\ConfigClassificationExpressRepository;

class ConfigClassificationExpressController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ConfigClassificationExpressRepository();
...
array( "field" => 'parentId', "operator" => 'like', "value" => $criteria->search ),
