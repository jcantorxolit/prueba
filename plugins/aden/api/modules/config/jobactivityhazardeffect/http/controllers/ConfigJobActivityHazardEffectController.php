...
namespace AdeN\Api\Modules\Config\JobActivityHazardEffect\Http\Controllers;
...
class ConfigJobActivityHazardEffectController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ConfigJobActivityHazardEffectRepository();
