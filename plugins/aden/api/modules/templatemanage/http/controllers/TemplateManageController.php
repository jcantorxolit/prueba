...
namespace AdeN\Api\Modules\TemplateManage\Http\Controllers;
...
class TemplateManageController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new TemplateManageRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'showAllTemplate', "operator" => 'eq')
            ];

            $criteria = CriteriaHelper::parse($content, $mandatoryFilters);

            $defaultFilters = [
                array("field" => 'template', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'dateof', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'filename', "operator" => 'like', "value" => $criteria->search),
    ...
    public function upload()
    {
        ...
        try {
            $allFiles = Input::file();
            $model = $this->repository->upload($id, $allFiles);
    ...
    public function download()
    {
        ...
        try {
            ...
            return $model->template_file->download();
    ...
    public function publish()
    {
        ...
        try {
            $model = $this->repository->find($id);
            $result = $this->repository->publish($model);
            $this->response->setResult($result);
        } catch (Exception $ex) {
            \Log::error($ex);
            $this->response->setStatuscode(404);
