...
namespace AdeN\Api\Modules\Report\Http\Controllers;
...
use AdeN\Api\Modules\Report\ReportRepository;
...
class ReportController extends BaseController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'module', "operator" => 'eq'),
            ];
            ...
            if ($this->isUserAgent()) {
                $criteria = CriteriaHelper::addMandatoryFilter($criteria, [
                    array("field" => 'allowAgent', "operator" => 'eq', "value" => 1),
                ]);
            } else if ($this->isUserCustomerAdmin() || $this->isUserCustomerAgent()) {
                $criteria = CriteriaHelper::addMandatoryFilter($criteria, [
                    array("field" => 'allowCustomer', "operator" => 'eq', "value" => 1),
                ]);
            }
