...
namespace AdeN\Api\Modules\Customer\ConfigProcessStaging\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ConfigProcessStaging\CustomerConfigProcessStagingRepository;

class CustomerConfigProcessStagingController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigProcessStagingRepository();
