...
namespace AdeN\Api\Modules\Customer\ConfigJobExpress\Http\Controllers;
...
class CustomerConfigJobExpressController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigJobExpressRepository();
