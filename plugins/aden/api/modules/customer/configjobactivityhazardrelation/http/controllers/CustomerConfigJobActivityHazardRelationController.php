...
namespace AdeN\Api\Modules\Customer\ConfigJobActivityHazardRelation\Http\Controllers;
...
class CustomerConfigJobActivityHazardRelationController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigJobActivityHazardRelationRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerConfigJobActivityId', "operator" => 'eq'),
            ];
            ...
            $defaultFilters = [
                ...
                array("field" => 'effect', "operator" => 'like', "value" => $criteria->search),
                ...
                array("field" => 'riskValue', "operator" => 'like', "value" => $criteria->search),
            ];
    ...
    public function indexAvailable()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'jobActivityId', "operator" => 'eq'),
                array("field" => 'customerConfigJobActivityId', "operator" => 'notInRaw'),
            ];
