...
namespace AdeN\Api\Modules\Customer\HealthDamageQualificationSourceNationalDetail;
...
class CustomerHealthDamageQualificationSourceNationalDetailRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerHealthDamageQualificationSourceNationalDetailModel());

        $this->service = new CustomerHealthDamageQualificationSourceNationalDetailService();
    }
    ...
    // AllHealthDamageQualificationSourceNationalDetail

    public function AllHealthDamageQualificationSourceNationalDetail($criteria)
    {
        $urlImages = "uploads/public";

        $this->setColumns([
            "id" => "wg_customer_health_damage_qs_national_board_detail.id",
            ...
            "customerHealthDamageQsNationalId" => "wg_customer_health_damage_qs_national_board_detail.customer_health_damage_qs_national_board_id",
        ]);
        ...
        /* Example relation*/
        $query->join("wg_customer_health_damage_qs_national_board", function ($join) {
            $join->on('wg_customer_health_damage_qs_national_board_detail.customer_health_damage_qs_national_board_id', '=', 'wg_customer_health_damage_qs_national_board.id');
            ...
            $join->on('wg_customer_health_damage_qs_national_board_detail.qualifiedOrigin', '=', 'work_health_damage_entity_qualify_origin.value');
            ...
            $join->on('wg_customer_health_damage_qs_national_board_detail.controversyStatus', '=', 'work_health_damage_controversy_status.value');

        })->leftJoin('wg_disability_diagnostic', 'wg_customer_health_damage_qs_national_board_detail.diagnostic', '=', 'wg_disability_diagnostic.id');
