...
namespace AdeN\Api\Modules\Customer\ArlServiceCost\Http\Controllers;
...
class CustomerArlServiceCostController extends BaseController
{
    use UserSecurity;
    ...
    {
        parent::__construct();
        $this->repository = new CustomerArlServiceCostRepository();
