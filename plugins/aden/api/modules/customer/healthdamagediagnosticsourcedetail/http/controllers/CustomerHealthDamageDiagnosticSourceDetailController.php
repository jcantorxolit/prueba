...
namespace AdeN\Api\Modules\Customer\HealthDamageDiagnosticSourceDetail\Http\Controllers;
...
use AdeN\Api\Modules\Customer\HealthDamageDiagnosticSourceDetail\CustomerHealthDamageDiagnosticSourceDetailRepository;
...
class CustomerHealthDamageDiagnosticSourceDetailController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerHealthDamageDiagnosticSourceDetailRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [                
                array("field" => 'codeCIE10', "operator" => 'like', "value" => $criteria->search),
    ...
    // indexHealthDamageDiagnosticSourceDetail >> AllHealthDamageDiagnosticSourceDetail

    public function indexHealthDamageDiagnosticSourceDetail()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'HealthDamageDiagnosticSourceId', "operator" => 'eq'),
            ];
            ...
            $result = $this->repository->AllHealthDamageDiagnosticSourceDetail($criteria);
