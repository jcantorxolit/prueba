...
namespace AdeN\Api\Modules\Customer\WorkMedicine\Http\Controllers;
...
use AdeN\Api\Modules\Customer\WorkMedicine\CustomerWorkMedicineRepository;
...
class CustomerWorkMedicineController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerWorkMedicineRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [                                
                array("field" => 'examinationDate', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'examinationType', "operator" => 'like', "value" => $criteria->search),
