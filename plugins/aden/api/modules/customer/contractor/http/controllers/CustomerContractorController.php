...
namespace AdeN\Api\Modules\Customer\Contractor\Http\Controllers;
...
class CustomerContractorController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractorRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'contract', "operator" => 'like', "value" => $criteria->search),
    ...
    public function getCustomerRelationships() {
        ...
        try {
            ...
            $defaultFilters = [
                array("field" => 'documentNumber', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'businessName', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'relationship', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'status', "operator" => 'like', "value" => $criteria->search),
            ];
            ...
            $result = $this->repository->getCustomerRelationshipsGrid($criteria);
