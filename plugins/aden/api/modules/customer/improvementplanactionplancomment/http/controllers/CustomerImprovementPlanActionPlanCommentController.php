...
namespace AdeN\Api\Modules\Customer\ImprovementPlanActionPlanComment\Http\Controllers;
...
class CustomerImprovementPlanActionPlanCommentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerImprovementPlanActionPlanCommentRepository();
...
array( "field" => 'customerImprovementPlanActionPlanId', "operator" => 'like', "value" => $criteria->search ),
