...
namespace AdeN\Api\Modules\Customer\ManagementDetailDocument\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ManagementDetailDocument\CustomerManagementDetailDocumentRepository;

class CustomerManagementDetailDocumentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerManagementDetailDocumentRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'managementDetailId', "operator" => 'eq'),                
