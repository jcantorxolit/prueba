...
class CustomerOccupationalInvestigationDocumentModel extends Model
{
    const CLASS_NAME = "AdeN\Api\Modules\Customer\OccupationalInvestigationAlDocument\CustomerOccupationalInvestigationDocumentModel";
     ...
     */
    protected $table = "wg_customer_occupational_investigation_al_document";
