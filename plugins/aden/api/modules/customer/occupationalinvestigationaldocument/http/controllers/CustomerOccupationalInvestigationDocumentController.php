...
namespace AdeN\Api\Modules\Customer\OccupationalInvestigationAlDocument\Http\Controllers;
...
use AdeN\Api\Modules\Customer\OccupationalInvestigationAlDocument\CustomerOccupationalInvestigationDocumentRepository;

class CustomerOccupationalInvestigationDocumentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerOccupationalInvestigationDocumentRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [                
                array("field" => 'customerOccupationalInvestigationId', "operator" => 'eq'),
