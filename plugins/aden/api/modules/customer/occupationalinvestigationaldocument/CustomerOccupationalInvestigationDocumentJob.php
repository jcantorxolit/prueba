...
class CustomerOccupationalInvestigationDocumentJob
{
    protected $service;
    ...
    public function fire($job, $data)
    {
        ...
        $excelFilename = 'GUIA_DOCUMENTOS_INVESTIGACIONES_AT_' . Carbon::now()->timestamp;
        ExportHelper::excelStorage($excelFilename, 'GUIA', $data['excel']);

        $zipFilename = 'DOCUMENTOS_DOCUMENTOS_INVESTIGACIONES_AT_' . Carbon::now()->timestamp . '.zip';
    ...
    {               
        $criteria->module = "DOCUMENTOS INVESTIGACIONES_AT";
        $criteria->url = $url;        
