...
namespace AdeN\Api\Modules\Customer\UnsafeActObservation\Http\Controllers;
...
use AdeN\Api\Modules\Customer\UnsafeActObservation\CustomerUnsafeActObservationRepository;
...
class CustomerUnsafeActObservationController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerUnsafeActObservationRepository();
...
array( "field" => 'customerUnsafeActId', "operator" => 'like', "value" => $criteria->search ),
