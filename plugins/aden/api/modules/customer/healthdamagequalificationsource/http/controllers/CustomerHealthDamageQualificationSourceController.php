...
namespace AdeN\Api\Modules\Customer\HealthDamageQualificationSource\Http\Controllers;
...
use AdeN\Api\Modules\Customer\HealthDamageQualificationSource\CustomerHealthDamageQualificationSourceRepository;
...
class CustomerHealthDamageQualificationSourceController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerHealthDamageQualificationSourceRepository();
    ...
    // indexHealthDamageQualificationSource >> AllHealthDamageQualificationSource

    public function indexHealthDamageQualificationSource()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $result = $this->repository->AllHealthDamageQualificationSource($criteria);
