...
namespace AdeN\Api\Modules\Customer\ContractSafetyInspectionListItem\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ContractSafetyInspectionListItem\CustomerContractSafetyInspectionListItemRepository;
use Carbon\Carbon;

class CustomerContractSafetyInspectionListItemController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractSafetyInspectionListItemRepository();
    ...
    public function index()
    {
        ...
        try {
            $mandatoryFilters = [
                array("field" => 'customerContractorId', "operator" => 'eq'),
                array("field" => 'customerSafetyInspectionConfigListId', "operator" => 'eq'),
    ...
    public function indexQuestion()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerContractorId', "operator" => 'eq'),
                array("field" => 'customerSafetyInspectionConfigListId', "operator" => 'eq'),
                array("field" => 'groupId', "operator" => 'eq'),
                array("field" => 'period', "operator" => 'eq'),
            ];
    ...
    public function indexDangerousness()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerContractorId', "operator" => 'eq'),
                array("field" => 'customerSafetyInspectionListId', "operator" => 'eq'),
                array("field" => 'period', "operator" => 'eq'),
            ];
            ...
            $result = $this->repository->allDangerousness($criteria);
    ...
    public function indexAction()
    {
        ...
        try {
            ...
            $result = $this->repository->allAction($criteria);
    ...
    public function batch()
    {
        ...
        try {
            $entity = HttpHelper::parse($content, true);
            $result = $this->repository->batch($entity);
            $this->response->setResult($result);
        } catch (\Exception $ex) {
            Log::error($ex);
            $this->response->setStatuscode(500);
