...
namespace AdeN\Api\Modules\Customer\SafetyInspectionListItem;
...
class CustomerSafetyInspectionListItemRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerSafetyInspectionListItemModel());
    ...
    public function all($criteria)
    {
        $this->setColumns([
            ...
            "customerSafetyInspectionId" => "category.customerSafetyInspectionId",
            "sort" => "category.sort"
        ]);
        ...
        $qDetail->join('wg_customer_safety_inspection_list', function ($join) {
        ...
        })->join('wg_customer_safety_inspection_list_item', function ($join) {
            $join->on('wg_customer_safety_inspection_list_item.customer_safety_inspection_list_id', '=', 'wg_customer_safety_inspection_list.id');
            $join->on('wg_customer_safety_inspection_list_item.customer_safety_inspection_config_list_item_id', '=', 'wg_customer_safety_inspection_config_list_item.id');
            ...
            $join->on('dangerousness.id', '=', 'wg_customer_safety_inspection_list_item.dangerousnessValue');
            ...
            $join->on('priority.id', '=', 'wg_customer_safety_inspection_list_item.priorityValue');
            ...
            $join->on('existingControl.id', '=', 'wg_customer_safety_inspection_list_item.existingControlValue');

        })->select(
            'wg_customer_safety_inspection_list_item.*',
        ...
        if ($criteria != null) {
            if ($criteria->mandatoryFilters != null) {
                foreach ($criteria->mandatoryFilters as $item) {
                    if ($item->field == 'customerSafetyInspectionId') {
                        $qDetail->where(SqlHelper::getPreparedField('wg_customer_safety_inspection.id'), SqlHelper::getOperator($item->operator), SqlHelper::getPreparedData($item), 'and');
                    }
                }
            }
        }
        ...
        $qSub->join('wg_customer_safety_inspection_list', function ($join) {
            $join->on('wg_customer_safety_inspection_list.customer_safety_inspection_id', '=', 'wg_customer_safety_inspection.id');
            ...
            $join->on('wg_customer_safety_inspection_list_item.customer_safety_inspection_config_list_item_id', '=', 'detail.customer_safety_inspection_config_list_item_id');
            $join->on('wg_customer_safety_inspection_list_item.customer_safety_inspection_list_id', '=', 'detail.customer_safety_inspection_list_id');
    ...
    {
        $this->setColumns([
            "id" => "wg_customer_safety_inspection_list_item.id",
            ...
            "customerSafetyInspectionId" => "wg_customer_safety_inspection.id AS customerSafetyInspectionId",
            "customerSafetyInspectionListId" => "wg_customer_safety_inspection_list_item.customer_safety_inspection_list_id as customerSafetyInspectionListId",
            ...
            "customerSafetyInspectionConfigListItemId" => "wg_customer_safety_inspection_list_item.customer_safety_inspection_config_list_item_id as customerSafetyInspectionConfigListItemId",
        ]);
        ...
        $query->join('wg_customer_safety_inspection_config_list_item', function ($join) {
            $join->on('wg_customer_safety_inspection_config_list_item.id', '=', 'wg_customer_safety_inspection_list_item.customer_safety_inspection_config_list_item_id');
            ...
            $join->on('wg_customer_safety_inspection_list.id', '=', 'wg_customer_safety_inspection_list_item.customer_safety_inspection_list_id');
            ...
            $join->on('wg_customer_safety_inspection.id', '=', 'wg_customer_safety_inspection_list.customer_safety_inspection_id');

        })->leftjoin(DB::raw(SystemParameter::getRelationTable('wg_safety_inspection_action')), function ($join) {
            $join->on('wg_customer_safety_inspection_list_item.action', '=', 'wg_safety_inspection_action.value');
    ...
    public function allDangerousness($criteria)
    {
        ...
        $query->join('wg_customer_safety_inspection_config_list_item', function ($join) {
            ...
            'wg_customer_safety_inspection_list_item.dangerousnessValue',
            'wg_customer_safety_inspection.id'
        );
    ...
    public function allAction($criteria)
    {
        ...
        $query->join('wg_customer_safety_inspection_config_list_item', function ($join) {
            ...
            'wg_customer_safety_inspection_config_list.id',
            'wg_customer_safety_inspection_list_item.action',
            'wg_customer_safety_inspection.id'
        );
