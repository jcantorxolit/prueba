...
namespace AdeN\Api\Modules\Customer\SafetyInspectionListItem\Http\Controllers;
...
use AdeN\Api\Modules\Customer\SafetyInspectionListItem\CustomerSafetyInspectionListItemRepository;
use Carbon\Carbon;
...
class CustomerSafetyInspectionListItemController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerSafetyInspectionListItemRepository();
    ...
    public function index()
    {
        ...
        try {
            $mandatoryFilters = [
                array("field" => 'customerSafetyInspectionId', "operator" => 'eq'),
