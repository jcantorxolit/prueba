...
namespace AdeN\Api\Modules\Customer\EvaluationMinimumStandardItem\Http\Controllers;
...
use AdeN\Api\Modules\Customer\EvaluationMinimumStandardItem\CustomerEvaluationMinimumStandardItemRepository;
...
class CustomerEvaluationMinimumStandardItemController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerEvaluationMinimumStandardItemRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'evaluationMinimumStandardId', "operator" => 'eq'),
