...
namespace AdeN\Api\Modules\Customer\Tracking\Http\Controllers;
...
use AdeN\Api\Modules\Customer\Tracking\CustomerTrackingRepository;

class CustomerTrackingController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerTrackingRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                ...
                array("field" => 'isVisible', "operator" => 'eq')
            ];
            ...
            $defaultFilters = [                
                ...
                array("field" => 'eventDateTime', "operator" => 'like', "value" => $criteria->search),
    ...
    public function indexComment()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerTrackingId', "operator" => 'eq'),                
            ];
            ...
            $result = $this->repository->allComment($criteria);
