...
namespace AdeN\Api\Modules\Customer\Matrix\Http\Controllers;

use AdeN\Api\Classes\BaseController;
use AdeN\Api\Helpers\CriteriaHelper;
use AdeN\Api\Helpers\HttpHelper;
use AdeN\Api\Modules\Customer\Matrix\CustomerMatrixRepository;
use Exception;
...
class CustomerMatrixController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerMatrixRepository();
