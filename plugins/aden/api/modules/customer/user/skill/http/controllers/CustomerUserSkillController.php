...
namespace AdeN\Api\Modules\Customer\User\Skill\Http\Controllers;
...
class CustomerUserSkillController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerUserSkillRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'customerUserId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'skill', "operator" => 'like', "value" => $criteria->search),
