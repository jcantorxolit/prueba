...
namespace AdeN\Api\Modules\Customer\ContractSafetyInspectionListItemComment\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ContractSafetyInspectionListItemComment\CustomerContractSafetyInspectionListItemCommentRepository;

class CustomerContractSafetyInspectionListItemCommentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractSafetyInspectionListItemCommentRepository();
