...
class CustomerContractDetailDocumentModel extends Model
{
    use CamelCasing;

    const CLASS_NAME = "Wgroup\CustomerContractDetailDocument\CustomerContractDetailDocument";

    /**
     * @var string The database table used by the model.
     */
    protected $table = "wg_customer_contract_detail_document";
