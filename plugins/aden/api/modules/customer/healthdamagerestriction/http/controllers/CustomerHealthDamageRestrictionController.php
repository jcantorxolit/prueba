...
namespace AdeN\Api\Modules\Customer\HealthDamageRestriction\Http\Controllers;
...
use AdeN\Api\Modules\Customer\HealthDamageRestriction\CustomerHealthDamageRestrictionRepository;
...
class CustomerHealthDamageRestrictionController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerHealthDamageRestrictionRepository();
    ...
    // indexHealthDamageRestriction >> AllHealthDamageRestriction

    public function indexHealthDamageRestriction()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $result = $this->repository->AllHealthDamageRestriction($criteria);
