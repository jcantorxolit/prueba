...
namespace AdeN\Api\Modules\Customer\ContractDetailComment\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ContractDetailComment\CustomerContractDetailCommentRepository;

class CustomerContractDetailCommentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractDetailCommentRepository();
