...
namespace AdeN\Api\Modules\Customer\ContractDetailComment;
...
class CustomerContractDetailCommentRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerContractDetailCommentModel());

        $this->service = new CustomerContractDetailCommentService();
    }
