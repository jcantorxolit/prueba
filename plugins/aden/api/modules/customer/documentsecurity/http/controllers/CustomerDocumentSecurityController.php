...
namespace AdeN\Api\Modules\Customer\DocumentSecurity\Http\Controllers;
...
use AdeN\Api\Modules\Customer\DocumentSecurity\CustomerDocumentSecurityRepository;



class CustomerDocumentSecurityController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerDocumentSecurityRepository();
    ...
    public function showRelation()
    {
        ...
        try {
            $result = $this->repository->parseModelWithRelations($this->repository->findRelation($customerId, $type, $origin));
            $this->response->setResult($result);
        } catch (Exception $ex) {
            $this->response->setResult(0);
            $this->response->setStatuscode(500);
