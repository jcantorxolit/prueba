...
class CustomerHealthDamageAdministrativeProcessRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerHealthDamageAdministrativeProcessModel());
    ...
    // AllHealthDamageAdministrativeProcess

    public function AllHealthDamageAdministrativeProcess($criteria)
    {
        $urlImages = "uploads/public";

        $this->setColumns([
            "id" => "wg_customer_health_damage_administrative_process.id",
            "createdAt" => "wg_customer_health_damage_administrative_process.created_at",
            "documentNumber" => "wg_employee.documentNumber",
            "firstName" => "wg_employee.firstName",
            "lastName" => "wg_employee.lastName",
            "name" => "wg_customer_config_job_data.name AS occupation",
        ...
        $query->join("wg_customer_employee", function ($join) {
            $join->on('wg_customer_health_damage_administrative_process.customer_employee_id', '=', 'wg_customer_employee.id');
            ...
            $join->on('wg_customer_health_damage_administrative_process.arl', '=', 'wg_arl.value');
