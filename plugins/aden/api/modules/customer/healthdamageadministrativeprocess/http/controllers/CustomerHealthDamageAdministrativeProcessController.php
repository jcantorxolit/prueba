...
namespace AdeN\Api\Modules\Customer\HealthDamageAdministrativeProcess\Http\Controllers;
...
use AdeN\Api\Modules\Customer\HealthDamageAdministrativeProcess\CustomerHealthDamageAdministrativeProcessRepository;
...
class CustomerHealthDamageAdministrativeProcessController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerHealthDamageAdministrativeProcessRepository();
    ...
    // indexHealthDamageAdministrativeProcess >> AllHealthDamageAdministrativeProcess

    public function indexHealthDamageAdministrativeProcess()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $result = $this->repository->AllHealthDamageAdministrativeProcess($criteria);
