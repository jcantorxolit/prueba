...
namespace AdeN\Api\Modules\Customer\SafetyInspectionList\Http\Controllers;
...
use AdeN\Api\Modules\Customer\SafetyInspectionList\CustomerSafetyInspectionListRepository;

class CustomerSafetyInspectionListController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerSafetyInspectionListRepository();
