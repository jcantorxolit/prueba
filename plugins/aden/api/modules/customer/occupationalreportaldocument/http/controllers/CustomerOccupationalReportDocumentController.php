...
namespace AdeN\Api\Modules\Customer\OccupationalReportAlDocument\Http\Controllers;
...
use AdeN\Api\Modules\Customer\OccupationalReportAlDocument\CustomerOccupationalReportDocumentRepository;

class CustomerOccupationalReportDocumentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerOccupationalReportDocumentRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [                
                array("field" => 'CustomerOccupationalReportId', "operator" => 'eq'),
