...
class CustomerOccupationalReportDocumentModel extends Model
{
    const CLASS_NAME = "AdeN\Api\Modules\Customer\OccupationalReportAlDocument\CustomerOccupationalReportDocumentModel";
     ...
     */
    protected $table = "wg_customer_occupational_report_al_document";
