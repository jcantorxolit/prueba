...
namespace AdeN\Api\Modules\Customer\ContractSafetyInspectionListObservation\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ContractSafetyInspectionListObservation\CustomerContractSafetyInspectionListObservationRepository;

class CustomerContractSafetyInspectionListObservationController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractSafetyInspectionListObservationRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                array("field" => 'list', "operator" => 'like', "value" => $criteria->search),
