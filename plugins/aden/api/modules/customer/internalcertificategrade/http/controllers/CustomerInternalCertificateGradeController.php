...
namespace AdeN\Api\Modules\Customer\InternalCertificateGrade\Http\Controllers;
...
class CustomerInternalCertificateGradeController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerInternalCertificateGradeRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                ...
                array("field" => 'statusCode', "operator" => 'eq'),
                array("field" => 'programId', "operator" => 'eq'),
                array("field" => 'agentId', "operator" => 'eq'),
                array("field" => 'location', "operator" => 'eq'),
                array("field" => 'startDate', "operator" => 'gte'),
                array("field" => 'endDate', "operator" => 'lte'),
            ];
            ...
            $defaultFilters = [                                                
                ...
                array("field" => 'registered', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'quota', "operator" => 'like', "value" => $criteria->search),
