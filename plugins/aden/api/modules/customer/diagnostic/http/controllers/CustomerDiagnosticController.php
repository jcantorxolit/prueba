...
namespace AdeN\Api\Modules\Customer\Diagnostic\Http\Controllers;
...
class CustomerDiagnosticController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerDiagnosticRepository();
    ...
    public function indexSummary()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerDiagnosticId', "operator" => 'eq'),
            ];
