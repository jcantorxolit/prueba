...
namespace AdeN\Api\Modules\Customer\ConfigQuestionExpressHistorical\Http\Controllers;
...
class CustomerConfigQuestionExpressHistoricalController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigQuestionExpressHistoricalRepository();
