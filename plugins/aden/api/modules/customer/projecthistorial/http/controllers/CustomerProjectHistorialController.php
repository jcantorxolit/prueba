...
namespace AdeN\Api\Modules\Customer\ProjectHistorial\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ProjectHistorial\CustomerProjectHistorialRepository;

class CustomerProjectHistorialController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerProjectHistorialRepository();
