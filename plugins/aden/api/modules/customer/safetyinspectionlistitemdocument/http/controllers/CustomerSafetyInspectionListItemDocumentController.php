...
namespace AdeN\Api\Modules\Customer\SafetyInspectionListItemDocument\Http\Controllers;
...
use AdeN\Api\Modules\Customer\SafetyInspectionListItemDocument\CustomerSafetyInspectionListItemDocumentRepository;
...
class CustomerSafetyInspectionListItemDocumentController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerSafetyInspectionListItemDocumentRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerSafetyInspectionListItemId', "operator" => 'eq'),                        
            ];
