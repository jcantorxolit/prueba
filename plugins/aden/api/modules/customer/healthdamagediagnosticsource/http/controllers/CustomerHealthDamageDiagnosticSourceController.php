...
namespace AdeN\Api\Modules\Customer\HealthDamageDiagnosticSource\Http\Controllers;
...
use AdeN\Api\Modules\Customer\HealthDamageDiagnosticSource\CustomerHealthDamageDiagnosticSourceRepository;
...
class CustomerHealthDamageDiagnosticSourceController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerHealthDamageDiagnosticSourceRepository();
    ...
    // indexHealthDamageDiagnosticSource >> AllHealthDamageDiagnosticSource

    public function indexHealthDamageDiagnosticSource()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $result = $this->repository->AllHealthDamageDiagnosticSource($criteria);
