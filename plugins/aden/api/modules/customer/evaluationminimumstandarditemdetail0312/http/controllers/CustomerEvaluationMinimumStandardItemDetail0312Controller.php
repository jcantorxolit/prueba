...
namespace AdeN\Api\Modules\Customer\EvaluationMinimumStandardItemDetail0312\Http\Controllers;
...
class CustomerEvaluationMinimumStandardItemDetail0312Controller extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerEvaluationMinimumStandardItemDetail0312Repository();
...
array( "field" => 'customerEvaluationMinimumStandardItemId', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'minimumStandardItemDetailId', "operator" => 'like', "value" => $criteria->search ),
