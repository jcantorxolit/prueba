...
namespace AdeN\Api\Modules\Customer\ConfigMacroProcess\Http\Controllers;
...
class CustomerConfigMacroProcessController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigMacroProcessRepository();
