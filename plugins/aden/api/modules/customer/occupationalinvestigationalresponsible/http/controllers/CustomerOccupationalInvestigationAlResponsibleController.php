...
namespace AdeN\Api\Modules\Customer\OccupationalInvestigationAlResponsible\Http\Controllers;
...
class CustomerOccupationalInvestigationAlResponsibleController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerOccupationalInvestigationAlResponsibleRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [                
                ...
                array("field" => 'entitytype', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'entityid', "operator" => 'like', "value" => $criteria->search),
                ...
                array("field" => 'role', "operator" => 'like', "value" => $criteria->search),
    ...
    public function showRelation()
    {
        ...
        try {
            $result = $this->repository->findRelation($id, $type, $customerId);
            $this->response->setResult($result);
        } catch (Exception $ex) {
            $this->response->setResult(0);
            $this->response->setStatuscode(500);
