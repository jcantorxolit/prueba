...
class CustomerSafetyInspectionRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerSafetyInspectionModel());
    ...
    {
        $this->setColumns([
            "id" => "wg_customer_safety_inspection.id",
    ...
    {
        return $this->service->getPrepareList($customerContractorId);
    }

    public function getHeaderFields($customerContractorId)
    {
        return $this->service->getHeaderFields($customerContractorId);
    }
}
