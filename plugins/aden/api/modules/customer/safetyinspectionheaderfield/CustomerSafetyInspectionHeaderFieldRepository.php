...
namespace AdeN\Api\Modules\Customer\SafetyInspectionHeaderField;
...
class CustomerSafetyInspectionHeaderFieldRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerSafetyInspectionHeaderFieldModel());
    ...
    {
        $this->setColumns([
            "id" => "wg_customer_safety_inspection_header_field.id",
            "user" => "users.name AS user",
            "createdAt" => "wg_customer_safety_inspection_header_field.created_at",
        ]);
        ...
        $query->leftjoin('users', function ($join) {
            $join->on('users.id', '=', 'wg_customer_safety_inspection_header_field.created_by');
    ...
    public function insertOrUpdate($entity)
    {
        ...
        $entityModel->customer_safety_inspection_config_header_field_id = $entity->customerSafetyInspectionConfigHeaderFieldId;
