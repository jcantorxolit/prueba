...
namespace AdeN\Api\Modules\Customer\ConfigActivityExpress\Http\Controllers;
...
class CustomerConfigActivityExpressController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigActivityExpressRepository();
