...
namespace AdeN\Api\Modules\Customer\ConfigJobExpressRelation\Http\Controllers;
...
class CustomerConfigJobExpressRelationController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigJobExpressRelationRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'processExpressRelationId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'jobExpressId', "operator" => 'like', "value" => $criteria->search),
