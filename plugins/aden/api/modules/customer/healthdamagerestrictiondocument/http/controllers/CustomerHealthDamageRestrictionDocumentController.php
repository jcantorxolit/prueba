...
namespace AdeN\Api\Modules\Customer\HealthDamageRestrictionDocument\Http\Controllers;
...
use AdeN\Api\Modules\Customer\HealthDamageRestrictionDocument\CustomerHealthDamageRestrictionDocumentRepository;
...
class CustomerHealthDamageRestrictionDocumentController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerHealthDamageRestrictionDocumentRepository();
    ...
    // indexHealthDamageRestrictionDocument >> AllHealthDamageRestrictionDocument

    public function indexHealthDamageRestrictionDocument()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $result = $this->repository->AllHealthDamageRestrictionDocument($criteria);
