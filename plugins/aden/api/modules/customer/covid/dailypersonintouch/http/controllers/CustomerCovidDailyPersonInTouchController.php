...
namespace AdeN\Api\Modules\Customer\Covid\DailyPersonInTouch\Http\Controllers;
...
use AdeN\Api\Modules\Customer\Covid\DailyPersonInTouch\CustomerCovidDailyPersonInTouchRepository;

class CustomerCovidDailyPersonInTouchController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerCovidDailyPersonInTouchRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'person', "operator" => 'like', "value" => $criteria->search),
