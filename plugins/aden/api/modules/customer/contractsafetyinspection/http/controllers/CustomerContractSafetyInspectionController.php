...
namespace AdeN\Api\Modules\Customer\ContractSafetyInspection\Http\Controllers;
...
class CustomerContractSafetyInspectionController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractSafetyInspectionRepository();
