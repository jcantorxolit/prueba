...
class CustomerContractSafetyInspectionRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerContractSafetyInspectionModel());

        $this->service = new CustomerContractSafetyInspectionService();
    }
    ...
    {
        $this->setColumns([
            "id" => "wg_customer_contractor_safety_inspection.id",
    ...
    {
        return $this->service->getPeriodList($customerContractorId);
    }
