...
namespace AdeN\Api\Modules\Customer\ReportCalculatedField;
...
class CustomerReportCalculatedFieldRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerReportCalculatedFieldModel());

        $this->service = new CustomerReportCalculatedFieldService();
    }
