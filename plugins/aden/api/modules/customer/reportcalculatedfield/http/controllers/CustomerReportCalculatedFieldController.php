...
namespace AdeN\Api\Modules\Customer\ReportCalculatedField\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ReportCalculatedField\CustomerReportCalculatedFieldRepository;





class CustomerReportCalculatedFieldController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerReportCalculatedFieldRepository();
