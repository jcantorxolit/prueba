...
namespace AdeN\Api\Modules\Customer\ImprovementPlanComment\Http\Controllers;
...
class CustomerImprovementPlanCommentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerImprovementPlanCommentRepository();
...
array( "field" => 'customerImprovementPlanId', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'reason', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'oldStatus', "operator" => 'like', "value" => $criteria->search ),
