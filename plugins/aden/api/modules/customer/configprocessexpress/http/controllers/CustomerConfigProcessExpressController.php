...
namespace AdeN\Api\Modules\Customer\ConfigProcessExpress\Http\Controllers;
...
class CustomerConfigProcessExpressController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigProcessExpressRepository();
