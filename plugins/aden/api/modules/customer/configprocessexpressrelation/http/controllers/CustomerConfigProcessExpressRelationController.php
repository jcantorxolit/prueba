...
namespace AdeN\Api\Modules\Customer\ConfigProcessExpressRelation\Http\Controllers;
...
class CustomerConfigProcessExpressRelationController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigProcessExpressRelationRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'processExpressId', "operator" => 'like', "value" => $criteria->search),
    ...
    public function copy()
    {
        ...
        try {
            $entity = HttpHelper::parse($content, true);
            $result = $this->repository->copy($entity);
            $this->response->setResult($result);
        } catch (\Exception $ex) {
            Log::error($ex);
            $this->response->setStatuscode(500);
