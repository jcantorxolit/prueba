...
namespace AdeN\Api\Modules\Customer\SafetyInspectionListItemComment\Http\Controllers;
...
use AdeN\Api\Modules\Customer\SafetyInspectionListItemComment\CustomerSafetyInspectionListItemCommentRepository;

class CustomerSafetyInspectionListItemCommentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerSafetyInspectionListItemCommentRepository();
