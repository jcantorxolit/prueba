...
namespace AdeN\Api\Modules\Customer\VrGeneralObservation\Http\Controllers;
...
use AdeN\Api\Modules\Customer\VrGeneralObservation\CustomerVrGeneralObservationRepository;

class CustomerVrGeneralObservationController extends BaseController
{
    use UserSecurity;
    ...
    {
        parent::__construct();
        $this->repository = new CustomerVrGeneralObservationRepository();
