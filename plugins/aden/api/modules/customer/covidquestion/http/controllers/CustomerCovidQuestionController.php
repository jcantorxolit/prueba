...
namespace AdeN\Api\Modules\Customer\CovidQuestion\Http\Controllers;
...
class CustomerCovidQuestionController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerCovidQuestionRepository();
...
array( "field" => 'wgCustomerCovidId', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'wgCovidQuestionId', "operator" => 'like', "value" => $criteria->search ),
