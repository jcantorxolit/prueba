...
class CustomerContractDetailService extends BaseService
{
    ...
    {
        $query = DB::table('wg_customer_contract_detail');
        ...
        $query->join('wg_customer_contractor', function ($join) {
            ...
            DB::raw('wg_customer_contract_detail.year AS item'),
            DB::raw('wg_customer_contract_detail.year AS value')
        )->where('wg_customer_contract_detail.contractor_id', '=', $contractorId)
        ->groupBy('wg_customer_contract_detail.year')
        ->orderBy('wg_customer_contract_detail.year', 'desc');
    ...
    public function getPeriodList($contractorId)
    {
        ...
        $query->join('wg_customer_contractor', function ($join) {
            ...
            DB::raw('wg_customer_contract_detail.period AS item'),
            DB::raw('wg_customer_contract_detail.period AS value')
        )->where('wg_customer_contract_detail.contractor_id', '=', $contractorId)
        ->groupBy('wg_customer_contract_detail.period')
        ->orderBy('wg_customer_contract_detail.period', 'desc');
