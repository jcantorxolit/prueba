...
namespace AdeN\Api\Modules\Customer\ConfigProcess\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ConfigProcess\CustomerConfigProcessRepository;

class CustomerConfigProcessController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigProcessRepository();
