...
namespace AdeN\Api\Modules\Customer\ManagementProgram\Http\Controllers;
...
class CustomerManagementProgramController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerManagementProgramRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'managementId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'programId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'programEconomicSectorId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'customerWorkplaceId', "operator" => 'like', "value" => $criteria->search),
