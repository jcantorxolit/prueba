...
namespace AdeN\Api\Modules\Customer\HealthDamageQualificationSourceOpportunityDetail;
...
class CustomerHealthDamageQualificationSourceOpportunityDetailRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerHealthDamageQualificationSourceOpportunityDetailModel());

        $this->service = new CustomerHealthDamageQualificationSourceOpportunityDetailService();
    }
    ...
    // AllHealthDamageQualificationSourceOpportunityDetail

    public function AllHealthDamageQualificationSourceOpportunityDetail($criteria)
    {
        $urlImages = "uploads/public";

        $this->setColumns([
            "id" => "wg_customer_health_damage_qs_first_opportunity_detail.id",
            ...
            "customerHealthDamageQsFirstOpportunityId" => "wg_customer_health_damage_qs_first_opportunity_detail.customer_health_damage_qs_first_opportunity_id",
        ]);
        ...
        /* Example relation*/
        $query->join("wg_customer_health_damage_qs_first_opportunity", function ($join) {
            $join->on('wg_customer_health_damage_qs_first_opportunity_detail.customer_health_damage_qs_first_opportunity_id', '=', 'wg_customer_health_damage_qs_first_opportunity.id');
            ...
            $join->on('wg_customer_health_damage_qs_first_opportunity_detail.qualifiedOrigin', '=', 'work_health_damage_entity_qualify_origin.value');
            ...
            $join->on('wg_customer_health_damage_qs_first_opportunity_detail.controversyStatus', '=', 'work_health_damage_controversy_status.value');

        })->leftJoin('wg_disability_diagnostic', 'wg_customer_health_damage_qs_first_opportunity_detail.diagnostic', '=', 'wg_disability_diagnostic.id');
