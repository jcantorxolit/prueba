...
namespace AdeN\Api\Modules\Customer\ManacleEmployee\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ManacleEmployee\CustomerManacleEmployeeRepository;

class CustomerManacleEmployeeController extends BaseController
{
    use UserSecurity;
    ...
    {
        parent::__construct();
        $this->repository = new CustomerManacleEmployeeRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'manacleNumber', "operator" => 'like', "value" => $criteria->search),
