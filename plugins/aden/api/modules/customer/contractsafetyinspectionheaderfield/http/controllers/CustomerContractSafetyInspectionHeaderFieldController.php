...
namespace AdeN\Api\Modules\Customer\ContractSafetyInspectionHeaderField\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ContractSafetyInspectionHeaderField\CustomerContractSafetyInspectionHeaderFieldRepository;

class CustomerContractSafetyInspectionHeaderFieldController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractSafetyInspectionHeaderFieldRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerContractorSafetyInspectionListItemId', "operator" => 'eq'),
            ];
