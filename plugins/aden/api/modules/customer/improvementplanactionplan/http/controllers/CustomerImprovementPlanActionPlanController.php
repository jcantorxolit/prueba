...
namespace AdeN\Api\Modules\Customer\ImprovementPlanActionPlan\Http\Controllers;
...
class CustomerImprovementPlanActionPlanController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerImprovementPlanActionPlanRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                ...
                array("field" => 'customerImprovementPlanId', "operator" => 'eq'),
                array("field" => 'customerImprovementPlanCauseRootCauseId', "operator" => 'eq'),
            ];
            ...
            $defaultFilters = [
                ...
                array("field" => 'entry', "operator" => 'like', "value" => $criteria->search),
