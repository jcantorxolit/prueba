...
namespace AdeN\Api\Modules\Customer\AbsenteeismDisabilityDayCharged\Http\Controllers;
...
class CustomerAbsenteeismDisabilityDayChargedController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerAbsenteeismDisabilityDayChargedRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerDisabilityId', "operator" => 'eq'),
                array("field" => 'isDeleted', "operator" => 'eq'),
            ];
            ...
            $defaultFilters = [
                ...
                array("field" => 'part', "operator" => 'like', "value" => $criteria->search),
            ...
            $this->response->setExtra($result["dayCharged"]);
        } catch (Exception $ex) {
            Log::error($ex);
