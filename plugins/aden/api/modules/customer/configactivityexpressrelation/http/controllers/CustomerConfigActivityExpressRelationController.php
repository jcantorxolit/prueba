...
namespace AdeN\Api\Modules\Customer\ConfigActivityExpressRelation\Http\Controllers;
...
class CustomerConfigActivityExpressRelationController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigActivityExpressRelationRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'jobExpressRelationId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'activityExpressId', "operator" => 'like', "value" => $criteria->search),
