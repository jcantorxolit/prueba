...
namespace AdeN\Api\Modules\Customer\HealthDamageQualificationSourceJusticeDetail;
...
class CustomerHealthDamageQualificationSourceJusticeDetailRepository extends BaseRepository
{
    public function __construct()
    {
        parent::__construct(new CustomerHealthDamageQualificationSourceJusticeDetailModel());
    ...
    // AllHealthDamageQualificationSourceJusticeDetail

    public function AllHealthDamageQualificationSourceJusticeDetail($criteria)
    {
        $urlImages = "uploads/public";

        $this->setColumns([
            "id" => "wg_customer_health_damage_qs_labor_justice_detail.id",
            ...
            "customerHealthDamageQsId" => "wg_customer_health_damage_qs_labor_justice_detail.customer_health_damage_qs_labor_justice_id",
        ]);
        ...
        })->leftJoin('wg_disability_diagnostic', 'wg_customer_health_damage_qs_labor_justice_detail.diagnostic', '=', 'wg_disability_diagnostic.id');
