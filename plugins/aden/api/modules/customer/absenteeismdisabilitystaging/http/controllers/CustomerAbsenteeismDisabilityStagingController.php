...
namespace AdeN\Api\Modules\Customer\AbsenteeismDisabilityStaging\Http\Controllers;
...
use AdeN\Api\Modules\Customer\AbsenteeismDisabilityStaging\CustomerAbsenteeismDisabilityStagingRepository;

class CustomerAbsenteeismDisabilityStagingController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerAbsenteeismDisabilityStagingRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'disabilityParent', "operator" => 'like', "value" => $criteria->search),
                ...
                array("field" => 'bodyPart', "operator" => 'like', "value" => $criteria->search),
