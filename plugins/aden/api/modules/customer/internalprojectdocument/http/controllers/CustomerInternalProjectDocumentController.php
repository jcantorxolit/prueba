...
namespace AdeN\Api\Modules\Customer\InternalProjectDocument\Http\Controllers;
...
use AdeN\Api\Modules\Customer\InternalProjectDocument\CustomerInternalProjectDocumentRepository;
class CustomerInternalProjectDocumentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerInternalProjectDocumentRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerInternalProjectId', "operator" => 'eq'),                
