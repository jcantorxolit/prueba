...
namespace AdeN\Api\Modules\Customer\InternalCertificateProgram\Http\Controllers;
...
use AdeN\Api\Modules\Customer\InternalCertificateProgram\CustomerInternalCertificateProgramRepository;
...
class CustomerInternalCertificateProgramController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerInternalCertificateProgramRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'capacity', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'hourDuration', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'authorizationResolution', "operator" => 'like', "value" => $criteria->search),
