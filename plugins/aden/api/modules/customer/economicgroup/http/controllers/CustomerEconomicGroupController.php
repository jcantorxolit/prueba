...
namespace AdeN\Api\Modules\Customer\EconomicGroup\Http\Controllers;
...
class CustomerEconomicGroupController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerEconomicGroupRepository();
    ...
    public function indexAvailable()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerId', "operator" => 'neq'),
            ];
