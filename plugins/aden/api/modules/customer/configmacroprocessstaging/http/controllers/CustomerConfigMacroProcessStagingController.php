...
namespace AdeN\Api\Modules\Customer\ConfigMacroProcessStaging\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ConfigMacroProcessStaging\CustomerConfigMacroProcessStagingRepository;

class CustomerConfigMacroProcessStagingController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigMacroProcessStagingRepository();
