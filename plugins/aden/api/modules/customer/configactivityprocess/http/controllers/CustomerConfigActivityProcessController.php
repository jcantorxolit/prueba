...
namespace AdeN\Api\Modules\Customer\ConfigActivityProcess\Http\Controllers;
...
class CustomerConfigActivityProcessController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigActivityProcessRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'activityId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'workplaceId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'macroProcessId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'processId', "operator" => 'like', "value" => $criteria->search),
