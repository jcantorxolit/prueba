...
namespace AdeN\Api\Modules\Customer\HealthDamageRestrictionObservation\Http\Controllers;
...
use AdeN\Api\Modules\Customer\HealthDamageRestrictionObservation\CustomerHealthDamageRestrictionObservationRepository;
...
class CustomerHealthDamageRestrictionObservationController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerHealthDamageRestrictionObservationRepository();
    ...
    // indexHealthDamageRestrictionObservation >> AllHealthDamageRestrictionObservation

    public function indexHealthDamageRestrictionObservation()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'accessLevel', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'description', "operator" => 'like', "value" => $criteria->search),
            ];

            $criteria = CriteriaHelper::addFilters($criteria, $defaultFilters);

            $result = $this->repository->AllHealthDamageRestrictionObservation($criteria);
    ...
    // indexHealthDamageRestrictionObservationAll >> AllHealthDamageRestrictionObservationAll

    public function indexHealthDamageRestrictionObservationAll()
    {
        $request = Request::instance();
        ...
        try {
            ...
            $result = $this->repository->AllHealthDamageRestrictionObservationAll($criteria);
