...
namespace AdeN\Api\Modules\Customer\ConfigJobActivityDocument\Http\Controllers;

use AdeN\Api\Classes\BaseController;
use AdeN\Api\Helpers\CriteriaHelper;
use AdeN\Api\Helpers\HttpHelper;
use AdeN\Api\Modules\Customer\ConfigJobActivityDocument\CustomerConfigJobActivityDocumentRepository;
use Exception;
...
class CustomerConfigJobActivityDocumentController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigJobActivityDocumentRepository();
