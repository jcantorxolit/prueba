...
namespace AdeN\Api\Modules\Customer\RoadSafety40595\Container\RoadSafetyItem40595\Http\Controllers;
...
use AdeN\Api\Modules\Customer\RoadSafety40595\Container\RoadSafetyItem40595\CustomerRoadSafetyItem40595Repository;
use AdeN\Api\Helpers\KendoCriteriaHelper;

class CustomerRoadSafetyItem40595Controller extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerRoadSafetyItem40595Repository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $entity = $customerRoadSafetyIdField ? $this->repository->findMinimumStandard($customerRoadSafetyIdField->value) : null;
