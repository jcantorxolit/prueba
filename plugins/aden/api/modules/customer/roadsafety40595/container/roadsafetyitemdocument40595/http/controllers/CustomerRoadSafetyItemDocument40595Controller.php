...
namespace AdeN\Api\Modules\Customer\RoadSafety40595\Container\RoadSafetyItemDocument40595\Http\Controllers;
...
use AdeN\Api\Modules\Customer\RoadSafety40595\Container\RoadSafetyItemDocument40595\CustomerRoadSafetyItemDocument40595Repository;

class CustomerRoadSafetyItemDocument40595Controller extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerRoadSafetyItemDocument40595Repository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerRoadSafetyItemId', "operator" => 'eq'),
    ...
    public function indexAvailablePreviousPeriod()
    {
        ...
        try {
            ...
            $mandatoryFilters = [
                array("field" => 'customerId', "operator" => 'eq'),
                array("field" => 'roadSafetyItemId', "operator" => 'eq'),
                array("field" => 'statusCode', "operator" => 'neq'),
                array("field" => 'program', "operator" => 'eq'),
            ];
