...
namespace AdeN\Api\Modules\Customer\RoadSafety40595\Container\RoadSafetyItemVerification40595\Http\Controllers;
...
class CustomerRoadSafetyItemVerification40595Controller extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerRoadSafetyItemVerification40595Repository();
...
array( "field" => 'customerRoadSafetyItemId', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'roadSafetyItemCriterionDetailId', "operator" => 'like', "value" => $criteria->search ),
