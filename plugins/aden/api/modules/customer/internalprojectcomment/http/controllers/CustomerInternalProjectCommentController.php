...
namespace AdeN\Api\Modules\Customer\InternalProjectComment\Http\Controllers;
...
use AdeN\Api\Modules\Customer\InternalProjectComment\CustomerInternalProjectCommentRepository;

class CustomerInternalProjectCommentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerInternalProjectCommentRepository();
