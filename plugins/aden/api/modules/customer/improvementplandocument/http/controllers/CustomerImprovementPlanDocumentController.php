...
namespace AdeN\Api\Modules\Customer\ImprovementPlanDocument\Http\Controllers;
...
class CustomerImprovementPlanDocumentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerImprovementPlanDocumentRepository();
