...
class CustomerImprovementPlanDocumentModel extends Model
{
    const CLASS_NAME = "AdeN\Api\Modules\Customer\ImprovementPlanDocument\CustomerImprovementPlanDocumentModel";
     ...
     */
    protected $table = "wg_customer_improvement_plan_document";
