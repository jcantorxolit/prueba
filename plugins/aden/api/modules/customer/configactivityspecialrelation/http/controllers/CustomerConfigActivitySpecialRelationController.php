...
namespace AdeN\Api\Modules\Customer\ConfigActivitySpecialRelation\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ConfigActivitySpecialRelation\CustomerConfigActivitySpecialRelationRepository;

class CustomerConfigActivitySpecialRelationController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerConfigActivitySpecialRelationRepository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'customerAreJobSpecialRelationId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'customerActivitySpecialId', "operator" => 'like', "value" => $criteria->search),
