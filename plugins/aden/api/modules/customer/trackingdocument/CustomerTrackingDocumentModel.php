...
class CustomerTrackingDocumentModel extends Model
{
    const CLASS_NAME = "AdeN\Api\Modules\Customer\TrackingDocument\CustomerTrackingDocumentModel";
     ...
     */
    protected $table = "wg_customer_tracking_document";
