...
namespace AdeN\Api\Modules\Customer\TrackingDocument\Http\Controllers;
...
class CustomerTrackingDocumentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerTrackingDocumentRepository();
