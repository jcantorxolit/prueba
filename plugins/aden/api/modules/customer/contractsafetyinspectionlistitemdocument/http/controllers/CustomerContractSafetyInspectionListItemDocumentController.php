...
namespace AdeN\Api\Modules\Customer\ContractSafetyInspectionListItemDocument\Http\Controllers;
...
use AdeN\Api\Modules\Customer\ContractSafetyInspectionListItemDocument\CustomerContractSafetyInspectionListItemDocumentRepository;

class CustomerContractSafetyInspectionListItemDocumentController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerContractSafetyInspectionListItemDocumentRepository();
