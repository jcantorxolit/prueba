...
namespace AdeN\Api\Modules\ProgramManagement\EconomicSector\Http\Controllers;
...
use AdeN\Api\Modules\ProgramManagement\EconomicSector\ProgramManagementEconomicSectorRepository;

class ProgramManagementEconomicSectorController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new ProgramManagementEconomicSectorRepository();
    ...
    public function store()
    {
        ...
        try {
            ...
            if (!$this->repository->canInsert($entity)) {
                throw new BadRequestHttpException("El registro que intenta guardar ya existe.");
            }
    ...
    public function destroy()
    {
        ...
        try {
            ...
            if (!$this->repository->canDelete($id)) {
                throw new BadRequestHttpException("El registro no se puede eliminar. Está siendo usado en otro proceso.");
            }
