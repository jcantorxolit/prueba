...
namespace AdeN\Api\Modules\Project\AgentTask\Http\Controllers;
...
class CustomerProjectAgentTaskController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerProjectAgentTaskRepository();
...
array( "field" => 'startdatetime', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'enddatetime', "operator" => 'like', "value" => $criteria->search ),
