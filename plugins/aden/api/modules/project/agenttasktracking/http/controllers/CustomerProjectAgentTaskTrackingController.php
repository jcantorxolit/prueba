...
namespace AdeN\Api\Modules\Project\AgentTaskTracking\Http\Controllers;
...
use AdeN\Api\Modules\Project\AgentTaskTracking\CustomerProjectAgentTaskTrackingRepository;

class CustomerProjectAgentTaskTrackingController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new CustomerProjectAgentTaskTrackingRepository();
...
array( "field" => 'projectAgentTaskId', "operator" => 'like', "value" => $criteria->search ),
array( "field" => 'agentId', "operator" => 'like', "value" => $criteria->search ),
