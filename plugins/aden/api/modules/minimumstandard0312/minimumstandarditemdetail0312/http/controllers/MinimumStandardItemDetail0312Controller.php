...
namespace AdeN\Api\Modules\MinimumStandard0312\MinimumStandardItemDetail0312\Http\Controllers;
...
class MinimumStandardItemDetail0312Controller extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new MinimumStandardItemDetail0312Repository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'minimumStandardItemId', "operator" => 'like', "value" => $criteria->search),
