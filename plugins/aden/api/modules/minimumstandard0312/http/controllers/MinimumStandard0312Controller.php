...
namespace AdeN\Api\Modules\MinimumStandard0312\Http\Controllers;
...
class MinimumStandard0312Controller extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new MinimumStandard0312Repository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                array("field" => 'cycle', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'parentNumeral', "operator" => 'like', "value" => $criteria->search),
