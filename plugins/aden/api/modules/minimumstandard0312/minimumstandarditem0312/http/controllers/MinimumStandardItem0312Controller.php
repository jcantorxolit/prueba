...
namespace AdeN\Api\Modules\MinimumStandard0312\MinimumStandardItem0312\Http\Controllers;
...
class MinimumStandardItem0312Controller extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new MinimumStandardItem0312Repository();
    ...
    public function index()
    {
        ...
        try {
            ...
            $defaultFilters = [
                ...
                array("field" => 'minimumStandardId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'numeral', "operator" => 'like', "value" => $criteria->search),
                ...
                array("field" => 'minimumStandardOldId', "operator" => 'like', "value" => $criteria->search),
                array("field" => 'oldId', "operator" => 'like', "value" => $criteria->search),
