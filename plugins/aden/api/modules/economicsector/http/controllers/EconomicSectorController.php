...
namespace AdeN\Api\Modules\EconomicSector\Http\Controllers;
...
class EconomicSectorController extends BaseController
{
    use UserSecurity;
    ...
    public function __construct()
    {
        ...
        $this->repository = new EconomicSectorRepository();
