...
function ($rootScope, $scope, $state, $translate, $localStorage, $window, $document, $timeout, cfpLoadingBar) {
    ...
    $scope.openWhatsapp = function (number) {
        window.open("https://wa.me/57"+number.replace(/\s/g, '')+"?text=Buen día, quiero solicitar soporte.","")
    };
    ...
    $scope.language = {
        ...
        init: function () {
            ...
            $scope.language.selected = $scope.language.available[(preferredLanguage)];
