...
app.controller('resourceLibraryListCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    'DTColumnDefBuilder', '$compile', 'toaster', '$state', '$rootScope', 'SweetAlert', '$http', '$aside', 'moment', 'ListService',
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
              $rootScope, SweetAlert, $http, $aside, moment, ListService) {
        ...
        $scope.dtInstanceResourceLibraryCallback = function (instance) {
            $scope.dtInstanceResourceLibrary = instance;
        };
        ...
        $scope.onAddResourceLibrary = function (id) {
            ...
            var modalInstance = $aside.open({
                ...
                templateUrl: $rootScope.app.views.urlRoot + 'modules/configuration/resource-library/resource_library_modal.htm',
                placement: 'right',
                size: 'lg',
                backdrop: true,
...
app.controller('ModalInstanceSideResourceLibraryCtrl', function ($rootScope, $stateParams, $scope, $uibModalInstance, resource, $log, $timeout, SweetAlert, $http, toaster, $filter, FileUploader, DTColumnBuilder, DTOptionsBuilder, $compile) {
            ...
            $http({
                ...
                .then(function (response) {
                    ...
                    $timeout(function () {
                        ...
                        $scope.noImage = $scope.resource.cover == '';
    ...
    $scope.onSave = function () {
        ...
        if ($scope.resource.dateOf == null || $scope.resource.dateOf == '') {
            validateDateMessage += "Debe ingresar la fecha \n";
        }
