    ...
    function($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $localStorage, $compile, toaster, $state, $rootScope, $timeout, $http, SweetAlert, $aside, $document, ListService) {
        ...
        function getList() {
            var entities = [
                ...
                { name: 'positiva_fgn_campus_filter_field', value: null },
            ];
        ...
        var storeDatatable = 'campusListCtrl-' + window.currentUser.id;
        ...
        $scope.dtColumnsPositivaFgn = [
            ...
            DTColumnBuilder.newColumn('campus').withTitle("Sede").withOption('width', 200).withOption('defaultContent', ''),
            ...
            DTColumnBuilder.newColumn('address').withTitle("Dirección").withOption('width', 200).withOption('defaultContent', ''),
        ];
                ...
                SweetAlert.swal({
                    ...
                    function(isConfirm) {
                        if (isConfirm) {
                            ...
                            $http({
                                method: 'POST',
                                url: 'api/positiva-fgn-campus/delete',
        ...
        var onEdit = function(id) {
            ...
            var modalInstance = $aside.open({
                templateUrl: $rootScope.app.views.urlRoot + "modules/positiva-fgn/campus/campus_edit.htm",
                placement: 'right',
                backdrop: 'static',
                size: 'lg',
