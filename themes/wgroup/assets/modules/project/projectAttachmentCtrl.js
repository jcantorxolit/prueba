 ...
 */
app.controller('projectAttachmentCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder,
        ...
        var onLoadRecord = function (id) {
            $http({
                method: 'GET',
                url: 'api/customer-project-document/get',
                params: {
                    id: id
                }
        ...
        var save = function () {
            ...
            return $http({
                method: 'POST',
                url: 'api/customer-project-document/save',
        ...
        var uploader = $scope.uploader = new FileUploader({
            url: 'api/customer-project-document/upload',
            formData: [],
        ...
        $scope.dtColumnsCustomerInternalProjectDocument = [
            DTColumnBuilder.newColumn(null).withTitle("Acciones").withOption('width', 150).notSortable()
                .renderWith(function (data, type, full, meta) {
                    ...
                    var downloadRoute = 'api/customer-project-document/download?id=' + data.id;
                    ...
                    buttons: {
                        ...
                        fullCancel: {
                            ...
                            action: function(scope, button) {
                                ...
                                $http({
                                    method: 'POST',
                                    url: 'api/customer-project-document/delete',
                                    headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                                    data: $.param(req)
                                }).then(function (response) {
