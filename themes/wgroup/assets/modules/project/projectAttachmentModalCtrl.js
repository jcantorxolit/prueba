app.controller('ModalProjectAttachmentInstanceSideCtrl', function (
    ...
    $scope.dtColumnsCustomerDocumentModal = [
        DTColumnBuilder.newColumn(null).withTitle("Acciones").withOption('width', 150).notSortable()
            .renderWith(function (data, type, full, meta) {
                ...
                var downloadUrl = "api/customer-project-document/download?id=" + data.id;
    ...
    function getList() {
        var entities = [
            {name: 'customer_document_type', value: item.customerId}
        ];
