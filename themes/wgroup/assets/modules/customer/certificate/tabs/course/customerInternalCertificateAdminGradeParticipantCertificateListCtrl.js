 ...
 */
app.controller('customerInternalCertificateAdminGradeParticipantCertificateListCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        $scope.dtInstanceCustomerInternalCertificateParticipant = {};
		$scope.dtOptionsCustomerInternalCertificateParticipant = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsCustomerInternalCertificateParticipant = [
            DTColumnBuilder.newColumn(null).withTitle("Acciones").withOption('width', 150).notSortable()
                .renderWith(function (data, type, full, meta) {
                    ...
                    var editTemplate = '<a target="_self" class="btn btn-primary btn-xs editRow lnk" href="#" uib-tooltip="Descargar certificado" data-id="' + data.id + '" >' +
        ...
        $scope.onGenerate = function () {
            ...
            $http({
                method: 'POST',
                url: 'api/customer-internal-certificate-grade/generate',
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                data: $.param(req)
            }).then(function (response) {
        ...
        var loadRow = function () {
            ...
            $("#dtCustomerInternalCertificateParticipants a.editRow").on("click", function () {
                var id = $(this).data("id");
                ...
                {
                    jQuery("#downloadDocument")[0].src = "api/customer-internal-certificate-grade-participant-certificate/download?id=" + id;
                }
            });

            $("#dtCustomerInternalCertificateParticipants a.viewRow").on("click", function () {
                var id = $(this).data("id");
            ...
            $("#dtCustomerInternalCertificateParticipants a.delRow").on("click", function () {
                var id = $(this).data("id");
        ...
        $scope.dtInstanceCustomerInternalCertificateParticipantCallback = function (instance) {
            $scope.dtInstanceCustomerInternalCertificateParticipant = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceCustomerInternalCertificateParticipant.reloadData();
        };

        $scope.onAddCustomer = function() {
            var modalInstance = $aside.open({
                //templateUrl: 'app_modal_certificate_grade_participant_customer.htm',
                templateUrl: $rootScope.app.views.urlRoot + "modules/customer/certificate/tabs/course/certificate_grade_participant_modal_customer.htm",
                placement: 'right',
                size: 'lg',
                backdrop: true,
