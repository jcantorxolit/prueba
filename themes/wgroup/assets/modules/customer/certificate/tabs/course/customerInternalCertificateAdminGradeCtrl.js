...
*/
app.controller('customerInternalCertificateAdminGradeCtrl', ['$scope', '$stateParams', '$log','$compile', '$rootScope', '$timeout',
function ($scope, $stateParams, $log, $compile, $rootScope, $timeout) {

    var log = $log;
    var request = {};

    log.info("loading..customerInternalCertificateAdminGradeCtrl!!! ");
