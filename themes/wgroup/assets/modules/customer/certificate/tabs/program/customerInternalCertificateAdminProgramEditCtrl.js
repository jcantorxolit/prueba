 ...
 */
app.controller('customerInternalCertificateAdminProgramEditCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        var save = function () {
            ...
            return $http({
                method: 'POST',
                url: 'api/customer-internal-certificate-program/save',
                    ...
                    if (isConfirm) {
                        $timeout(function () {
                            ...
                            if (speciality.id != 0) {
                                ...
                                $http({
                                    method: 'POST',
                                    url: 'api/customer-internal-certificate-program-speciality/delete',
                                    headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                                    data: $.param(req)
                                }).then(function (response) {
                    ...
                    if (isConfirm) {
                        $timeout(function () {
                            ...
                            if (requirement.id != 0) {
                                ...
                                $http({
                                    method: 'POST',
                                    url: 'api/customer-internal-certificate-program-requirement/delete',
                                    headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                                    data: $.param(req)
                                }).then(function (response) {
                                    swal("Eliminado", "Registro eliminado satisfactoriamente", "info");
