...
*/
app.controller('customerInternalCertificateAdminProgramCtrl', ['$scope', '$stateParams', '$log','$compile', '$rootScope', '$timeout',
function ($scope, $stateParams, $log, $compile, $rootScope, $timeout) {

    var log = $log;
    var request = {};

    log.info("loading..customerInternalCertificateAdminProgramCtrl!!! ");
