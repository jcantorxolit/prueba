 ...
 */
app.controller('customerSafetyInspectionListItemEditCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        function getList() {
            var entities = [
                {name: 'customer_safety_inspection_list', value: currentId},
                {name: 'customer_safety_inspection_header_fields', value: currentId},
            ];

            ListService.getDataList(entities)
                .then(function (response) {
                    $scope.lists = response.data.data.customerSafetyInspectionList;
                    $scope.headerFields = response.data.data.customerSafetyInspectionHeaderFields;
        ...
        $timeout(function () {
            $scope.mainGridOptions = {
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: "api/customer-safety-inspection-list-item",
                            dataType: "json",
                            type: "POST",
                            data: function() {

                                var param = {
                                    customerSafetyInspectionId: currentId,
            ...
            $scope.detailGridOptions = function(dataItem) {
                return {
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: "api/customer-safety-inspection-list-item-question",
                                dataType: "json",
                                type: "POST",
                                data: function() {
        ...
        var onSaveBatch = function (models) {
            ...
            return $http({
                method: 'POST',
                url: 'api/customer-safety-inspection-list-item/batch',
        ...
        $scope.onSaveHeaderBatch = function (models) {
            ...
            return $http({
                method: 'POST',
                url: 'api/customer-safety-inspection-header-field/batch',
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                data: $.param(req)
            }).then(function (response) {
        ...
        var onSaveObservation = function() {
            ...
            return $http({
                method: 'POST',
                url: 'api/customer-safety-inspection-list-observation/save',
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                data: $.param(req)
            }).then(function (response) {
        ...
        $scope.dtInstanceCustomerSafetyInspectionObservation = {};
		$scope.dtOptionsCustomerSafetyInspectionObservation = DTOptionsBuilder.newOptions()
            // Add Bootstrap compatibility
            .withBootstrap().withOption('responsive', true)
            .withOption('ajax', {
                // Either you specify the AjaxDataProp here
                data: function(d) {
                    d.customerSafetyInspectionId = currentId;

                    return JSON.stringify(d);
                },
                url: 'api/customer-safety-inspection-list-observation',
        ...
        $scope.dtColumnsCustomerSafetyInspectionObservation = [
        ...
        $scope.dtInstanceCustomerSafetyInspectionObservationCallback = function(instance) {
            $scope.dtInstanceCustomerSafetyInspectionObservation = instance;
        }

        var reloadObservationData = function() {
            $scope.dtInstanceCustomerSafetyInspectionObservation.reloadData();
        }


        //----------------------------------------------------------------------------DANGEROUSNESS
		$scope.dtOptionsCustomerSafetyInspectionDangerousness = DTOptionsBuilder.newOptions()
            // Add Bootstrap compatibility
            .withBootstrap().withOption('responsive', true)
            .withOption('ajax', {
                // Either you specify the AjaxDataProp here
                ...
                url: 'api/customer-safety-inspection-list-item-dangerousness',
                contentType: "application/json",
                type: 'POST',
                beforeSend: function () {
                    // Aqui inicia el loader indicator
        ...
        $scope.dtColumnsCustomerSafetyInspectionDangerousness = [
        ...
        $scope.dtInstanceCustomerSafetyInspectionDangerousnessCallback = function(instance) {
            $scope.dtInstanceCustomerSafetyInspectionDangerousness = instance;
        }

        var reloadDangerousnessData = function() {
            $scope.dtInstanceCustomerSafetyInspectionDangerousness.reloadData();
        }


        //----------------------------------------------------------------------------ACTIONS
		$scope.dtOptionsCustomerSafetyInspectionActions = DTOptionsBuilder.newOptions()
            // Add Bootstrap compatibility
            .withBootstrap().withOption('responsive', true)
            .withOption('ajax', {
                // Either you specify the AjaxDataProp here
                ...
                url: 'api/customer-safety-inspection-list-item-action',
                contentType: "application/json",
                type: 'POST',
                beforeSend: function () {
                    // Aqui inicia el loader indicator
        ...
        $scope.dtColumnsCustomerSafetyInspectionActions = [
            DTColumnBuilder.newColumn('description').withTitle("Acciones").withOption('defaultContent', ''),
            DTColumnBuilder.newColumn('quantity').withTitle("Cantidad").withOption('defaultContent', ''),
        ];

        $scope.dtInstanceCustomerSafetyInspectionActionsCallback = function(instance) {
            $scope.dtInstanceCustomerSafetyInspectionActions = instance;
        }

        var reloadActionData = function() {
            $scope.dtInstanceCustomerSafetyInspectionActions.reloadData();
        }
        ...
        $scope.onAddComment= function (dataItem) {
            var modalInstance = $aside.open({
                ...
                size: 'lg',
                backdrop: true,
                controller: 'ModalInstanceSideCustomerSafetyInspectionListItemCommentCtrl',
                scope: $scope,
                resolve: {
                    question: function () {
                        return dataItem;
        ...
        $scope.onAddAttachment = function (dataItem) {
            var modalInstance = $aside.open({
                templateUrl: $rootScope.app.views.urlRoot + "modules/customer/safety/inspection/customer_safety_inspection_attachment_modal.htm",
                placement: 'right',
                size: 'lg',
                backdrop: true,
                controller: 'ModalInstanceSideCustomerSafetyInspectionListItemAttachmentCtrl',
                scope: $scope,
                resolve: {
                    isView: function () {
                        return $scope.isView;
...
app.controller('ModalInstanceSideCustomerSafetyInspectionListItemCommentCtrl', function ($stateParams, $rootScope, $scope, $uibModalInstance, question, $log, $timeout, SweetAlert, $http, toaster, $filter, FileUploader, DTColumnBuilder, DTOptionsBuilder, $compile, $document) {
    ...
    var initialize = function() {
        $scope.entity = {
            id: 0,
            customerSafetyInspectionListItemId: question.id,
            comment: '',
        };
    }
    ...
    $scope.onSave = function () {
        ...
        return $http({
            method: 'POST',
            url: 'api/customer-safety-inspection-list-item-comment/save',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            data: $.param(req)
        }).then(function (response) {
            $timeout(function () {
    ...
    $scope.dtOptionsQuestionComment = DTOptionsBuilder.newOptions()
        ...
        .withOption('ajax', {
            // Either you specify the AjaxDataProp here
            data: function(d) {
                d.customerSafetyInspectionListItemId = question.id

                return JSON.stringify(d);
            },
            url: 'api/customer-safety-inspection-list-item-comment',
            contentType: "application/json",
            type: 'POST',
            beforeSend: function () {
                // Aqui inicia el loader indicator
...
app.controller('ModalInstanceSideCustomerSafetyInspectionListItemImprovementPlanCtrl', function ($stateParams, $rootScope, $scope, $uibModalInstance, question,
    ...
    var init = function () {
        $scope.improvement = {
            ...
            classificationName: question.groupId,
            classificationId: question.groupId,
            entityName: 'IS',
...
app.controller('ModalInstanceSideCustomerSafetyInspectionListItemAttachmentCtrl', function ($stateParams, $rootScope, $scope, $uibModalInstance, $log, $timeout, SweetAlert, isView, question, $filter, FileUploader, $http, DTColumnBuilder, DTOptionsBuilder, $compile, ListService, toaster) {
    ...
    var uploader = $scope.uploader = new FileUploader({
        url: 'api/customer/safety-inspection-list-item-document/upload',
        formData: [],
    ...
    var save = function () {
        ...
        return $http({
            method: 'POST',
            url: 'api/customer-safety-inspection-list-item-document/save',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            data: $.param(req)
        }).then(function (response) {
            $timeout(function () {
    ...
    $scope.dtOptionsSafetyInspectionDocument = DTOptionsBuilder.newOptions()
        // Add Bootstrap compatibility
        .withBootstrap()
        .withOption('responsive', true)
        .withOption('ajax', {
            ...
            url: 'api/customer-safety-inspection-list-item-document',
            contentType: "application/json",
            type: 'POST',
            beforeSend: function () {
                // Aqui inicia el loader indicator
    ...
    $scope.dtColumnsSafetyInspectionDocument = [
        DTColumnBuilder.newColumn(null).withTitle("Acciones").withOption('width', 150).notSortable()
            .renderWith(function (data, type, full, meta) {
                var url = data.documentUrl ? data.documentUrl : '';
                var downloadUrl = "api/customer-safety-inspection-list-item-document/download?id=" + data.id;
                var actions = "";
    ...
    var loadRow = function () {
        ...
        $("#dtSafetyInspectionDocument a.editRow").on("click", function () {

        });
    };

    $scope.dtInstanceSafetyInspectionDocumentCallback = function (instance) {
        $scope.dtInstanceSafetyInspectionDocument = instance;
    };

    $scope.reloadData = function () {
        $scope.dtInstanceSafetyInspectionDocument.reloadData();
    };
