 ...
 * @since  1.0
 */
app.controller('customerMatrixConfigWizardTabActivityCtrl', ['$scope', '$stateParams', '$log',
    ...
    function ($scope, $stateParams, $log, $compile, $state,
        ...
        var save = function () {
            ...
            return $http({
                method: 'POST',
                url: 'api/customer/matrix-activity/save',
        ...
        $scope.dtInstanceMatrixConfigActivity = {};
		$scope.dtOptionsMatrixConfigActivity = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsMatrixConfigActivity = [
            ...
            DTColumnBuilder.newColumn('name').withTitle("Actividad").withOption('defaultContent', ''),
        ...
        var loadRow = function () {
            ...
            $("#dtMatrixConfigActivity a.editRow").on("click", function () {
                var id = $(this).data("id");
                $scope.editMatrixConfigActivity(id);
            });

            $("#dtMatrixConfigActivity a.delRow").on("click", function () {
                var id = $(this).data("id");
                ...
                SweetAlert.swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            $http({
                                method: 'POST',
                                url: 'api/customer/matrix-activity/delete',
                                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                                data: $.param(req)
                            }).then(function (response) {
        ...
        $scope.reloadData = function () {
            $scope.dtInstanceMatrixConfigActivity.reloadData();
        };

        $scope.editMatrixConfigActivity = function (id) {
            if (id) {
        ...
        $scope.clearMatrixConfigActivity = function () {
            init();
        };
    }]);
