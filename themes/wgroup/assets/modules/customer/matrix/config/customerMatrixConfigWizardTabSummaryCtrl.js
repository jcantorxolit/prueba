 ...
 */
app.controller('customerMatrixConfigWizardTabSummaryCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        log.info("loading..customerMatrixConfigWizardTabSummaryCtrl ");
        $scope.loading = true;
        $scope.isView = false;
        $scope.wizards = [];
        ...
        var loadList = function () {
            ...
            req.customerMatrixId = currentId;

            return $http({
                method: 'POST',
                url: 'api/customer/matrix/chart-list',
                ...
                $timeout(function () {
                    ...
                    $scope.charts = $scope.datasetwizardsData;
                });
            }).catch(function (e) {
                $log.error(e);
