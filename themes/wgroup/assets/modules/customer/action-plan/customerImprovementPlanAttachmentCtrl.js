 ...
 */
app.controller('customerImprovementPlanAttachmentCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        var onLoadRecord = function (id) {
            ...
            $http({
                method: 'GET',
                url: 'api/customer-improvement-plan-document/get',
                params: req
            })
        ...
        $scope.dtColumnsMinimumStandardDocument40595 = [
            DTColumnBuilder.newColumn(null).withTitle("Acciones").withOption('width', 150).notSortable()
                .renderWith(function (data, type, full, meta) {
                    ...
                    var downloadUrl = "api/customer-improvement-plan-document/download?id=" + data.id;
        ...
        var loadRow = function () {
            ...
            $("#dtMinimumStandardDocument40595 a.editRow").on("click", function () {
                ...
                if (url == "") {
                    ...
                    jQuery("#downloadDocument")[0].src = "api/customer-improvement-plan-document/download?id=" + id;
                }
            });
