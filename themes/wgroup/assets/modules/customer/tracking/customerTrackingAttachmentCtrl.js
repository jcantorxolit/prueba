 ...
 */
app.controller('customerTrackingAttachmentCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        var onLoadRecord = function (id) {
            ...
            $http({
                method: 'GET',
                url: 'api/customer-tracking-document/get',
                params: req
            })
        ...
        $scope.dtOptionsTrackingDocument = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsTrackingDocument = [
        ...
        var loadRow = function () {
            ...
            $("#dtTrackingDocument a.editRow").on("click", function () {
                var id = $(this).data("id");
            ...
            angular.element("#dtTrackingDocument a.delDocumentRow").on("click", function () {
        ...
        $scope.dtInstanceTrackingDocumentCallback = function (instance) {
            $scope.dtInstanceTrackingDocument = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceTrackingDocument.reloadData();
        };
