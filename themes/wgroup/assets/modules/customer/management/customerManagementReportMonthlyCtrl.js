 ...
 */
app.controller('customerManagementReportMonthlyCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        var log = $log;
        var request = {};
        log.info("loading..customerManagementReportMonthlyCtrl ");

        $scope.request = {};
        $scope.audit = {};
        $scope.audit.operation = "info";
        $scope.audit.managementId = $scope.$parent.currentManagement;
        $scope.audit.year = 0;
        $scope.audit.program = 0;
        ...
        var loadReports = function () {
            ...
            $http({
                method: 'GET',
                url: 'api/management/reportMonthly',
                params: req
            }).then(function (response) {
                ...
                $timeout(function () {
                    ...
                    if (response.data.result.line_programs.datasets) {
                    ...
                    if (response.data.result.report_programs.datasets) {
		...
		$scope.dtOptionsDiagnosticSummaryProgram = DTOptionsBuilder.newOptions()
            ...
            .withOption('ajax', {
                ...
                data: $scope.request,
                url: 'api/management/summary-program',
                type: 'POST',
                beforeSend: function () {
		...
		$scope.dtOptionsDiagnosticSummaryIndicator = DTOptionsBuilder.newOptions()
            ...
            .withOption('ajax', {
                // Either you specify the AjaxDataProp here
                data: $scope.request,
                url: 'api/management/summary-indicator',
                type: 'POST',
                beforeSend: function () {
                    // Aqui inicia el loader indicator
                },
        ...
        $scope.$watch("filter.selectedProgram", function () {
            $timeout(function () {
                if ($scope.filter.selectedProgram != null) {
                    $scope.audit.operation = "info";
                    $scope.audit.managementId = $scope.$parent.currentManagement;
                    $scope.audit.program = $scope.filter.selectedProgram.id;
        ...
        {
            jQuery("#downloadDocument")[0].src = "api/management/summary-program/export?data=" + Base64.encode(JSON.stringify($scope.audit));
        }
