 ...
 */
app.controller('customerConfigWizardMacroProcessesImportCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        var $exportUrl = '';
        var $endpoint = 'api/v1/customer-config-macroprocess-import';
        ...
        $scope.onDownload = function () {
            angular.element("#downloadDocument")[0].src = "api/customer-config-macro-process/download-template?customerId=" + $stateParams.customerId;
        };

        $scope.dtInstanceConfigMacroImport = {};
		$scope.dtOptionsConfigMacroImport = DTOptionsBuilder.newOptions()
            ...
            .withOption('ajax', {
                ...
                url: 'api/customer-config-macro-process',
        ...
        $scope.dtColumnsConfigMacroImport = [
        ...
        $scope.reloadData = function () {
            $scope.dtInstanceConfigMacroImport.reloadData();
        };
