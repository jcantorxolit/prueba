 ...
 */
app.controller('customerConfigWizardActivityImportCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        var $exportUrl = '';
        var $endpoint = 'api/v1/customer-config-activity-import';
        ...
        $scope.onDownload = function () {
            angular.element("#downloadDocument")[0].src = "api/customer-config-activity/download-template";
        };

        $scope.dtInstanceConfigJobActivityImport = {};
		$scope.dtOptionsConfigJobActivityImport = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsConfigJobActivityImport = [
        ...
        $scope.reloadData = function () {
            $scope.dtInstanceConfigJobActivityImport.reloadData();
        };
