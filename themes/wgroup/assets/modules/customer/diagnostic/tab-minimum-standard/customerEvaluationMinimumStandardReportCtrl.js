 ...
 */
app.controller('customerEvaluationMinimumStandardReportCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        request.standard_id = $scope.$parent.currentId;
        ...
        var initialize = function () {
            ...
            req.standard_id = $scope.$parent.currentId;
        ...
        var loadData = function () {
            ...
            req.customer_id = $stateParams.customerId;
            req.standard_id = $scope.currentId;
            req.rate_id = $scope.rate_id;

            $http({
                method: 'POST',
                url: 'api/customer/evaluation-minimum-standard-item-report',
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                data: $.param(req)
            }).then(function (response) {

                $scope.cycles = response.data.data.standards;
                $scope.loaded = true;
        ...
        {
            jQuery("#downloadDocument")[0].src = "api/customer/evaluation-minimum-standard-item/export-excel?id=" + $scope.currentId + "&rate=" + $scope.rate_id;
        }
