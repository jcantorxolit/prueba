 ...
 */
app.controller('customerConfigurationMinimumStandardItemListCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        $scope.dtInstanceCustomerConfigMinimumStandardItem = {};
        $scope.dtOptionsCustomerConfigMinimumStandardItem = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsCustomerConfigMinimumStandardItem = [
        ...
        var loadRow = function () {
            ...
            $("#dtCustomerConfigMinimumStandardItem a.editRow").on("click", function () {
                var id = $(this).data("id");
                $scope.editMinimumStandardItem(id);
            });

            $("#dtCustomerConfigMinimumStandardItem a.delRow").on("click", function () {
                var id = $(this).data("id");
        ...
        $scope.reloadData = function () {
            $scope.dtInstanceCustomerConfigMinimumStandardItem.reloadData();
        };
        ...
        var onOpenModal = function (id) {
            ...
            var modalInstance = $aside.open({
                ...
                templateUrl: $rootScope.app.views.urlRoot + "modules/customer/diagnostic/tab-minimum-standard/customer_configuration_minimum_standard_item_modal.htm",
                placement: 'right',
                size: 'lg',
                backdrop: true,
...
app.controller('ModalInstanceSideCustomerConfigurationMinimumStandardItemEditCtrl', function ($rootScope, $stateParams, $scope, $uibModalInstance, standard, $log, $timeout, SweetAlert, $http, toaster, $filter, $aside, $document, DTColumnBuilder, DTOptionsBuilder, $compile) {
