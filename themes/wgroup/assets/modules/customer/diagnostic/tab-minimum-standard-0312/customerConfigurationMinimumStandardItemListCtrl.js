 ...
 */
app.controller('customerConfigurationMinimumStandardItem0312ListCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        $scope.dtOptionsCustomerConfigMinimumStandardItem0312 = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsCustomerConfigMinimumStandardItem0312 = [
        ...
        var loadRow = function () {
            ...
            $("#dtCustomerConfigMinimumStandardItem0312 a.editRow").on("click", function () {
                var id = $(this).data("id");
                onEdit(id);
            });

            $("#dtCustomerConfigMinimumStandardItem0312 a.delRow").on("click", function () {
                var id = $(this).data("id");
        ...
        $scope.dtInstanceCustomerConfigMinimumStandardItem0312Callback = function (instance) {
            $scope.dtInstanceCustomerConfigMinimumStandardItem0312 = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceCustomerConfigMinimumStandardItem0312.reloadData();
        };
        ...
        var onOpenModal = function (id) {
            ...
            var modalInstance = $aside.open({
                ...
                templateUrl: $rootScope.app.views.urlRoot + "modules/customer/diagnostic/tab-minimum-standard-0312/customer_configuration_minimum_standard_item_modal.htm",
                placement: 'right',
                size: 'lg',
                backdrop: true,
...
app.controller('ModalInstanceSideCustomerConfigurationMinimumStandardItem0312EditCtrl', function ($rootScope, $stateParams, $scope, $uibModalInstance, standard, $log, $timeout, SweetAlert, $http, toaster, $filter, $aside, $document, DTColumnBuilder, DTOptionsBuilder, $compile) {
    ...
    var loadListVerificationMode = function () {
        ...
        return $http({
            method: 'POST',
            url: 'api/customer/configuration-minimum-standard-item-detail/list-data',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            data: $.param(req)
        }).then(function (response) {
            $timeout(function () {
    ...
    var save = function () {
        ...
        return $http({
            method: 'POST',
            url: 'api/customer/configuration-minimum-standard-item-detail/insert',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            data: $.param(req)
        }).then(function (response) {
