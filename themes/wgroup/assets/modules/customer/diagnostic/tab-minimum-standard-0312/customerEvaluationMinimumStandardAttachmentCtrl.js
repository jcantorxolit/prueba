 ...
 */
app.controller('customerEvaluationMinimumStandardAttachment0312Ctrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        var onInit = function() {
            ...
            $scope.attachment = {
                id: 0,
                customerEvaluationMinimumStandardItemId: 0,
                type: null,
                classification: null,
                description: "",
        ...
        var onLoadRecord = function (id) {
            ...
            $http({
                method: 'GET',
                url: 'api/customer-evaluation-minimum-standard-item-document-0312/get',
                params: req
            })
        ...
        $scope.dtOptionsMinimumStandardDocument0312 = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsMinimumStandardDocument0312 = [
        ...
        var loadRow = function () {
            ...
            $("#dtMinimumStandardDocument0312 a.editRow").on("click", function () {
                var id = $(this).data("id");
            ...
            angular.element("#dtMinimumStandardDocument0312 a.delDocumentRow").on("click", function () {
                    ...
                    buttons: {
                        ...
                        fullCancel: {
                            ...
                            action: function(scope, button) {
                                ...
                                $http({
                                    method: 'POST',
                                    url: 'api/customer-evaluation-minimum-standard-item-document-0312/delete',
                                    headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                                    data: $.param(req)
                                }).then(function (response) {
        ...
        $scope.dtInstanceMinimumStandardDocument0312Callback = function (instance) {
            $scope.dtInstanceMinimumStandardDocument0312 = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceMinimumStandardDocument0312.reloadData();
        };
