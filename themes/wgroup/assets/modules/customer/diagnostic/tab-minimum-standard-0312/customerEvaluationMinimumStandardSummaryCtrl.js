 ...
 */
app.controller('customerEvaluationMinimumStandardSummary0312Ctrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        $scope.dtOptionsEvaluationMinimumStandardSummary0312 = DTOptionsBuilder.newOptions()
        // Add Bootstrap compatibility
            ...
            .withOption('ajax', {
                ...
                url: 'api/customer-evaluation-minimum-standard-0312-summary',
        ...
        $scope.dtColumnsEvaluationMinimumStandardSummary0312 = [
        ...
        $scope.dtInstanceEvaluationMinimumStandardSummary0312Callback = function (instance) {
            $scope.dtInstanceEvaluationMinimumStandardSummary0312 = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceEvaluationMinimumStandardSummary0312.reloadData();
        };
        ...
        $scope.onExportPdf = function () {
            $timeout(function () {
                kendo.drawing.drawDOM($(".minimun-standard-0312-export-pdf"))
                .then(function (group) {
        ...
        $scope.onExportExcel = function () {
            ...
            angular.element("#download")[0].src = "api/customer-evaluation-minimum-standard-0312-summary/export-excel?data=" + Base64.encode(data);
        }
        ...
        $scope.onReportExportPdf = function () {
            ...
            angular.element("#download")[0].src = "api/customer-evaluation-minimum-standard-0312/export-pdf?data=" + Base64.encode(data);
        }
