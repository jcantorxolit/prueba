 ...
 */
app.controller('customerRoadSafety40595EditCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        function getList() {
            ...
            var entities = [
                { name: 'customer_road_safety_cycle_40595', value: null, criteria: $criteria },
        ...
        $timeout(function () {
            $scope.mainGridOptions = {
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: "api/customer-road-safety-item-40595",
                            dataType: "json",
                            type: "POST",
                            data: function () {
            ...
            $scope.detailGridOptions = function (dataItem) {
                return {
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: "api/customer-road-safety-item-40595-question",
                                dataType: "json",
                                type: "POST",
                                data: function () {
                        ...
                        filter: { field: "cycleId", operator: "eq", value: dataItem.cycle_id }
                    },
                    editable: 'incell',
                    edit: function (e) {
        ...
        $scope.onAddAttachment = function (dataItem) {
            var modalInstance = $aside.open({
                templateUrl: $rootScope.app.views.urlRoot + "modules/customer/diagnostic/tab-road-safety/40595/customer_road_safety_items_document_modal.htm",
                placement: 'right',
                size: 'lg',
                backdrop: true,
                controller: 'ModalInstanceSideCustomerRoadSafetyItemAttachment40595Ctrl',
                scope: $scope,
                resolve: {
                    dataItem: function () {
                        return dataItem;
        ...
        $scope.onAddImprovementPlan = function (dataItem) {
            var modalInstance = $aside.open({
                ...
                size: 'lg',
                backdrop: true,
                controller: 'ModalInstanceSideCustomerRoadSafetyItemImprovementPlan40595Ctrl',
                scope: $scope,
                resolve: {
                    item: function () {
                        return dataItem;
        ...
        $scope.onAddVerificationList = function (dataItem) {
            var modalInstance = $aside.open({
                //templateUrl: 'app_modal_road_safety_item_detail.htm',
                templateUrl: $rootScope.app.views.urlRoot + "modules/customer/diagnostic/tab-road-safety/40595/customer_road_safety_items_detail_modal.htm",
                placement: 'right',
                size: 'lg',
                backdrop: true,
                controller: 'ModalInstanceSideCustomerRoadSafetyItemDetail40595Ctrl',
                scope: $scope,
                resolve: {
                    item: function () {
                        return dataItem;
        ...
        $scope.onSummaryExportExcel = function () {
            ...
            angular.element("#download")[0].src = "api/customer-road-safety-item-40595/export-excel?data=" + Base64.encode(data);
        }

    }]);

app.controller('ModalInstanceSideCustomerRoadSafetyItemAttachment40595Ctrl', function ($stateParams, $rootScope, $scope, $uibModalInstance, cycle, dataItem, isView, $log, $timeout, SweetAlert, $filter, FileUploader, $http, DTColumnBuilder, DTOptionsBuilder, $compile, ListService) {
    ...
    var init = function () {
        $scope.attachment = {
            id: 0,
            customerRoadSafetyItemId: dataItem.id,
            type: null,
            classification: null,
            description: "",
    ...
    $scope.dtOptionsCustomerDocumentModal = DTOptionsBuilder.newOptions()
        ...
        .withOption('ajax', {
            ...
            data: function (d) {
                d.customerRoadSafetyItemId = dataItem.id;
    ...
    $scope.dtOptionsCustomerMinimunStandardItemDocumentModal = DTOptionsBuilder.newOptions()
        ...
        .withOption('ajax', {
            ...
            url: 'api/customer-road-safety-item-document-40595-available-previous',
            contentType: "application/json",
            type: 'POST',
            beforeSend: function () {
                // Aqui inicia el loader indicator
    ...
    var onImportHistorical = function (id) {
        ...
        return $http({
            method: 'POST',
            url: 'api/customer-road-safety-item-document-40595/import-historical',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            data: $.param({
...
app.controller('ModalInstanceSideCustomerRoadSafetyItemImprovementPlan40595Ctrl', function ($stateParams, $rootScope, $scope, $uibModalInstance, item, cycle,
...
app.controller('ModalInstanceSideCustomerRoadSafetyItemComment40595Ctrl', function ($stateParams, $rootScope, $scope, $uibModalInstance, dataItem, isView, $log, $timeout, SweetAlert, $http, toaster, $filter, FileUploader, DTColumnBuilder, DTOptionsBuilder, $compile, $document) {
    ...
    $scope.onSave = function () {
        ...
        return $http({
            method: 'POST',
            url: 'api/customer-road-safety-item-comment-40595/save',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            data: $.param(req)
        }).then(function (response) {
            $timeout(function () {
    ...
    $scope.dtOptionsQuestionComment = DTOptionsBuilder.newOptions()
        ...
        .withOption('ajax', {
            ...
            url: 'api/customer-road-safety-item-comment-40595',
            type: 'POST',
            beforeSend: function () {
                // Aqui inicia el loader indicator
            },
...
app.controller('ModalInstanceSideCustomerRoadSafetyItemDetail40595Ctrl', function ($rootScope, $stateParams, $scope, $uibModalInstance, cycleList, item, isView, $log, $timeout, SweetAlert, $http, toaster, $filter, $aside, $document, DTColumnBuilder, DTOptionsBuilder, $compile) {

    var log = $log;

    $scope.isView = true;
    $scope.isVisible = !isView;
    $scope.cycleList = cycleList;
    ...
    var onLoadRecord = function () {
        if ($scope.entity.id) {
            ...
            $http({
                method: 'GET',
                url: 'api/customer-road-safety-item-40595/get',
                params: req
            })
                .catch(function (e, code) {
                ...
                .then(function (response) {
                    ...
                    $timeout(function () {
                        ...
                        $scope.entity.cycle = {
                            id: item.cycleId,
                            description: item.cycleDescription
                        }
                        $scope.entity.description = item.description;
                        $scope.entity.numeral = item.numeral;
                        $scope.entity.value = item.value;
    ...
    var save = function () {
        ...
        return $http({
            method: 'POST',
            url: 'api/customer-road-safety-item-40595/save',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            data: $.param(req)
        }).then(function (response) {
