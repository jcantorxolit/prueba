 ...
 */
app.controller('customerRoadSafetyMonthlyReport40595Ctrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        function getCharts() {
            ...
            var entities = [
                ...
                { name: 'customer_road_safety_monthly_40595', criteria: $criteria }
            ];
            ...
            ChartService.getDataChart(entities)
                .then(function (response) {
                    ...
                    $scope.chart.status.data = response.data.data.customerRoadSafetyMonthlyStatus;
                    $scope.chart.average.data = response.data.data.customerRoadSafetyMonthlyAverage;
                    $scope.chart.total.data = response.data.data.customerRoadSafetyMonthlyTotal;
                    $scope.chart.advance.data = response.data.data.customerRoadSafetyMonthlyAdvance;
        ...
        function getList() {
            ...
            var entities = [
                {name: 'customer_road_safety_year_40595', value: null, criteria: $criteria},
                {name: 'road_safety_rate_40595', value: $stateParams.customerId},
            ];

            ListService.getDataList(entities)
                .then(function (response) {
                    $scope.years = response.data.data.customerRoadSafetyYear;
        ...
        $timeout(function () {
            $scope.mainGridOptions = {
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: "api/customer-road-safety-tracking-40595-summary-cycle",
                            dataType: "json",
                            type: "POST",
                            data: function() {
            ...
            $scope.detailGridOptions = function(dataItem) {
                return {
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: "api/customer-road-safety-tracking-40595-summary-cycle-detail",
                                dataType: "json",
                                type: "POST",
                                data: function() {
        ...
        $scope.dtOptionsMinimumStandardSummaryProgram40595 = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsMinimumStandardSummaryProgram40595 = [
        ...
        //Indicators
        ////////////////////////////////////////////////////////////////
        $scope.dtOptionsMinimumStandardSummaryIndicator40595 = DTOptionsBuilder.newOptions()
            // Add Bootstrap compatibility
            .withBootstrap()
            ...
            .withOption('ajax', {
                ...
                url: 'api/customer-road-safety-tracking-40595-summary-indicator',
                contentType: 'application/json',
                type: 'POST',
                beforeSend: function () {
                    // Aqui inicia el loader indicator
        ...
        $scope.dtColumnsMinimumStandardSummaryIndicator40595 = [
        ...
        $scope.dtInstanceMinimumStandardSummaryProgram40595Callback = function (instance) {
            $scope.dtInstanceMinimumStandardSummaryProgram40595 = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceMinimumStandardSummaryProgram40595.reloadData();
        };


        $scope.dtInstanceMinimumStandardSummaryIndicator40595Callback = function (instance) {
            $scope.dtInstanceMinimumStandardSummaryIndicator40595 = instance;
        };

        $scope.reloadIndicatorData = function () {
            $scope.dtInstanceMinimumStandardSummaryIndicator40595.reloadData();
        };
        ...
        $scope.onSummaryByProgramExportExcel = function () {
            ...
            angular.element("#downloadDocument")[0].src = "api/customer-road-safety-tracking-40595-summary-cycle/export-excel?data=" + Base64.encode(data);
        }

        $scope.onSummaryByProgramExportPdf = function () {
            kendo.drawing.drawDOM($(".export-pdf-program-em-40595"))
                .then(function (group) {
                ...
                .done(function (data) {
                    ...
                    kendo.saveAs({
                        dataURI: data,
                        fileName: "PESV 40595 Reporte Mensual Ciclos.pdf",
        ...
        $scope.onSummaryByIndicatorExportExcel = function () {
            ...
            angular.element("#downloadDocument")[0].src = "api/customer-road-safety-tracking-40595-summary-indicator/export-excel?data=" + Base64.encode(data);
        }

        $scope.onSummaryByIndicatorExportPdf = function () {
            kendo.drawing.drawDOM($(".export-pdf-indicator-em-40595"))
                .then(function (group) {
                    // Render the result as a PDF file
                    return kendo.drawing.exportPDF(group, {
                        paperSize: "auto",
                ...
                .done(function (data) {
                    ...
                    kendo.saveAs({
                        dataURI: data,
                        fileName: "PESV 40595 Reporte Mensual Indicadores.pdf",
                        proxyURL: "//demos.telerik.com/kendo-ui/service/export"
                    });
                });
        }
