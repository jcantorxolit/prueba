 ...
 */
app.controller('customerRoadSafetyImport40595Ctrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        function getList() {
            ...
            var entities = [
                { name: 'customer_road_safety_parent_40595', value: null, criteria: $criteria },
                { name: 'customer_road_safety_40595', value: null, criteria: $criteria },
                { name: 'customer_road_safety_item_40595', value: null, criteria: $criteria },
            ];
        ...
        var getListParent = function() {
            if ($scope.entity.customerEvaluationMinimumStardardParent != null) {
                $scope.standardList = $filter('filter')($scope.standardListAll, {roadSafetyParentId: $scope.entity.customerEvaluationMinimumStardardParent.roadSafetyParentId}, true);
            }
        }

        var getListStandard = function() {
            if ($scope.entity.customerEvaluationMinimumStardard != null) {
                $scope.standardItemList = $filter('filter')($scope.standardItemListAll, {roadSafetyParentId: $scope.entity.customerEvaluationMinimumStardard.roadSafetyId}, true);
            }
        }
        ...
        var save = function () {
            ...
            return $http({
                method: 'POST',
                url: 'api/customer-road-safety-item-document-40595/import',
        ...
        $scope.dtOptionsMinimumStandardItemDocument40595 = DTOptionsBuilder.newOptions()
            ...
            .withOption('ajax', {
                ...
                data: function(d) {
                    d.customerRoadSafetyItemId = $scope.entity.customerEvaluationMinimumStardardItem ? $scope.entity.customerEvaluationMinimumStardardItem.customerRoadSafetyItemId : 0;
                    d.customerId = $scope.entity.customerEvaluationMinimumStardardItem ? $stateParams.customerId : -1;
                    d.statusCode = '2'
                    return JSON.stringify(d);
                },
                url: 'api/customer-road-safety-item-document-40595-available',
        ...
        $scope.dtColumnsMinimumStandardItemDocument40595 = [
        ...
        var loadRow = function () {
            $("#dtMinimumStandardItemDocument40595 a.downloadDocumentRow").on("click", function () {
                var id = $(this).data("id");
        ...
        $scope.dtInstanceMinimumStandardItemDocument40595Callback = function (instance) {
            $scope.dtInstanceMinimumStandardItemDocument40595 = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceMinimumStandardItemDocument40595.reloadData();
        };
