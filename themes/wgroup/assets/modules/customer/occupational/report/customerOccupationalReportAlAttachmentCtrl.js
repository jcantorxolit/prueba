 ...
 */
app.controller('customerOccupationalReportAlAttachmentCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder', 'DTColumnDefBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        $scope.onCancel = function () {
            if ($scope.$parent != null) {
                $scope.$parent.navToSection("list", "list", $scope.currentId);
            }
        };
        ...
        var onInit = function() {
            ...
            $scope.attachment = {
                id: 0,
                customerImprovementPlanItemId: 0,
                type: null,
                classification: null,
                description: "",
        ...
        var onLoadRecord = function (id) {
            ...
            $http({
                method: 'GET',
                url: 'api/customer-occupational-report-document/get',
                params: req
            })
        ...
        $scope.dtOptionsCustomerOccupationalReportALDocument = DTOptionsBuilder.newOptions()
        ...
        $scope.dtColumnsCustomerOccupationalReportALDocument = [
        ...
        var loadRow = function () {
            ...
            $("#dtCustomerOccupationalReportALDocument a.editRow").on("click", function () {
                var id = $(this).data("id");
                var url = $(this).data("url");
                //$scope.editCustomerOccupationalReportAL(id);
                if (url == "") {
            ...
            angular.element("#dtCustomerOccupationalReportALDocument a.delDocumentRow").on("click", function () {
        ...
        $scope.dtInstanceCustomerOccupationalReportALDocumentCallback = function (instance) {
            $scope.dtInstanceCustomerOccupationalReportALDocument = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceCustomerOccupationalReportALDocument.reloadData();
        };
