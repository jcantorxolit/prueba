 ...
 */
app.controller('customerOccupationalReportAnalysisCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, $compile, toaster, $state,
        ...
        function getCharts() {
            ...
            var entities = [            
                ...
                {name: 'customer_occupational_report', criteria: $criteria},                
            ];
            ...
            ChartService.getDataChart(entities)
                .then(function (response) {
                    ...
                    //$scope.chart.bar.options.maintainAspectRatio = true;
        ...
        var loadFilters = function() {
            ...
            $http({
                method: 'POST',
                url: 'api/occupational-report/monthly-filter',
        ...
        $scope.dtInstanceReportAlSummaryProgram = {};
		$scope.dtOptionsReportAlSummaryProgram = DTOptionsBuilder.newOptions()
            ...
            .withOption('ajax', {
                ...
                data: $scope.request,
                url: 'api/occupational-report/summary-lesion',
                type: 'POST',
                beforeSend: function () {
        ...
        $scope.dtColumnsReportAlSummaryProgram = [
        ...
        $scope.dtInstanceReportAlSummaryIndicator = {};
		$scope.dtOptionsReportAlSummaryIndicator = DTOptionsBuilder.newOptions()
            // Add Bootstrap compatibility
            .withBootstrap()
            .withOption('responsive', true)
            .withOption('ajax', {
                // Either you specify the AjaxDataProp here
                data: $scope.request,
                url: 'api/occupational-report/summary-indicator',
                type: 'POST',
                beforeSend: function () {
                    // Aqui inicia el loader indicator
                },
        ...
        $scope.dtColumnsReportAlSummaryIndicator = [
        ...
        $scope.dtInstanceReportAlSummaryProgramCallback = function (instance) {
            $scope.dtInstanceReportAlSummaryProgram = instance;
        };

        $scope.reloadData = function () {
            $scope.dtInstanceReportAlSummaryProgram.reloadData();
        };

        $scope.dtInstanceReportAlSummaryIndicatorCallback = function (instance) {
            $scope.dtInstanceReportAlSummaryIndicator = instance;
        };

        $scope.reloadIndicatorData = function () {
            //$scope.dtInstanceReportAlSummaryIndicator.reloadData();
        };
        ...
        {
            jQuery("#downloadDocument")[0].src = "api/occupational-report/summary-lesion/export?data=" + Base64.encode(JSON.stringify($scope.audit));
        }
