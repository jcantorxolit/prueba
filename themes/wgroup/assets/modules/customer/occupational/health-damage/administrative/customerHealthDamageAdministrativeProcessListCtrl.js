...
*/
app.controller('customerHealthDamageAdministrativeProcessListCtrl', ['$scope', '$stateParams', '$log','DTOptionsBuilder', 'DTColumnBuilder',
...
function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder,
    ...
    var log = $log;
        log.info("loading..customerHealthDamageAdministrativeProcessListCtrl ");
   ...
   // $rootScope.tracking_section = "list";
    ...
    $scope.dtInstanceHealthDamageAdministrativeProcess = {};
		$scope.dtOptionsHealthDamageAdministrativeProcess = DTOptionsBuilder.newOptions()
    ...
    $scope.dtColumnsHealthDamageAdministrativeProcess = [
    ...
    var loadRow = function () {
        ...
        $("#dtHealthDamageAdministrativeProcess a.editRow").on("click", function () {
            var id = $(this).data("id");
            $scope.editWorkMedicine(id);
        });

        $("#dtHealthDamageAdministrativeProcess a.viewRow").on("click", function () {
            var id = $(this).data("id");
            $scope.viewWorkMedicine(id);
        });

        $("#dtHealthDamageAdministrativeProcess a.delRow").on("click", function () {
            var id = $(this).data("id");
            ...
            SweetAlert.swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $http({
                            method: 'POST',
                            url: 'api/customer/health-damage/administrative-process/delete',
    ...
    $scope.reloadData = function () {
        $scope.dtInstanceHealthDamageAdministrativeProcess.reloadData();
    };
