 ...
 */
app.controller('customerCovidIndicatorExternalCtrl', 
function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, $compile, ListService, ChartService, $aside, $rootScope, CustomerCovidService) {
        ...
        function getOtherList(value, type) {
            ...
            var entities = [
                ...
                {
                    name: 'customer_covid_contractor',
                    criteria: criteriaParams
                },
            ];
            ListService.getDataList(entities)
                .then(function (response) {
                    ...
                    $scope.contractorList = response.data.data.covidContractorList;
                }, function (error) {
        ...
        function getCharts() {
            ...
            if ($scope.filter.selectedContractor) {
                $criteria.contractorId = $scope.filter.selectedContractor.id;
            }
            ...
            ChartService.getDataChart(entities)
                .then(function (response) {
                    ...
                    $scope.chart.employeeWorkplace.data = response.data.data.covidEmployeeWorkPlace;
        ...
        $scope.onClearContractor = function () {
            if($scope.filter.selectedContractor != null) {
                $scope.filter.contractorId = null;
                $scope.filter.selectedContractor = null;
                getCharts();
                $scope.reloadData();
            }    
        }
