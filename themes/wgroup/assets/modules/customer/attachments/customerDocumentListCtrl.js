 ...
 */
app.controller('customerDocumentListCtrl', ['$scope', '$stateParams', '$log', 'DTOptionsBuilder', 'DTColumnBuilder',
    ...
    function ($scope, $stateParams, $log, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder,
        ...
        $scope.$storage = $localStorage.$default({
            hideCustomerAttachmentCanceled: true
        });
        ...
        $scope.dtInstanceCustomerDocument = {};
		$scope.dtOptionsCustomerDocument = DTOptionsBuilder.newOptions()
            ...
            .withOption('ajax', {
                ...
                data: function(d) {
                    ...
                    if ($scope.$storage.hideCustomerAttachmentCanceled) {
                        d.statusCode = '2'
                    }
        ...
        $scope.dtColumnsCustomerDocument = [
            DTColumnBuilder.newColumn(null).withTitle("Acciones").withOption('width', 150).notSortable()
                .renderWith(function (data, type, full, meta) {
                    var url = data.documentUrl ? data.documentUrl : '';
                    var downloadRoute = 'api/document/download?id=' + data.id;
        ...
        var loadRow = function () {
            ...
            angular.element("#dtCustomerDocument a.delDocumentRow").on("click", function () {
        ...
        $scope.dtInstanceCustomerDocumentCallback = function(instance) {
            $scope.dtInstanceCustomerDocument = instance;
        }

        $scope.reloadData = function () {
            $scope.dtInstanceCustomerDocument.reloadData();
        };
        ...
        $scope.settings = function () {
            if ($scope.$parent != null) {
                $scope.$parent.navToSection("setting", "setting", $stateParams.customerId);
            }
        }
