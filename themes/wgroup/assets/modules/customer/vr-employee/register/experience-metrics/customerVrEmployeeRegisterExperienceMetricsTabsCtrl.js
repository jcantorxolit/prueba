 ...
 */
app.controller('customerVrEmployeeRegisterExperienceMetricsTabsCtrl', ['$scope', '$rootScope', '$timeout', '$filter',
    function ($scope, $rootScope,  $timeout,  $filter) {
        ...
        $scope.$on('resumeTab', function(event) {
            $scope.activeTab = 2;
            $scope.switchTab("tab2");
        });
