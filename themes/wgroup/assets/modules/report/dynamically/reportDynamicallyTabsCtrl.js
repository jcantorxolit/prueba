 ...
 */
app.controller('reportDynamicallyTabsCtrl', ['$scope', '$stateParams', '$log', '$compile', '$rootScope', '$timeout', '$state', '$filter', 'flowFactory','$http',
    function ($scope, $stateParams, $log, $compile, $rootScope, $timeout, $state, $filter, flowFactory, $http) {

        var log = $log;
        log.info("loading..reportDynamicallyTabsCtrl!!! ");
        var log = $log;
        var request = {};
