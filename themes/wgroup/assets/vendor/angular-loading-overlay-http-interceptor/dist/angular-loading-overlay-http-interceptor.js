...
/***/ function(module, exports, __webpack_require__) {
	...
	var bsLoadingOverlayHttpInterceptorFactoryFactory = function (bsLoadingOverlayService, $q) {
	    return function (config) {
	        return new BsLoadingOverlayHttpInterceptorInterceptor_1.default(config, bsLoadingOverlayService, $q);
	    };
	};
	bsLoadingOverlayHttpInterceptorFactoryFactory.$inject = ['bsLoadingOverlayService', '$q'];
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports) {
	...
	var BsLoadingOverlayHttpInterceptorInterceptor = (function () {
	    function BsLoadingOverlayHttpInterceptorInterceptor(config, bsLoadingOverlayService, $q) {
	        var _this = this;
