...
return [
    ...
    */
    ...
    'loadModules' => ['System', 'Backend', 'Cms', 'wgroup'],
    ...
    */
    ...
    'enableRoutesCache' => envi('ROUTES_CACHE', false),
    ...
    */
    ...
    'enableAssetCache' => envi('ASSET_CACHE', false),
    ...
    */
    ...
    'databaseTemplates' => envi('DATABASE_TEMPLATES', false),
    ...
    */
    ...
    'storage' => [
        ...
        'uploads' => [
            'disk'            => envi('default_filesystem_disk', 'local'),
            'folder'          => '',
            'path'            => envi('storage_upload_path', 'uploads'),
    ...
    */
    ...
    'linkPolicy' => envi('LINK_POLICY', 'detect'),
    ...
    */
    ...
    'enableCsrfProtection' => envi('ENABLE_CSRF', true),
 ...
 /*
    ...
    |--------------------------------------------------------------------------
    |
    | Specifies the URI prefix used for accessing api services (dont use / on start)
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Specifies if captcha is enable in the app
    |
    */
    'enableCaptcha' => envi('enableCaptcha'),
    ...
    |
    */
    'enableAutoRegister' => envi('enableAutoRegister'),
];
