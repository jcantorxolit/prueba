...
/**
 * Description of CustomerEmployeeDocumentCriticalDTO
 *
 * @author jdblandon
 */
class CustomerEmployeeDocumentCriticalDTO {
    ...
    private function getBasicInfo($model) {
        ...
        $documentModel = CustomerEmployeeDocumentCritical::find($model->id);
    ...
    public static function  fillAndSaveModel($object)
    {
        ...
        if ($object->id) {
            // Existe
            if (!($model = CustomerEmployeeDocumentCritical::find($object->id))) {
                // No existe
        ...
        return CustomerEmployeeDocumentCritical::find($model->id);
    }
    ...
    public static function denied($object)
    {
        ...
        $customerEmployeeDocumentTracking = new CustomerEmployeeDocumentCriticalTracking();
    ...
    public static function parse($info, $fmt_response = "1") {
        ...
        if (is_array($data) || $data instanceof Collection) {
            ...
            foreach ($data as $model) {
                if ($model instanceof CustomerEmployeeDocumentCritical) {
                    $parsed[] = (new CustomerEmployeeDocumentCriticalDTO())->parseModel($model, $fmt_response);
                } else {
                    $parsed[] = (new CustomerEmployeeDocumentCriticalDTO())->parseArray($model, $fmt_response);
                }
            }
            return $parsed;
        } else if ($info instanceof CustomerEmployeeDocumentCritical) {
            return (new CustomerEmployeeDocumentCriticalDTO())->parseModel($data, $fmt_response);
        } else {
            // return empty instance
            if ($fmt_response == "1") {
                return "";
            } else {
                return new CustomerEmployeeDocumentCriticalDTO();
            }
        }
    }
