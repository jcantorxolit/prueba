 ...
 * Idea Model
 */
class CustomerEmployeeDocumentCritical extends Model
{

    /**
     * @var string The database table used by the model.
     */
    public $table = 'wg_customer_employee_document_critical';
    ...
    {
        return CustomerEmployeeDocumentCritical::where('customer_employee_id', $customerEmployeeId)->where('type', $documentType)->count() > 0;
    }
