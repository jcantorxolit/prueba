 ...
 * Idea Model
 */
class CustomerInternalCertificateGradeParticipant extends Model
{

    /**
     * @var string The database table used by the model.
     */
    public $table = 'wg_customer_internal_certificate_grade_participant';
    ...
    {
        return CustomerEmployeeDTO::parse(CustomerEmployee::find($this->customer_employee_id));
    }
    ...
    {
        return CustomerInternalCertificateGradeParticipantDocument::where("customer_internal_certificate_grade_participant_id", $this->id)->count();
    }
