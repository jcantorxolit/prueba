...
/**
 * Description of CertificateGradeParticipantDocumentDTO
 *
 * @author jdblandon
 */
class CertificateGradeParticipantDocumentDTO {
    ...
    private function getBasicInfoPermission($model) {
        ...
        $documentModel = CertificateGradeParticipantDocument::find($model->id);
    ...
    public static function  fillAndSaveModel($object)
    {
        ...
        if ($object->id) {
            // Existe
            if (!($model = CertificateGradeParticipantDocument::find($object->id))) {
                // No existe
        ...
        $model->certificate_grade_participant_id = $object->certificateGradeParticipantId;
        ...
        return CertificateGradeParticipantDocument::find($model->id);
    }
    ...
    public static function parse($info, $fmt_response = "1") {
        ...
        if (is_array($data) || $data instanceof Collection) {
            ...
            foreach ($data as $model) {
                if ($model instanceof CertificateGradeParticipantDocument) {
                    $parsed[] = (new CertificateGradeParticipantDocumentDTO())->parseModel($model, $fmt_response);
                } else {
                    $parsed[] = (new CertificateGradeParticipantDocumentDTO())->parseArray($model, $fmt_response);
                }
            }
            return $parsed;
        } else if ($info instanceof CertificateGradeParticipantDocument) {
            return (new CertificateGradeParticipantDocumentDTO())->parseModel($data, $fmt_response);
        } else {
            // return empty instance
            if ($fmt_response == "1") {
                return "";
            } else {
                return new CertificateGradeParticipantDocumentDTO();
            }
        }
    }
