...
class ReportRepository {
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "") {
        ...
        $query->leftjoin("wg_collection_data", function ($join) {
            $join->on('wg_report.collection_id', '=', 'wg_collection_data.id');
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_report.allowAgent" || $field == "wg_report.allowCustomer") {
