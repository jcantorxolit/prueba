 ...
 * Idea Model
 */
class CustomerMatrixDataActionPlanRespTask extends Model
{

    /**
     * @var string The database table used by the model.
     */
    public $table = 'wg_customer_matrix_data_action_plan_resp_task';
    ...
    public $hasMany = [
        'tracking' => ['Wgroup\CustomerMatrixDataActionPlanRespTask\CustomerMatrixDataActionPlanRespTaskTracking'],
    ];
