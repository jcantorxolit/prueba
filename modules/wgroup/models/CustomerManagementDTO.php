...
/**
 * Description of CustomerManagementDTO
 *
 * @author jdblandon
 */
class CustomerManagementDTO
{
    ...
    /**
     * @param $model : Modelo CustomerManagementDTO
     */
    ...
    public static function  fillAndSaveModel($object, $finalize = false)
    {
        ...
        if ($object->id) {
            // Existe
            if (!($model = CustomerManagement::find($object->id))) {
                // No existe
        ...
        return CustomerManagement::find($model->id);
    ...
    public static function parse($info, $fmt_response = "1")
    {
        ...
        if (is_array($data) || $data instanceof Collection) {
            ...
            foreach ($data as $model) {
                if ($model instanceof CustomerManagement) {
                    $parsed[] = (new CustomerManagementDTO())->parseModel($model, $fmt_response);
                } else {
                    $parsed[] = (new CustomerManagementDTO())->parseArray($model, $fmt_response);
                }
            }
            return $parsed;
        } else if ($info instanceof CustomerManagement) {
            return (new CustomerManagementDTO())->parseModel($data, $fmt_response);
        } else {
