 ...
 * @author TeamCloud
 */
class EmployeeDemographicRepository {
    ...
    protected $columns = array('wg_employee_demographic.*');
    ...
    public function __construct(EmployeeDemographic $model) {
        $this->model = $model;
    }
    ...
    public function getFiltereds($filter = array(), $join = "", $count = false) {
        $query = $this->query();
        $query->select(['wg_employee_demographic.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "") {
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_employee_demographic.employee_id" || $field == "wg_employee_demographic.category") {
