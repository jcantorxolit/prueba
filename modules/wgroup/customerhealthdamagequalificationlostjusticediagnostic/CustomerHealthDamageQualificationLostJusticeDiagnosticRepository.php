 ...
 * @author TeamCloud
 */
class CustomerHealthDamageQualificationLostJusticeDiagnosticRepository
{
    ...
    protected $columns = array('wg_customer_health_damage_ql_ordinary_labor_law_detail.*');
    ...
    public function __construct(CustomerHealthDamageQualificationLostJusticeDiagnostic $model)
    {
        $this->model = $model;
    }
    ...
    {
        $query = $this->query();
        $query->select(['wg_customer_health_damage_ql_ordinary_labor_law_detail.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "")
    {
        ...
        $query->join("wg_customer_health_damage_ql_ordinary_labor_law", function ($join) {
            $join->on('wg_customer_health_damage_ql_ordinary_labor_law_detail.customer_health_damage_ql_ordinary_labor_law_id', '=', 'wg_customer_health_damage_ql_ordinary_labor_law.id');
        });
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_customer_health_damage_ql_ordinary_labor_law_detail.customer_health_damage_ql_ordinary_labor_law_id") {
