 ...
 * Idea Model
 */
class CustomerHealthDamageQualificationLostDocument extends Model
{

    /**
     * @var string The database table used by the model.
     */
    public $table = 'wg_customer_health_damage_ql_document';
    ...
    {
        return $this->getParameterByValue($this->type, "work_health_damage_ql_document_type");
    }
