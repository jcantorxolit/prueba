 ...
 * @author TeamCloud
 */
class ImprovementPlanCauseCategoryRepository {
    ...
    protected $columns = array('wg_improvement_plan_cause_category.*');
    ...
    public function __construct(ImprovementPlanCauseCategory $model) {
        $this->model = $model;
    }
    ...
    public function getFiltereds($filter = array(), $join = "", $count = false) {
        $query = $this->query();
        $query->select(['wg_improvement_plan_cause_category.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "") {
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_improvement_plan_cause_category.status") {
