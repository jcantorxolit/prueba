...
class CustomerConfigHazardInterventionActionPlanRespTaskService {
    ...
    public function getAllBy($search, $perPage = 10, $currentPage = 0, $sorting = array(), $typeFilter = "", $customerId = 0, $isCustomerVisible = false) {
        ...
        $this->customerProjectAgentTaskRepository = new CustomerConfigHazardInterventionActionPlanRespTaskRepository($model);
