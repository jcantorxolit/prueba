 ...
 * @author TeamCloud
 */
class CustomerConfigHazardInterventionActionPlanRespTaskRepository {
    ...
    public function __construct(CustomerConfigHazardInterventionActionPlanRespTask $model) {
        $this->model = $model;
    }
