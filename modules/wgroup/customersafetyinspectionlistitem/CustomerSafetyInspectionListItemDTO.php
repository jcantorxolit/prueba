 ...
 * @author jdblandon
 */
class CustomerSafetyInspectionListItemDTO {
    ...
    /**
     * @param $model: Modelo CustomerSafetyInspectionListItem
     */
    ...
    public static function  fillAndSaveModel($object)
    {
        ...
        if ($object->id) {
            // Existe
            if (!($model = CustomerSafetyInspectionListItem::find($object->id))) {
                // No existe
        ...
        return CustomerSafetyInspectionListItem::find($model->id);
    }
    ...
    public static function parse($info, $fmt_response = "1") {
        ...
        if (is_array($data) || $data instanceof Collection) {
            ...
            foreach ($data as $model) {
                if ($model instanceof CustomerSafetyInspectionListItem) {
                    $parsed[] = (new CustomerSafetyInspectionListItemDTO())->parseModel($model, $fmt_response);
                }
            }
            return $parsed;
        } else if ($info instanceof CustomerSafetyInspectionListItem) {
            return (new CustomerSafetyInspectionListItemDTO())->parseModel($data, $fmt_response);
        } else {
            // return empty instance
            if ($fmt_response == "1") {
                return "";
            } else {
                return new CustomerSafetyInspectionListItemDTO();
            }
        }
    }
