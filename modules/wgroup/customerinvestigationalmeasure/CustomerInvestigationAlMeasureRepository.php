 ...
 * @author TeamCloud
 */
class CustomerInvestigationAlMeasureRepository
{
    ...
    protected $columns = array('wg_customer_investigation_al_measure.*');
    ...
    public function __construct(CustomerInvestigationAlMeasure $model)
    {
        $this->model = $model;
    }
    ...
    {
        $query = $this->query();
        $query->select(['wg_customer_investigation_al_measure.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "")
    {
        ...
        /*$query->leftjoin(DB::raw(SystemParameter::getRelationTable('investigation_measure')), function($join)
        {
            $join->on('wg_customer_investigation_al_measure.type', '=', 'investigation_measure.value');
        });*/
