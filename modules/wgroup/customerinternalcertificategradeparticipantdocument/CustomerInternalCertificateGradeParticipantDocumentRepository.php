...
/**
 * Description of CustomerInternalCertificateGradeParticipantDocumentRepository
 *
 * @author TeamCloud
 */
class CustomerInternalCertificateGradeParticipantDocumentRepository {
    ...
    protected $columns = array('wg_customer_internal_certificate_grade_participant_document.*');
    ...
    public function __construct(CustomerInternalCertificateGradeParticipantDocument $model) {
        $this->model = $model;
    }
    ...
    public function getFiltereds($filter = array(), $join = "", $count = false) {
        $query = $this->query();
        $query->select(['wg_customer_internal_certificate_grade_participant_document.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "") {
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_customer_internal_certificate_grade_participant_document.certificate_grade_participant_id") {
