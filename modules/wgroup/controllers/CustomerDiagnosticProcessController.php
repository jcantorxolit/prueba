...
use Wgroup\Classes\ServiceCustomerDiagnosticProcess;
use Wgroup\Models\CustomerDiagnosticProcess;
use Wgroup\Models\CustomerDiagnosticProcessDTO;
 ...
 * @author Andres Mejia
 */
class CustomerDiagnosticProcessController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new ServiceCustomerDiagnosticProcess();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerDiagnosticProcessDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerDiagnosticProcessDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerDiagnosticProcessDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new CustomerDiagnosticProcessDTO();
            }
            else
            {
                if (!($model = CustomerDiagnosticProcess::find($id))) {
