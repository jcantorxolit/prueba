...
use Wgroup\EmployeeDemographic\EmployeeDemographicService;
 ...
 * @author Andres Mejia
 */
class EmployeeDemographicController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new EmployeeDemographicService();
    ...
    public function index()
    {
        ...
        try {
            ...
            $data = $this->service->getAll(@$search['value'], $length, $currentPage, $sort, $employeeId, $category);

            // Counts
            $recordsTotal = $this->service->getAllRecordsCount('', $employeeId, $category);
            $recordsFiltered = $this->service->getAllRecordsCount(@$search['value'], $employeeId, $category);

            $result = EmployeeDemographicDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = EmployeeDemographicDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = EmployeeDemographicDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = EmployeeDemographic::find($traking))) {
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = EmployeeDemographic::find($id))) {
                throw new \Exception("Customer not found", 404);
            }

            //Get data
            $result = EmployeeDemographicDTO::parse($model, "2");
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = EmployeeDemographic::find($id);
