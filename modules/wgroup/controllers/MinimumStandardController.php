...
use Wgroup\MinimumStandard\MinimumStandardService;
 ...
 * @author Andres Mejia
 */
class MinimumStandardController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new MinimumStandardService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = MinimumStandardDTO::parse($data);
    ...
    {
        try {
            $data['cycle'] = ConfigMinimumStandardCycle::all();
            $data['parent'] = MinimumStandardDTO::parse(MinimumStandard::whereType('P')->where('isActive', 1)->get());
            $data['standard'] = MinimumStandardDTO::parse(MinimumStandard::whereType('C')->where('isActive', 1)->get());
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = MinimumStandardDTO::fillAndSaveModel($info);

            $result = MinimumStandardDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new MinimumStandardDTO();
            } else {
                if (!($model = MinimumStandard::find($id))) {
