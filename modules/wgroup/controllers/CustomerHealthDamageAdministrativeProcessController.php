...
use Wgroup\CustomerHealthDamageAdministrativeProcess\CustomerHealthDamageAdministrativeProcess;
use Wgroup\CustomerHealthDamageAdministrativeProcess\CustomerHealthDamageAdministrativeProcessDTO;
use Wgroup\CustomerHealthDamageAdministrativeProcess\CustomerHealthDamageAdministrativeProcessService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageAdministrativeProcessController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageAdministrativeProcessService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageAdministrativeProcessDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageAdministrativeProcessDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageAdministrativeProcessDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageAdministrativeProcess::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageAdministrativeProcessDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageAdministrativeProcessDocumentDTO::parse($model);
