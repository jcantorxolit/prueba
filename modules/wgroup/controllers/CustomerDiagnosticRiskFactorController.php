...
use Wgroup\Classes\ServiceCustomerDiagnosticRiskFactor;
 ...
 * @author Andres Mejia
 */
class CustomerDiagnosticRiskFactorController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new ServiceCustomerDiagnosticRiskFactor();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerDiagnosticRiskFactorDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerDiagnosticRiskFactorDTO::fillAndSaveModel($info);

            $result = CustomerDiagnosticRiskFactorDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new CustomerDiagnosticRiskFactorDTO();
            }
            else
            {
                if (!($model = CustomerDiagnosticRiskFactor::find($id))) {
