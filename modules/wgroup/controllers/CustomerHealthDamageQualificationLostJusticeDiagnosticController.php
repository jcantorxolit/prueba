...
use Wgroup\CustomerHealthDamageQualificationLostJusticeDiagnostic\CustomerHealthDamageQualificationLostJusticeDiagnosticService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationLostJusticeDiagnosticController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageQualificationLostJusticeDiagnosticService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationLostJusticeDiagnosticDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostJusticeDiagnosticDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostJusticeDiagnosticDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationLostJusticeDiagnostic::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostJusticeDiagnosticDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostJusticeDiagnosticDocumentDTO::parse($model);
