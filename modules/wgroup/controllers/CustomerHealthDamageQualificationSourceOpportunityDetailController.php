...
use Wgroup\CustomerHealthDamageQualificationSourceOpportunityDetail\CustomerHealthDamageQualificationSourceOpportunityDetail;
use Wgroup\CustomerHealthDamageQualificationSourceOpportunityDetail\CustomerHealthDamageQualificationSourceOpportunityDetailDTO;
use Wgroup\CustomerHealthDamageQualificationSourceOpportunityDetail\CustomerHealthDamageQualificationSourceOpportunityDetailService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationSourceOpportunityDetailController extends BaseController {
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationSourceOpportunityDetailDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceOpportunityDetailDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceOpportunityDetailDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationSourceOpportunityDetail::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceOpportunityDetailDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceOpportunityDetailDocumentDTO::parse($model);
