...
use Wgroup\CertificateGradeParticipant\CertificateGradeParticipantDTO;
use Wgroup\CertificateGradeParticipant\CertificateGradeParticipantService;
...
class CertificateGradeParticipantController extends BaseController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            if ($operation == "audit") {
                ...
                $result = CertificateGradeParticipantDTO::parse($data, "2");
            } else {
                ...
                $result = CertificateGradeParticipantDTO::parse($data);
            }
    ...
    public function filterIndex()
    {
        ...
        try {
            ...
            // extract info
            $result = CertificateGradeParticipantDTO::parse($resultData, "2");
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CertificateGradeParticipantDTO::fillAndSaveModel($info);

            $result = CertificateGradeParticipantDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CertificateGradeParticipant::find($id))) {
    ...
    public function validate()
    {
        ...
        try {
            ...
            $model = CertificateGradeParticipant::where('validateCodeCertificate', $id)->first();
    ...
    public function download()
    {
        ...
        try {
            ...
            $model = CertificateGradeParticipant::where('identificationNumber', $id)->where('hasCertificate', '1')->orderBy('certificateCreatedAt', 'desc')->first();
    ...
    public function export()
    {
        ...
        try {
            ...
            $model = CertificateGradeParticipantDTO::find($id);
    ...
    public function downloadCertificate()
    {
        ...
        try {
            ...
            $pathToFile = public_path() . "/uploads/public/certificate/$file";
            //$pathToFile = public_path() . "/uploads/public/certificate/$file";
            $pathToFile = str_replace("/certificado", "/sylogi", $pathToFile);
    ...
    public function streamCertificate()
    {
        ...
        try {
            ...
            $pathToFile = str_replace("certificado", "sylogi", public_path()) . "/uploads/public/certificate/$file";
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CertificateGradeParticipant::find($id);
