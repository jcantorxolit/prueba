...
use Wgroup\CertificateLogBookDocument\CertificateLogBookDocument;
use Wgroup\CertificateLogBookDocument\CertificateLogBookDocumentDTO;
use Wgroup\CertificateLogBookDocument\CertificateLogBookDocumentService;
 ...
 * @author Andres Mejia
 */
class CertificateLogBookDocumentController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CertificateLogBookDocumentService();
    ...
    public function index(){
        ...
        $certificateGradeParticipantId = $this->getUser()->id;
        ...
        try {
            ...
            // extract info
            $result = CertificateLogBookDocumentDTO::parse($data, "2");
    ...
    public function users(){
        ...
        try {
            ...
            // extract info
            $result = CertificateLogBookDocumentDTO::parse($data, "3");
    ...
    public function save() {
        ...
        try {
            ...
            $model = CertificateLogBookDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CertificateLogBookDocumentDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CertificateLogBookDocument::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CertificateLogBookDocument::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CertificateLogBookDocument::find($customer))) {
    ...
    public function download()
    {
        ...
        try {
            ...
            //$this->response->setResult($result);
            $file = str_replace("/certificado", "",public_path()). $result->document->path;
