...
class CategoryManagementController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new ProgramManagementCategoryService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = ProgramManagementCategoryDTO::parse($data, '2');
    ...
    {
        try {
            $programId = $this->request->get("program_id", "0");
            //$data = CustomerConfigWorkPlace::whereCustomerId($customerId)->whereStatus('Activo')->whereType('MPP')->get();
            $data = ProgramManagementCategory::whereStatus('Activo')->whereProgramId($programId)->get();
    ...
    public function save() {
        ...
        try {
           ...
           $json = base64_decode($text);
            ...
            $model = ProgramManagementCategoryDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = ProgramManagementCategoryDTO::parse($model, '2');
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = ProgramManagementCategory::find($id))) {
