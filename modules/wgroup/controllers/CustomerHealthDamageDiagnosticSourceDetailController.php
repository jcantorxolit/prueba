...
use Wgroup\CustomerHealthDamageDiagnosticSourceDetail\CustomerHealthDamageDiagnosticSourceDetail;
use Wgroup\CustomerHealthDamageDiagnosticSourceDetail\CustomerHealthDamageDiagnosticSourceDetailDTO;
use Wgroup\CustomerHealthDamageDiagnosticSourceDetail\CustomerHealthDamageDiagnosticSourceDetailService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageDiagnosticSourceDetailController extends BaseController {
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageDiagnosticSourceDetailDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageDiagnosticSourceDetailDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageDiagnosticSourceDetailDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageDiagnosticSourceDetail::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageDiagnosticSourceDetailDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageDiagnosticSourceDetailDocumentDTO::parse($model);
