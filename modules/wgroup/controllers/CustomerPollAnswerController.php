...
use Wgroup\CustomerPollAnswer\CustomerPollAnswerDTO;
use Wgroup\CustomerPollAnswer\CustomerPollAnswerService;
 ...
 * @author Andres Mejia
 */
class CustomerPollAnswerController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerPollAnswerService();
    ...
    public function index(){
        ...
        try {
            ...
            **/
            ...
            // extract info
            $result = CustomerPollAnswerDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerPollAnswerDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerPollAnswerDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerPollAnswer::find($traking))) {
                throw new Exception("Customer not found to delete.");
            }

            // limpiar los contactos
            foreach ($model->alerts as $mc) {
                $mc->delete();
            }
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerPollAnswer::find($id))) {
                throw new \Exception("Customer not found", 404);
            }

            //Get data
            $result = CustomerPollAnswerDTO::parse($model, "2");
