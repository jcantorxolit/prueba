...
use Wgroup\CustomerOccupationalReportIncident\CustomerOccupationalReportIncident;
use Wgroup\CustomerOccupationalReportIncident\CustomerOccupationalReportIncidentDTO;
use Wgroup\CustomerOccupationalReportIncident\CustomerOccupationalReportIncidentService;
 ...
 * @author Andres Mejia
 */
class CustomerOccupationalReportIncidentController extends BaseController {
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            //$result = CustomerOccupationalReportIncidentDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerOccupationalReportIncidentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerOccupationalReportIncidentDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerOccupationalReportIncident::find($traking))) {
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerOccupationalReportIncident::find($id))) {
    ...
    public function download()
    {
        ...
        try {
            ...
            $report['arl_url'] = $model != null && \AdeN\Api\Helpers\FileSystemHelper::attachInstance($model->logo) != null ? \AdeN\Api\Helpers\FileSystemHelper::attachInstance($model->logo)->path : '';
            ...
            return  $pdf->download('Reporte_Incidente.pdf');
