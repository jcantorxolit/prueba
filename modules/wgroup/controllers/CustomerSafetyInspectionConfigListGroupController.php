...
use Wgroup\CustomerSafetyInspectionConfigListGroup\CustomerSafetyInspectionConfigListGroup;
use Wgroup\CustomerSafetyInspectionConfigListGroup\CustomerSafetyInspectionConfigListGroupDTO;
use Wgroup\CustomerSafetyInspectionConfigListGroup\CustomerSafetyInspectionConfigListGroupService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerSafetyInspectionConfigListGroupController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerSafetyInspectionConfigListGroupService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerSafetyInspectionConfigListGroupDTO::parse($data);
    ...
    public function listIndex()
    {
        ...
        try {
            ...
            $data = CustomerSafetyInspectionConfigListGroupDTO::parse(CustomerSafetyInspectionConfigListGroup::whereCustomerSafetyInspectionConfigListId($listId)
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerSafetyInspectionConfigListGroupDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerSafetyInspectionConfigListGroupDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerSafetyInspectionConfigListGroup::find($id))) {
