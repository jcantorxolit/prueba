...
use Wgroup\CustomerHealthDamageQualificationLostNationalDiagnostic\CustomerHealthDamageQualificationLostNationalDiagnosticService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationLostNationalDiagnosticController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageQualificationLostNationalDiagnosticService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationLostNationalDiagnosticDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostNationalDiagnosticDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostNationalDiagnosticDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationLostNationalDiagnostic::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostNationalDiagnosticDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostNationalDiagnosticDocumentDTO::parse($model);
