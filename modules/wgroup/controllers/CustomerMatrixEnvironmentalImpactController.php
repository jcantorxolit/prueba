...
use Wgroup\CustomerMatrixEnvironmentalImpact\CustomerMatrixEnvironmentalImpactService;
use DB;
use Validator;
use Input;
use Excel;
...
use Carbon\Carbon;
use Wgroup\CustomerMatrixEnvironmentalImpact\CustomerMatrixEnvironmentalImpactStaging;
 ...
 * @author Andres Mejia
 */
class CustomerMatrixEnvironmentalImpactController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerMatrixEnvironmentalImpactService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerMatrixEnvironmentalImpactDTO::parse($data);
    ...
    public function getList()
    {
        ...
        try {
            ...
            $result = CustomerMatrixEnvironmentalImpact::whereCustomerMatrixId($customerMatrixId)->where('isActive', 1)->get();
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerMatrixEnvironmentalImpactDTO::fillAndSaveModel($info);

            $result = CustomerMatrixEnvironmentalImpactDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new CustomerMatrixEnvironmentalImpactDTO();
            }
            else {
                if (!($model = CustomerMatrixEnvironmentalImpact::find($id))) {
    ...
    protected function checkImportPostBack($uploadedFile, $customerId, $workPlaceId, $macroProcessId)
    {
        ...
        try {
            ...
            Excel::load($uploadedFile, function ($file) use ($customerId, $workPlaceId, $macroProcessId)
            {
                ...
                if (count($data) > 0) {
                    // var_dump($data);
                    CustomerMatrixEnvironmentalImpactStaging::truncate();
                    CustomerMatrixEnvironmentalImpactStaging::insert($data);
