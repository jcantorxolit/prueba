...
use Wgroup\RoadSafetyItemDetail\RoadSafetyItemDetailService;
 ...
 * @author Andres Mejia
 */
class RoadSafetyItemDetailController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new RoadSafetyItemDetailService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = RoadSafetyItemDetailDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = RoadSafetyItemDetailDTO::fillAndSaveModel($info);

            $result = RoadSafetyItemDetailDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new RoadSafetyItemDetailDTO();
            } else {
                if (!($model = RoadSafetyItemDetail::find($id))) {
