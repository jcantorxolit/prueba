...
use Wgroup\CustomerSafetyInspectionConfigHeader\CustomerSafetyInspectionConfigHeader;
use Wgroup\CustomerSafetyInspectionConfigHeader\CustomerSafetyInspectionConfigHeaderDTO;
use Wgroup\CustomerSafetyInspectionConfigHeader\CustomerSafetyInspectionConfigHeaderService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerSafetyInspectionConfigHeaderController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerSafetyInspectionConfigHeaderService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerSafetyInspectionConfigHeaderDTO::parse($data);
    ...
    public function listIndex()
    {
        ...
        try {
            ...
            $data = CustomerSafetyInspectionConfigHeaderDTO::parse(CustomerSafetyInspectionConfigHeader::whereCustomerId($customerId)
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerSafetyInspectionConfigHeaderDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerSafetyInspectionConfigHeaderDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerSafetyInspectionConfigHeader::find($id))) {
