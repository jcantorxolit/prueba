...
class CustomerImprovementPlanController extends BaseController
{
    ...
    public function index()
    {
        ...
        $entityName = $this->request->get("entity_type", "");
...
*/
            ...
            if ($customerId != "0") {
                ...
                $data = $this->service->getAllByEntity(@$search['value'], $length, $currentPage, $entityId, $entityName, $audit);
                $recordsTotal = $this->service->getCountEntity("", $entityId, $entityName, null);
                $recordsFiltered = $this->service->getCountEntity(@$search['value'], $entityId, $entityName, $audit);
            }


            // extract info
            $result = CustomerImprovementPlanDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerImprovementPlanDTO::parse($model);
    ...
    public function getEntity()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlan::where('entityId', $entityId)->where('entityName', $entityName)->first();
