...
use Wgroup\CustomerContractorSafetyInspectionConfigListValidation\CustomerContractorSafetyInspectionConfigListValidation;
use Wgroup\CustomerContractorSafetyInspectionConfigListValidation\CustomerContractorSafetyInspectionConfigListValidationDTO;
use Wgroup\CustomerContractorSafetyInspectionListItem\CustomerContractorSafetyInspectionListItem;
use Wgroup\CustomerContractorSafetyInspectionListItem\CustomerContractorSafetyInspectionListItemDTO;
use Wgroup\CustomerContractorSafetyInspectionListItem\CustomerContractorSafetyInspectionListItemService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerContractorSafetyInspectionListItemController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerContractorSafetyInspectionListItemService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerContractorSafetyInspectionListItemDTO::parse($data);
        ...
        foreach ($questions as $question) {
            ...
            if ($question->groupId == $group->id) {
                ...
                if ($question->dangerousnessValue != null) {
                    $question->dangerousness = new CustomerContractorSafetyInspectionConfigListValidation();
                    if (($model = CustomerContractorSafetyInspectionConfigListValidation::find($question->dangerousnessValue))) {
                        $question->dangerousness = CustomerContractorSafetyInspectionConfigListValidationDTO::parse($model);
                    }
                }

                if ($question->existingControlValue != null) {
                    $question->existingControl = new CustomerContractorSafetyInspectionConfigListValidation();
                    if (($model = CustomerContractorSafetyInspectionConfigListValidation::find($question->existingControlValue))) {
                        $question->existingControl = CustomerContractorSafetyInspectionConfigListValidationDTO::parse($model);
                    }
                }
                ...
                $question->action = CustomerContractorSafetyInspectionListItem::getAction($question->action);
    ...
    public function listIndex()
    {
        ...
        try {
            ...
            $data = CustomerContractorSafetyInspectionListItemDTO::parse(CustomerContractorSafetyInspectionListItem::whereCustomerContractorSafetyInspectionConfigListId($listId)
                ->whereIsActive(1)->get());
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerContractorSafetyInspectionListItemDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerContractorSafetyInspectionListItemDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerContractorSafetyInspectionListItem::find($id))) {
