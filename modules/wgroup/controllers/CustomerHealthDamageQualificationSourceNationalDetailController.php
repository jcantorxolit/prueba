...
use Wgroup\CustomerHealthDamageQualificationSourceNationalDetail\CustomerHealthDamageQualificationSourceNationalDetail;
use Wgroup\CustomerHealthDamageQualificationSourceNationalDetail\CustomerHealthDamageQualificationSourceNationalDetailDTO;
use Wgroup\CustomerHealthDamageQualificationSourceNationalDetail\CustomerHealthDamageQualificationSourceNationalDetailService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationSourceNationalDetailController extends BaseController {
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationSourceNationalDetailDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceNationalDetailDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceNationalDetailDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationSourceNationalDetail::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceNationalDetailDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceNationalDetailDocumentDTO::parse($model);
