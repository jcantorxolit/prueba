...
use Wgroup\CustomerSafetyInspectionConfigHeaderField\CustomerSafetyInspectionConfigHeaderFieldService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerSafetyInspectionConfigHeaderFieldController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerSafetyInspectionConfigHeaderFieldService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerSafetyInspectionConfigHeaderFieldDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerSafetyInspectionConfigHeaderFieldDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerSafetyInspectionConfigHeaderFieldDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerSafetyInspectionConfigHeaderField::find($id))) {
