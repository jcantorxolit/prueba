 ...
 * @author Andres Mejia
 */
class CustomerDiagnosticWorkPlaceController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new ServiceCustomerDiagnosticWorkPlace();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerDiagnosticWorkPlaceDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerDiagnosticWorkPlaceDTO::fillAndSaveModel($info);

            $result = CustomerDiagnosticWorkPlaceDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new CustomerDiagnosticWorkPlaceDTO();
            }
            else {
                if (!($model = CustomerDiagnosticWorkPlace::find($id))) {
