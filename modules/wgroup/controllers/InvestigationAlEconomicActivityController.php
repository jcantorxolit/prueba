...
use Wgroup\InvestigationAlEconomicActivity\InvestigationAlEconomicActivityDTO;
use Wgroup\InvestigationAlEconomicActivity\InvestigationAlEconomicActivityService;
 ...
 * @author Andres Mejia
 */
class InvestigationAlEconomicActivityController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new InvestigationAlEconomicActivityService();
    ...
    public function index()
    {
        ...
        $investigationCategoryCause = $this->request->get("investigation_cause_category", "0");
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, array());
            ...
            // extract info
            $result = InvestigationAlEconomicActivityDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = InvestigationAlEconomicActivityDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = InvestigationAlEconomicActivityDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = InvestigationAlEconomicActivity::find($id))) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = InvestigationAlEconomicActivityDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = InvestigationAlEconomicActivityDocumentDTO::parse($model);
