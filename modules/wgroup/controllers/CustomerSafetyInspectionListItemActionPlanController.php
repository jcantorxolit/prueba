...
use Wgroup\CustomerSafetyInspectionListItemActionPlan\CustomerSafetyInspectionListItemActionPlan;
use Wgroup\CustomerSafetyInspectionListItemActionPlan\CustomerSafetyInspectionListItemActionPlanDTO;
use Wgroup\CustomerSafetyInspectionListItemActionPlan\CustomerSafetyInspectionListItemActionPlanService;
use Wgroup\CustomerSafetyInspectionListItemActionPlan\CustomerSafetyInspectionListItemActionPlanActionPlan;
use Wgroup\CustomerSafetyInspectionListItemActionPlan\CustomerSafetyInspectionListItemActionPlanActionPlanDTO;
 ...
 */
class CustomerSafetyInspectionListItemActionPlanController extends BaseController {
    ...
    public function index($programId = 0, $managementId = 0){
        ...
        try {
            ...
            $data["questions"] = CustomerSafetyInspectionListItemActionPlanDTO::parse($questions);

           // $modelCategories = ProgramPreventionCategoryDTO::parse($categories);
            //$modelQuestions = CustomerSafetyInspectionListItemActionPlanDTO::parse($questions);
...
*/
    ...
    public function getActionPlan()
    {
        ...
        try {
            ...
            */
            ...
            if (!($model = CustomerSafetyInspectionListItemActionPlanActionPlan::find($id))) {
                throw new \Exception("Customer not found", 404);
            }


            //Get data
            $result = CustomerSafetyInspectionListItemActionPlanActionPlanDTO::parse($model);
        ...
        foreach($dtos as $program){
            ...
            foreach($questions as $question){
                if($question->program_id == $program->id){
                    $question->plan = new CustomerSafetyInspectionListItemActionPlanActionPlanDTO();
                    if (($mdlActionPlan = CustomerSafetyInspectionListItemActionPlanActionPlan::find($question->actionPlanId))) {
                        $question->plan = CustomerSafetyInspectionListItemActionPlanActionPlanDTO::parse($mdlActionPlan);
    ...
    public function save() {
        ...
        try {
            ...
            //Get data
            $model = CustomerSafetyInspectionListItemActionPlanDTO::fillAndSaveModel($info);

            $result = CustomerSafetyInspectionListItemActionPlanDTO::parse($model);
    ...
    public function get() {
        ...
        try {
            ...
            if(!($model = CustomerSafetyInspectionListItemActionPlan::find($id))){
