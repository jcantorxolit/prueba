...
use Wgroup\CustomerDiagnosticPreventionDocumentQuestion\CustomerDiagnosticPreventionDocumentQuestionService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerDiagnosticPreventionDocumentQuestionController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerDiagnosticPreventionDocumentQuestionService();
    ...
    public function index(){
        ...
        $customerDiagnosticPreventionDocumentId = $this->request->get("customer_diagnostic_prevention_document_id", "0");
        ...
        try {
            ...
            $data = $this->service->getAllBySearch(@$search['value'], $length, $currentPage, $orders, "", $customerDiagnosticPreventionDocumentId);

            // Counts
            $recordsTotal = $this->service->getAllBySearchCount("", $customerDiagnosticPreventionDocumentId);
            $recordsFiltered = $this->service->getAllBySearchCount(@$search['value'], $customerDiagnosticPreventionDocumentId);

            // extract info
            $result = $data;//CustomerDiagnosticPreventionDocumentQuestionDTO::parse($data);
    ...
    public function filterSelected(){
        ...
        try {
            ...
            // get all tracking by customer with pagination
            $data = $this->service->getAllBySearchSelected(@$search['value'], $length, $currentPage, $orders, "", $customerDiagnosticPreventionDocumentId);

            // Counts
            $recordsTotal = $this->service->getAllBySearchSelectedCount("", $customerDiagnosticPreventionDocumentId);
            $recordsFiltered = $this->service->getAllBySearchSelectedCount(@$search['value'], $customerDiagnosticPreventionDocumentId);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerDiagnosticPreventionDocumentQuestionDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerDiagnosticPreventionDocumentQuestionDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerDiagnosticPreventionDocumentQuestion::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerDiagnosticPreventionDocumentQuestion::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerDiagnosticPreventionDocumentQuestion::find($customer))) {
