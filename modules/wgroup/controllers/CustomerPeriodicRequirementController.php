...
use Wgroup\CustomerPeriodicRequirement\CustomerPeriodicRequirement;
use Wgroup\CustomerPeriodicRequirement\CustomerPeriodicRequirementDTO;
use Wgroup\CustomerPeriodicRequirement\CustomerPeriodicRequirementService;
 ...
 * @author Andres Mejia
 */
class CustomerPeriodicRequirementController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerPeriodicRequirementService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerPeriodicRequirementDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerPeriodicRequirementDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerPeriodicRequirementDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerPeriodicRequirement::find($traking))) {
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerPeriodicRequirement::find($id))) {
