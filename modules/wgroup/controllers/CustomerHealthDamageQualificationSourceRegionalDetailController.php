...
use Wgroup\CustomerHealthDamageQualificationSourceRegionalDetail\CustomerHealthDamageQualificationSourceRegionalDetail;
use Wgroup\CustomerHealthDamageQualificationSourceRegionalDetail\CustomerHealthDamageQualificationSourceRegionalDetailDTO;
use Wgroup\CustomerHealthDamageQualificationSourceRegionalDetail\CustomerHealthDamageQualificationSourceRegionalDetailService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationSourceRegionalDetailController extends BaseController {
    ...
    public function index()
    {
        ...
        $customerHealthDamageId = $this->request->get("customer_health_damage_regional_id", "0");
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationSourceRegionalDetailDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceRegionalDetailDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceRegionalDetailDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationSourceRegionalDetail::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceRegionalDetailDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceRegionalDetailDocumentDTO::parse($model);
