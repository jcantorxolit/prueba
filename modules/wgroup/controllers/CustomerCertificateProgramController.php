...
use Wgroup\CustomerCertificateProgram\CustomerCertificateProgram;
use Wgroup\CustomerCertificateProgram\CustomerCertificateProgramDTO;
use Wgroup\CustomerCertificateProgram\CustomerCertificateProgramService;
 ...
 * @author Andres Mejia
 */
class CustomerCertificateProgramController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerCertificateProgramService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerCertificateProgramDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerCertificateProgramDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerCertificateProgramDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerCertificateProgram::find($traking))) {
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerCertificateProgram::find($id))) {
