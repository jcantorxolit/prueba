...
use Wgroup\CustomerInvestigationAlCause\CustomerInvestigationAlCauseService;
 ...
 * @author Andres Mejia
 */
class CustomerInvestigationAlCauseController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerInvestigationAlCauseService();
    ...
    public function index()
    {
        ...
        $customerInvestigationId = $this->request->get("customer_investigation_id", "0");
        ...
        try {
            ...
            // extract info
            $result = CustomerInvestigationAlCauseDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerInvestigationAlCauseDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlCauseDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerInvestigationAlCause::find($id))) {
    ...
    public function get()
    {
        ...
        try {
            ...
            if (!($model = CustomerInvestigationAlCause::whereCustomerInvestigationId($id)->first())) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerInvestigationAlCauseDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlCauseDocumentDTO::parse($model);
