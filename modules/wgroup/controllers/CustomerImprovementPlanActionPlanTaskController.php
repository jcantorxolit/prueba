...
use Wgroup\CustomerImprovementPlanActionPlanTask\CustomerImprovementPlanActionPlanTask;
use Wgroup\CustomerImprovementPlanActionPlanTask\CustomerImprovementPlanActionPlanTaskDTO;
use Wgroup\CustomerImprovementPlanActionPlanTask\CustomerImprovementPlanActionPlanTaskService;
 ...
 * @author Andres Mejia
 */
class CustomerImprovementPlanActionPlanTaskController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerImprovementPlanActionPlanTaskService();
    ...
    public function index()
    {
        ...
        $customerImprovementPlanActionPlanId = $this->request->get("improvement_action_plan_id", "0");
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, $orders, $customerImprovementPlanActionPlanId, $audit);
            $recordsTotal = $this->service->getCount("", $customerImprovementPlanActionPlanId, null);
            $recordsFiltered = $this->service->getCount(@$search['value'], $customerImprovementPlanActionPlanId, $audit);

            // extract info
            $result = CustomerImprovementPlanActionPlanTaskDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanActionPlanTaskDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerImprovementPlanActionPlanTaskDTO::parse($model);
    ...
    public function update()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanActionPlanTaskDTO::updateModel($info);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerImprovementPlanActionPlanTask::find($id))) {
    ...
    public function getEntity()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanActionPlanTask::where('entityId', $entityId)->where('entityName', $entityName)->first();
