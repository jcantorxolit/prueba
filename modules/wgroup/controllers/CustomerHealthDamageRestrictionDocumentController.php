...
use Wgroup\CustomerHealthDamageRestrictionDocument\CustomerHealthDamageRestrictionDocument;
use Wgroup\CustomerHealthDamageRestrictionDocument\CustomerHealthDamageRestrictionDocumentDTO;
use Wgroup\CustomerHealthDamageRestrictionDocument\CustomerHealthDamageRestrictionDocumentService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageRestrictionDocumentController extends BaseController {
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageRestrictionDocumentDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageRestrictionDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageRestrictionDocumentDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageRestrictionDocument::find($id))) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerHealthDamageRestrictionDocument::find($document);
