...
use Wgroup\CustomerHealthDamageDiagnosticSource\CustomerHealthDamageDiagnosticSource;
use Wgroup\CustomerHealthDamageDiagnosticSource\CustomerHealthDamageDiagnosticSourceDTO;
use Wgroup\CustomerHealthDamageDiagnosticSource\CustomerHealthDamageDiagnosticSourceService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageDiagnosticSourceController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageDiagnosticSourceService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageDiagnosticSourceDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageDiagnosticSourceDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageDiagnosticSourceDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageDiagnosticSource::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageDiagnosticSourceDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageDiagnosticSourceDocumentDTO::parse($model);
