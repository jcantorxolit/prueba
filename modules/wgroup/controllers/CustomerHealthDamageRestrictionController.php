...
use Wgroup\CustomerHealthDamageRestriction\CustomerHealthDamageRestriction;
use Wgroup\CustomerHealthDamageRestriction\CustomerHealthDamageRestrictionDTO;
use Wgroup\CustomerHealthDamageRestriction\CustomerHealthDamageRestrictionService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageRestrictionController extends BaseController {
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageRestrictionDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageRestrictionDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageRestrictionDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageRestriction::find($id))) {
