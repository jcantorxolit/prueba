...
class CustomerTrackingController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new ServiceCustomerTracking();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerTrackingDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerTrackingDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerTrackingDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerTracking::find($traking))) {
    ...
    public function get()
    {
        ...
        try {
            ...
            if (!($model = CustomerTracking::find($id))) {
    ...
    public function agent()
    {
        ...
        try {
            ...
            // extract info
            $result = $data; //CustomerProjectDTO::parse($data, "7");
