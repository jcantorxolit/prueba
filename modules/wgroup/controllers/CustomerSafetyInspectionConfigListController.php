...
use Wgroup\CustomerSafetyInspectionConfigList\CustomerSafetyInspectionConfigList;
use Wgroup\CustomerSafetyInspectionConfigList\CustomerSafetyInspectionConfigListDTO;
use Wgroup\CustomerSafetyInspectionConfigList\CustomerSafetyInspectionConfigListService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerSafetyInspectionConfigListController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerSafetyInspectionConfigListService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerSafetyInspectionConfigListDTO::parse($data);
    ...
    public function listIndex()
    {
        ...
        try {
            ...
            $data = CustomerSafetyInspectionConfigListDTO::parse(CustomerSafetyInspectionConfigList::whereCustomerId($customerId)
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerSafetyInspectionConfigListDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerSafetyInspectionConfigListDTO::parse($model);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerSafetyInspectionConfigList::find($id))) {
