 ...
 * @author Andres Mejia
 */
class CustomerImprovementPlanCauseSubCauseController extends BaseController
{
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanCauseSubCauseDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerImprovementPlanCauseSubCauseDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerImprovementPlanCauseSubCause::find($id))) {
    ...
    public function getEntity()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanCauseSubCause::where('entityId', $entityId)->where('entityName', $entityName)->first();
