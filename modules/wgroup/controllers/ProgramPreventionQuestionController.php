...
use Wgroup\ProgramPreventionQuestion\ProgramPreventionQuestionService;
use Excel;
 ...
 * @author Andres Mejia
 */
class ProgramPreventionQuestionController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new ProgramPreventionQuestionService();
    ...
    public function index(){
        ...
        try {
            ...
            // Counts
            $recordsTotal = $this->service->getAllBySearchCount("");
            $recordsFiltered = $this->service->getAllBySearchCount(@$search['value']);

            // extract info
            $result = $data;//ProgramPreventionQuestionDTO::parse($data, "2");
    ...
    public function save() {
        ...
        try {
            ...
            $model = ProgramPreventionQuestionDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = ProgramPreventionQuestionDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = ProgramPreventionQuestion::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = ProgramPreventionQuestion::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = ProgramPreventionQuestion::find($customer))) {
