...
use Wgroup\CustomerAbsenteeismIndirectCost\CustomerAbsenteeismIndirectCostService;
 ...
 * @author Andres Mejia
 */
class CustomerAbsenteeismDisabilityIndirectCostController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerAbsenteeismIndirectCostService();
    ...
    public function index(){
        ...
        try {
            ...
            $data = $this->service->getAllByPermission(@$search['value'], $length, $currentPage, $orders, "", $customerDisabilityId);
            ...
            // extract info
            $result = CustomerAbsenteeismIndirectCostDTO::parse($data, "2");
    ...
    public function users(){
        ...
        try {
            ...
            // extract info
            $result = CustomerAbsenteeismIndirectCostDTO::parse($data, "3");
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerAbsenteeismIndirectCostDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerAbsenteeismIndirectCostDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerAbsenteeismIndirectCost::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerAbsenteeismIndirectCost::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerAbsenteeismIndirectCost::find($customer))) {
