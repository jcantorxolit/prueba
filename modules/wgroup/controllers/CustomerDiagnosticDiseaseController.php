...
use Wgroup\Classes\ServiceCustomerDiagnosticDisease;
...
use Wgroup\Models\CustomerDiagnosticDiseaseDTO;
 ...
 * @author Andres Mejia
 */
class CustomerDiagnosticDiseaseController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new ServiceCustomerDiagnosticDisease();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerDiagnosticDiseaseDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerDiagnosticDiseaseDTO::fillAndSaveModel($info);

            $result = CustomerDiagnosticDiseaseDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new CustomerDiagnosticDiseaseDTO();
            }
            else {
                if (!($model = CustomerDiagnosticDisease::find($id))) {
