...
use Wgroup\Classes\ServiceAgent;
...
class AgentController extends BaseController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            // Counts
            $recordCount = $this->service->getAllRecordsCount();
            $recordCountFilter = $this->service->getAllRecordsCount(@$search['value']);

            // extract info
            $result = AgentDTO::parse($data);
    ...
    public function getByCustomer()
    {
        ...
        try {
            ...
            // get all ideas with pagination
            $data = $this->service->getAllByCustomer(@$search['value'], $length, $currentPage, $orders, '', $customerId);

            // Counts
            $recordCount = $this->service->getAllByCustomerCount('', $customerId);
            $recordCountFilter = $this->service->getAllByCustomerCount(@$search['value'], $customerId);
    ...
    protected function checkUploadPostback($uploadedFile, $model)
    {
        ...
        try {
            ...
            $validationRules[] = 'mimes:jpg,png,jpeg,bmp,gif,msg';
