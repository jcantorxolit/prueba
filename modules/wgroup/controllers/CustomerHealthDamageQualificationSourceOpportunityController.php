...
use Wgroup\CustomerHealthDamageQualificationSourceOpportunity\CustomerHealthDamageQualificationSourceOpportunityService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationSourceOpportunityController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageQualificationSourceOpportunityService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationSourceOpportunityDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceOpportunityDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceOpportunityDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationSourceOpportunity::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceOpportunityDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceOpportunityDocumentDTO::parse($model);
