...
use Wgroup\CustomerInvestigationAlMeasureTrackingEvidence\CustomerInvestigationAlMeasureTrackingEvidence;
use Wgroup\CustomerInvestigationAlMeasureTrackingEvidence\CustomerInvestigationAlMeasureTrackingEvidenceDTO;
use Wgroup\CustomerInvestigationAlMeasureTrackingEvidence\CustomerInvestigationAlMeasureTrackingEvidenceService;
 ...
 * @author Andres Mejia
 */
class CustomerInvestigationAlMeasureTrackingEvidenceController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerInvestigationAlMeasureTrackingEvidenceService();
    ...
    public function index()
    {
        ...
        $customerInvestigationMeasureTrackingId = $this->request->get("investigation_measure_tracking_id", "0");
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, array(), $customerInvestigationMeasureTrackingId);

            // Counts
            //$recordsTotal = $this->service->getCount("", $customerId);
            //$recordsFiltered = $this->service->getCount(@$search['value'], $customerId);

            $recordsTotal = $this->service->getCount("", $customerInvestigationMeasureTrackingId);
            $recordsFiltered = $this->service->getCount(@$search['value'], $customerInvestigationMeasureTrackingId);

            // extract info
            $result = CustomerInvestigationAlMeasureTrackingEvidenceDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerInvestigationAlMeasureTrackingEvidenceDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlMeasureTrackingEvidenceDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerInvestigationAlMeasureTrackingEvidence::find($id))) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerInvestigationAlMeasureTrackingEvidence::find($document);
