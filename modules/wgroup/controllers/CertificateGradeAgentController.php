...
use Wgroup\CertificateGradeAgent\CertificateGradeAgent;
use Wgroup\CertificateGradeAgent\CertificateGradeAgentDTO;
use Wgroup\CertificateGradeAgent\CertificateGradeAgentService;
use Wgroup\CertificateGradeAgent\CertificateGradeCalendarService;
use Wgroup\CertificateGradeAgent\CertificateGradeCalendar;
use Wgroup\CertificateGradeAgent\CertificateGradeCalendarDTO;
 ...
 * @author Andres Mejia
 */
class CertificateGradeAgentController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CertificateGradeAgentService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CertificateGradeAgentDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CertificateGradeAgentDTO::fillAndSaveModel($info);

            $result = CertificateGradeAgentDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CertificateGradeAgent::find($id))) {
    ...
    public function generateCertificate()
    {
        ...
        try {
            ...
            if (!($model = CertificateGradeAgent::find($id))) {
                throw new Exception("CertificateGradeAgent not found to delete.");
            }
...
*/
    ...
    public function export()
    {
        ...
        try {
            ...
            $model = CertificateGradeAgentDTO::find($id);
