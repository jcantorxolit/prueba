...
use Wgroup\CustomerInvestigationAlMeasure\CustomerInvestigationAlMeasureService;
 ...
 * @author Andres Mejia
 */
class CustomerInvestigationAlMeasureController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerInvestigationAlMeasureService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerInvestigationAlMeasureDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerInvestigationAlMeasureDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlMeasureDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerInvestigationAlMeasure::find($id))) {
                throw new Exception("Customer not found to delete.");
            }

            CustomerInvestigationAlMeasureTracking::where("customer_investigation_measure_id", $id)->delete();
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerInvestigationAlMeasureDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlMeasureDocumentDTO::parse($model);
