...
use Wgroup\PollQuestion\PollQuestion;
use Wgroup\PollQuestion\PollQuestionDTO;
use Wgroup\PollQuestion\PollQuestionService;
...
class PollQuestionController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new PollQuestionService();
    ...
    public function index(){
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, $orders, "", $pollId);
            ...
            // extract info
            $result = PollQuestionDTO::parse($data, "2");
    ...
    public function save() {
        ...
        try {
            ...
            $model = PollQuestionDTO::fillAndSaveModel($info);

            $result = PollQuestionDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = PollQuestion::find($traking))) {
