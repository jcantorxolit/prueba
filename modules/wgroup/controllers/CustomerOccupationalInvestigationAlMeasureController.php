...
use Wgroup\CustomerOccupationalInvestigationAlMeasure\CustomerOccupationalInvestigationAlMeasure;
use Wgroup\CustomerOccupationalInvestigationAlMeasure\CustomerOccupationalInvestigationAlMeasureDTO;
use Wgroup\CustomerOccupationalInvestigationAlMeasure\CustomerOccupationalInvestigationAlMeasureService;
 ...
 * @author Andres Mejia
 */
class CustomerOccupationalInvestigationAlMeasureController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerOccupationalInvestigationAlMeasureService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerOccupationalInvestigationAlMeasureDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlMeasureDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerOccupationalInvestigationAlMeasureDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerOccupationalInvestigationAlMeasure::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlMeasureDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerOccupationalInvestigationAlMeasureDocumentDTO::parse($model);
