...
use Wgroup\CustomerRoadSafetyItemComment\CustomerRoadSafetyItemCommentService;
use Wgroup\CustomerRoadSafetyItemCommentItem\CustomerRoadSafetyItemCommentItemService;
 ...
 * @author Andres Mejia
 */
class CustomerRoadSafetyItemCommentController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerRoadSafetyItemCommentService();
    ...
    public function index()
    {
        ...
        try {
            ...
            //var_dump($data);
            // extract info
            $result = CustomerRoadSafetyItemCommentDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerRoadSafetyItemCommentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerRoadSafetyItemCommentDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if (!($model = CustomerRoadSafetyItemComment::find($id))) {
