...
use Wgroup\CustomerConfigHazardInterventionActionPlan\CustomerConfigHazardInterventionActionPlan;
use Wgroup\CustomerContractDetail\CustomerContractDetailService;
use Wgroup\CustomerConfigHazardInterventionActionPlan\CustomerConfigHazardInterventionActionPlanDTO;
use Wgroup\CustomerConfigHazardInterventionActionPlan\CustomerConfigHazardInterventionActionPlanService;
use Wgroup\CustomerConfigHazardInterventionActionPlan\CustomerConfigHazardInterventionActionPlanActionPlan;
use Wgroup\CustomerConfigHazardInterventionActionPlan\CustomerConfigHazardInterventionActionPlanActionPlanDTO;
 ...
 */
class CustomerConfigJobActivityInterventionActionPlanController extends BaseController {
    ...
    public function index($programId = 0, $managementId = 0){
        ...
        try {
            ...
            $data["questions"] = CustomerConfigHazardInterventionActionPlanDTO::parse($questions);

           // $modelCategories = ProgramPreventionCategoryDTO::parse($categories);
            //$modelQuestions = CustomerConfigHazardInterventionActionPlanDTO::parse($questions);
...
*/
    ...
    public function getActionPlan()
    {
        ...
        try {
            ...
            */
            ...
            if (!($model = CustomerConfigHazardInterventionActionPlanActionPlan::find($id))) {
                throw new \Exception("Customer not found", 404);
            }


            //Get data
            $result = CustomerConfigHazardInterventionActionPlanActionPlanDTO::parse($model);
        ...
        foreach($dtos as $program){
            ...
            foreach($questions as $question){
                if($question->program_id == $program->id){
                    $question->plan = new CustomerConfigHazardInterventionActionPlanActionPlanDTO();
                    if (($mdlActionPlan = CustomerConfigHazardInterventionActionPlanActionPlan::find($question->actionPlanId))) {
                        $question->plan = CustomerConfigHazardInterventionActionPlanActionPlanDTO::parse($mdlActionPlan);
    ...
    public function save() {
        ...
        try {
            ...
            //Get data
            $model = CustomerConfigHazardInterventionActionPlanDTO::fillAndSaveModel($info);

            $result = CustomerConfigHazardInterventionActionPlanDTO::parse($model);
    ...
    public function get() {
        ...
        try {
            ...
            if(!($model = CustomerConfigHazardInterventionActionPlan::find($id))){
