...
use Wgroup\CustomerInvestigationAlEvent\CustomerInvestigationAlEventService;
 ...
 * @author Andres Mejia
 */
class CustomerInvestigationAlEventController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerInvestigationAlEventService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerInvestigationAlEventDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerInvestigationAlEventDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlEventDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerInvestigationAlEvent::find($id))) {
    ...
    public function get() {
        ...
        try {
            ...
            $result['investigation'] = CustomerInvestigationAlDTO::parse(CustomerInvestigationAl::find($id));
            $result['eventLocation'] = $this->getModel($id, 'location');
            $result['eventVersion'] = $this->getModel($id, 'version');
            $result['eventCondition'] = $this->getModel($id, 'condition');
            $result['eventDocument'] = $this->getModel($id, 'document');
    ...
    {
        if (!($model = CustomerInvestigationAlEvent::whereCustomerInvestigationId($id)->whereType($type)->first())) {
            return null;
        }

        return CustomerInvestigationAlEventDTO::parse($model);
    }
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerInvestigationAlEvent::find($document);
