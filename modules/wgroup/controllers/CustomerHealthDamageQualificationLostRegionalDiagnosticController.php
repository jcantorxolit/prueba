...
use Wgroup\CustomerHealthDamageQualificationLostRegionalDiagnostic\CustomerHealthDamageQualificationLostRegionalDiagnosticService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationLostRegionalDiagnosticController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageQualificationLostRegionalDiagnosticService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationLostRegionalDiagnosticDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostRegionalDiagnosticDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostRegionalDiagnosticDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationLostRegionalDiagnostic::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostRegionalDiagnosticDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostRegionalDiagnosticDocumentDTO::parse($model);
