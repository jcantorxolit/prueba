...
use Wgroup\CustomerInvestigationAlFactor\CustomerInvestigationAlFactor;
use Wgroup\CustomerInvestigationAlFactor\CustomerInvestigationAlFactorDTO;
use Wgroup\CustomerInvestigationAlFactor\CustomerInvestigationAlFactorService;
 ...
 * @author Andres Mejia
 */
class CustomerInvestigationAlFactorController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerInvestigationAlFactorService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerInvestigationAlFactorDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerInvestigationAlFactorDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlFactorDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerInvestigationAlFactor::find($id))) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerInvestigationAlFactorDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerInvestigationAlFactorDocumentDTO::parse($model);
