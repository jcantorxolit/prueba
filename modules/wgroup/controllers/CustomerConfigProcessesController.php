...
use Wgroup\CustomerConfigProcesses\CustomerConfigProcesses;
...
use Carbon\Carbon;
use Wgroup\CustomerConfigProcesses\CustomerConfigProcessesStaging;
 ...
 * @author Andres Mejia
 */
class CustomerConfigProcessesController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerConfigProcessesService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerConfigProcessesDTO::parse($data);
    ...
    public function listIndex()
    {
        ...
        try {
            ...
            $data = CustomerConfigProcesses::whereCustomerId($customerId)
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerConfigProcessesDTO::fillAndSaveModel($info);

            $result = CustomerConfigProcessesDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new CustomerConfigProcessesDTO();
            }
            else {
                if (!($model = CustomerConfigProcesses::find($id))) {
    ...
    protected function checkImportPostBack($uploadedFile, $customerId, $workPlaceId, $macroProcessId)
    {
        ...
        try {
            ...
            Excel::load($uploadedFile, function ($file) use ($customerId, $workPlaceId, $macroProcessId)
            {
                ...
                if (count($data) > 0) {
                    // var_dump($data);
                    CustomerConfigProcessesStaging::truncate();
                    CustomerConfigProcessesStaging::insert($data);
