...
use Wgroup\InvestigationAlCause\InvestigationAlCauseService;
 ...
 * @author Andres Mejia
 */
class InvestigationAlCauseController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new InvestigationAlCauseService();
    ...
    public function index()
    {
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, array(), $investigationCategoryCause);

            // Counts
            //$recordsTotal = $this->service->getCount("", $customerId);
            //$recordsFiltered = $this->service->getCount(@$search['value'], $customerId);

            $recordsTotal = $this->service->getCount("", $investigationCategoryCause);
            $recordsFiltered = $this->service->getCount(@$search['value'], $investigationCategoryCause);

            // extract info
            $result = InvestigationAlCauseDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = InvestigationAlCauseDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = InvestigationAlCauseDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = InvestigationAlCause::find($id))) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = InvestigationAlCauseDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = InvestigationAlCauseDocumentDTO::parse($model);
