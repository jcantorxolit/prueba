...
use Wgroup\Classes\ServiceCustomerDiagnosticObservation;
use Wgroup\Classes\ServiceCustomerDiagnosticWorkPlace;
...
use Wgroup\Models\CustomerDiagnosticObservationDTO;
use Wgroup\Models\CustomerDiagnosticRiskFactorDTO;
 ...
 * @author Andres Mejia
 */
class CustomerDiagnosticObservationController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new ServiceCustomerDiagnosticObservation();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerDiagnosticObservationDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = CustomerDiagnosticObservationDTO::fillAndSaveModel($info);

            $result = CustomerDiagnosticObservationDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new CustomerDiagnosticObservationDTO();
            }
            else
            {
                if (!($model = CustomerDiagnosticObservation::find($id))) {
                    throw new \Exception("Diagnostic observation not found");
                }
