...
use Wgroup\CustomerInternalCertificateGradeCalendar\CustomerInternalCertificateGradeCalendarService;
 ...
 * @author Andres Mejia
 */
class CustomerInternalCertificateGradeCalendarController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerInternalCertificateGradeCalendarService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerInternalCertificateGradeCalendarDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerInternalCertificateGradeCalendarDTO::fillAndSaveModel($info);

            $result = CustomerInternalCertificateGradeCalendarDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerInternalCertificateGradeCalendar::find($id))) {
    ...
    public function generateCertificate()
    {
        ...
        try {
            ...
            if (!($model = CustomerInternalCertificateGradeCalendar::find($id))) {
                throw new Exception("CustomerInternalCertificateGradeCalendar not found to delete.");
            }
...
*/
    ...
    public function export()
    {
        ...
        try {
            ...
            $model = CustomerInternalCertificateGradeCalendarDTO::find($id);
