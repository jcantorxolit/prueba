...
use Wgroup\CustomerConfigRoadSafetyItemDetail\CustomerConfigRoadSafetyItemDetail;
use Wgroup\CustomerConfigRoadSafetyItemDetail\CustomerConfigRoadSafetyItemDetailDTO;
use Wgroup\CustomerConfigRoadSafetyItemDetail\CustomerConfigRoadSafetyItemDetailService;
 ...
 * @author Andres Mejia
 */
class CustomerConfigRoadSafetyItemDetailController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerConfigRoadSafetyItemDetailService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerConfigRoadSafetyItemDetailDTO::parse($data);
    ...
    {
        $customerId = $this->request->get("customer_id", "0");
        $roadSafetyItemId = $this->request->get("road_safety_item_id", "0");

        try {
            $data['verificationList'] = $this->service->getAll($customerId, $roadSafetyItemId);
            // set count total ideas
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerConfigRoadSafetyItemDetailDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerConfigRoadSafetyItemDetailDTO::parse($model);
    ...
    public function insert()
    {
        ...
        try {
            ...
            CustomerConfigRoadSafetyItemDetailDTO::bulkInsert($info->verificationList, $info->customerId);

            $info->verificationList = $this->service->getAll($info->customerId, $info->roadSafetyItemId);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerConfigRoadSafetyItemDetail::find($id))) {
    ...
    public function getEntity()
    {
        ...
        try {
            ...
            $model = CustomerConfigRoadSafetyItemDetail::where('entityId', $entityId)->where('entityName', $entityName)->first();
