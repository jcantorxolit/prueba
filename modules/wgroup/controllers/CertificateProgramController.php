...
use Wgroup\CertificateProgram\CertificateProgramService;
use Wgroup\CertificateProgramRequirement\CertificateProgramRequirement;
use Wgroup\CertificateProgramSpeciality\CertificateProgramSpeciality;
 ...
 * @author Andres Mejia
 */
class CertificateProgramController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CertificateProgramService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CertificateProgramDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CertificateProgramDTO::fillAndSaveModel($info);

            $result = CertificateProgramDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CertificateProgram::find($id))) {
    ...
    public function deleteSpeciality()
    {
        ...
        try {
            ...
            if (!($model = CertificateProgramSpeciality::find($id))) {
                throw new Exception("Program not found to delete.");
            }
    ...
    public function deleteRequirement()
    {
        ...
        try {
            ...
            if (!($model = CertificateProgramRequirement::find($id))) {
                throw new Exception("Program not found to delete.");
            }
...
*/
    ...
    public function export()
    {
        ...
        try {
            ...
            $model = CertificateProgramDTO::find($id);
