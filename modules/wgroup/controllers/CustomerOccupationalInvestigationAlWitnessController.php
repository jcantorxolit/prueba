 ...
 * @author Andres Mejia
 */
class CustomerOccupationalInvestigationAlWitnessController extends BaseController {
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlWitnessDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerOccupationalInvestigationAlWitnessDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerOccupationalInvestigationAlWitness::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlWitnessDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerOccupationalInvestigationAlWitnessDocumentDTO::parse($model);
