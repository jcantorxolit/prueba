...
use Wgroup\CustomerOccupationalInvestigationAl\CustomerOccupationalInvestigationAl;
use Wgroup\CustomerOccupationalInvestigationAl\CustomerOccupationalInvestigationAlDTO;
use Wgroup\CustomerOccupationalInvestigationAl\CustomerOccupationalInvestigationAlService;
 ...
 * @author Andres Mejia
 */
class CustomerOccupationalInvestigationAlController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerOccupationalInvestigationAlService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // Counts
            $recordCount = $this->service->getCount("", $customerId);
            $recordCountFilter = $this->service->getCount(@$search['value'], $customerId);

            // extract info
            $result = CustomerOccupationalInvestigationAlDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerOccupationalInvestigationAlDTO::parse($model);
    ...
    public function saveCustomer()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndSaveCustomerModel($info);
    ...
    public function saveEmployee()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndSaveEmployeeModel($info);
    ...
    public function saveAccident()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndSaveAccidentModel($info);
    ...
    public function saveSummary()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndSaveSummaryModel($info);
    ...
    public function saveEvent()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndSaveEventModel($info);
    ...
    public function saveAnalysis()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndSaveAnalysisModel($info);
    ...
    public function update()
    {
        ...
        try {
            ...
            $model = CustomerOccupationalInvestigationAlDTO::fillAndUpdateModel($info);
    ...
    public function get()
    {
        ...
        try {
            ...
            if (!($model = CustomerOccupationalInvestigationAl::find($id))) {
                throw new \Exception("CustomerOccupationalInvestigationAl not found", 404);
            }
    ...
    public function upload()
    {
        ...
        try {
            ...
            //Log::info("CustomerOccupationalInvestigationAl [" . $id . "]s::");

            $model = CustomerOccupationalInvestigationAl::find($id);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerOccupationalInvestigationAl::find($id))) {
                throw new Exception("CustomerOccupationalInvestigationAl not found to delete.");
            }
    ...
    public function download()
    {
        ...
        try {
            ...
            //$pdf = SnappyPdf::loadView("aden.pdf::html.letter", $data)->setPaper('legal')->setOrientation('portrait')->setWarnings(false);
