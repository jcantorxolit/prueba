...
use Wgroup\CertificateGradeParticipantDocument\CertificateGradeParticipantDocumentDTO;
use Wgroup\CertificateGradeParticipantDocument\CertificateGradeParticipantDocumentService;
 ...
 * @author Andres Mejia
 */
class CertificateGradeParticipantDocumentController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CertificateGradeParticipantDocumentService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CertificateGradeParticipantDocumentDTO::parse($data, "2");
    ...
    public function users(){
        ...
        try {
            ...
            // extract info
            $result = CertificateGradeParticipantDocumentDTO::parse($data, "3");
    ...
    public function save() {
        ...
        try {
            ...
            $model = CertificateGradeParticipantDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CertificateGradeParticipantDocumentDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CertificateGradeParticipantDocument::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CertificateGradeParticipantDocument::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CertificateGradeParticipantDocument::find($customer))) {
