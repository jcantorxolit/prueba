...
use Wgroup\CustomerHealthDamageQualificationSourceJusticeDetail\CustomerHealthDamageQualificationSourceJusticeDetail;
use Wgroup\CustomerHealthDamageQualificationSourceJusticeDetail\CustomerHealthDamageQualificationSourceJusticeDetailDTO;
use Wgroup\CustomerHealthDamageQualificationSourceJusticeDetail\CustomerHealthDamageQualificationSourceJusticeDetailService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationSourceJusticeDetailController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageQualificationSourceJusticeDetailService();
    ...
    public function index()
    {
        ...
        $customerHealthDamageId = $this->request->get("customer_health_damage_national_id", "0");
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationSourceJusticeDetailDTO::parse($data);
    ...
    public function first()
    {
        ...
        $operation = $this->request->get("operation", "all");
        $customerHealthDamageId = $this->request->get("customer_health_damage_justiceFirst_id", "0");
        $data = $this->request->get("data", "");
    ...
    public function second()
    {
        ...
        $operation = $this->request->get("operation", "all");
        $customerHealthDamageId = $this->request->get("customer_health_damage_justiceSecond_id", "0");
        $data = $this->request->get("data", "");
    ...
    public function third()
    {
        ...
        $operation = $this->request->get("operation", "all");
        $customerHealthDamageId = $this->request->get("customer_health_damage_justiceThird_id", "0");
        $data = $this->request->get("data", "");
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceJusticeDetailDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceJusticeDetailDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationSourceJusticeDetail::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationSourceJusticeDetailDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationSourceJusticeDetailDocumentDTO::parse($model);
