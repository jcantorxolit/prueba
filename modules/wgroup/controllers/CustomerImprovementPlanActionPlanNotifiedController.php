...
use Wgroup\CustomerImprovementPlanActionPlanNotified\CustomerImprovementPlanActionPlanNotifiedService;
 ...
 * @author Andres Mejia
 */
class CustomerImprovementPlanActionPlanNotifiedController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerImprovementPlanActionPlanNotifiedService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerImprovementPlanActionPlanNotifiedDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanActionPlanNotifiedDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerImprovementPlanActionPlanNotifiedDTO::parse($model);
    ...
    public function update()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanActionPlanNotifiedDTO::updateModel($info);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerImprovementPlanActionPlanNotified::find($id))) {
    ...
    public function getEntity()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanActionPlanNotified::where('entityId', $entityId)->where('entityName', $entityName)->first();
