 ...
 * @author Andres Mejia
 */
class QuoteServiceController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new QuoteServiceService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = QuoteServiceDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $result = QuoteServiceDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = QuoteDetail::find($traking))) {
