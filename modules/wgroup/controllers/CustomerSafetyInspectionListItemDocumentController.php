...
use Wgroup\CustomerSafetyInspectionListItemDocument\CustomerSafetyInspectionListItemDocument;
use Wgroup\CustomerSafetyInspectionListItemDocument\CustomerSafetyInspectionListItemDocumentDTO;
use Wgroup\CustomerSafetyInspectionListItemDocument\CustomerSafetyInspectionListItemDocumentService;
 ...
 * @author Andres Mejia
 */
class CustomerSafetyInspectionListItemDocumentController extends BaseController {
    ...
    public function index(){
        ...
        $safetyInspectionListItemId = $this->request->get("safetyInspectionListItemId", "0");
        ...
        try {
            ...
            $data = $this->service->getAllByPermission(@$search['value'], $length, $currentPage, $orders, "", $safetyInspectionListItemId);

            //$data = array();

            //Log::info("Despues de");
            // Counts
            $recordsTotal = $this->service->getCount("", $safetyInspectionListItemId);
            //$recordsFiltered = $this->service->getCount(@$search['value'], $customerId);

            // extract info
            $result = CustomerSafetyInspectionListItemDocumentDTO::parse($data, "2");
    ...
    public function users(){
        ...
        try {
            ...
            // extract info
            $result = CustomerSafetyInspectionListItemDocumentDTO::parse($data, "3");
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerSafetyInspectionListItemDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerSafetyInspectionListItemDocumentDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerSafetyInspectionListItemDocument::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerSafetyInspectionListItemDocument::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerSafetyInspectionListItemDocument::find($customer))) {
