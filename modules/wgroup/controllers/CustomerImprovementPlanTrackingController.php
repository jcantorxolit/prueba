...
use Wgroup\CustomerImprovementPlanTracking\CustomerImprovementPlanTrackingService;
 ...
 * @author Andres Mejia
 */
class CustomerImprovementPlanTrackingController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new CustomerImprovementPlanTrackingService();
    ...
    public function index()
    {
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, $orders, $customerImprovementPlanId);
            $recordsTotal = $this->service->getCount("", $customerImprovementPlanId);
            $recordsFiltered = $this->service->getCount(@$search['value'], $customerImprovementPlanId);

            // extract info
            $result = CustomerImprovementPlanTrackingDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanTrackingDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerImprovementPlanTrackingDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerImprovementPlanTracking::find($id))) {
    ...
    public function getEntity()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanTracking::where('entityId', $entityId)->where('entityName', $entityName)->first();
