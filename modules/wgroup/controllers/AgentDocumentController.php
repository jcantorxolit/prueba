...
use Wgroup\Classes\ServiceAgentDocument;
use Wgroup\Models\AgentDocument;
use Wgroup\Models\AgentDocumentDTO;
 ...
 * @author Andres Mejia
 */
class AgentDocumentController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new ServiceAgentDocument();
    ...
    public function index()
    {
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, $orders, "", $agentId, $hideCanceled);

            // Counts
            $recordsTotal = $this->service->getCount("", $agentId, $hideCanceled);
            $recordsFiltered = $this->service->getCount(@$search['value'], $agentId, $hideCanceled);

            // extract info
            $result = AgentDocumentDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = AgentDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = AgentDocumentDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = AgentDocument::find($document);
    ...
    public function get()
    {
        ...
        try {
            ...
            if (!($model = AgentDocument::find($id))) {
