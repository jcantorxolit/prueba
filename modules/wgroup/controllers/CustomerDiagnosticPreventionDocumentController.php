...
use Wgroup\CustomerDiagnosticPreventionDocument\CustomerDiagnosticPreventionDocument;
use Wgroup\CustomerDiagnosticPreventionDocument\CustomerDiagnosticPreventionDocumentDTO;
use Wgroup\CustomerDiagnosticPreventionDocument\CustomerDiagnosticPreventionDocumentService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerDiagnosticPreventionDocumentController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerDiagnosticPreventionDocumentService();
    ...
    public function index(){
        ...
        try {
            ...
            $data = $this->service->getAllBySearch(@$search['value'], $length, $currentPage, $orders, "", $customerId);
            ...
            // extract info
            $result = CustomerDiagnosticPreventionDocumentDTO::parse($data, "2");
    ...
    public function filterQuestion(){
        ...
        $itemsPerPage = Parameters::get('system::tables.rowsperpage', 15);
        $customerId = $this->request->get("customer_id", "0");
        $questionId = $this->request->get("question_id", "0");
        ...
        try {
            ...
            // get all tracking by customer with pagination
            $data = $this->service->getAllBySearchQuestion(@$search['value'], $length, $currentPage, $orders, "", $customerId, $questionId);

            // Counts
            $recordsTotal = $this->service->getQuestionCount("", $customerId, $questionId);
            $recordsFiltered = $this->service->getQuestionCount(@$search['value'], $customerId, $questionId);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerDiagnosticPreventionDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerDiagnosticPreventionDocumentDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerDiagnosticPreventionDocument::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerDiagnosticPreventionDocument::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerDiagnosticPreventionDocument::find($customer))) {
