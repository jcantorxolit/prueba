...
use Wgroup\CustomerHealthDamageQualificationLostOpportunityDiagnostic\CustomerHealthDamageQualificationLostOpportunityDiagnosticService;
 ...
 * @author Andres Mejia
 */
class CustomerHealthDamageQualificationLostOpportunityDiagnosticController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerHealthDamageQualificationLostOpportunityDiagnosticService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageQualificationLostOpportunityDiagnosticDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostOpportunityDiagnosticDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostOpportunityDiagnosticDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationLostOpportunityDiagnostic::find($id))) {
    ...
    public function upload() {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostOpportunityDiagnosticDocumentDTO ::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostOpportunityDiagnosticDocumentDTO::parse($model);
