...
use Wgroup\CustomerHealthDamageRestrictionDetail\CustomerHealthDamageRestrictionDetail;
use Wgroup\CustomerHealthDamageRestrictionDetail\CustomerHealthDamageRestrictionDetailDTO;
use Wgroup\CustomerHealthDamageRestrictionDetail\CustomerHealthDamageRestrictionDetailService;
...
class CustomerHealthDamageRestrictionDetailController extends BaseController {
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = CustomerHealthDamageRestrictionDetailDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerHealthDamageRestrictionDetailDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageRestrictionDetailDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageRestrictionDetail::find($id))) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerHealthDamageRestrictionDetail::find($document);
