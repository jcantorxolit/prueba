...
use Wgroup\CustomerImprovementPlanAlert\CustomerImprovementPlanAlertService;
 ...
 * @author Andres Mejia
 */
class CustomerImprovementPlanAlertController extends BaseController
{
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerImprovementPlanAlertDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerImprovementPlanAlertDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerImprovementPlanAlert::find($id))) {
