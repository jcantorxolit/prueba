...
use Wgroup\CustomerAbsenteeismDisabilityDocument\CustomerAbsenteeismDisabilityDocumentService;
 ...
 * @author Andres Mejia
 */
class CustomerAbsenteeismDisabilityDocumentController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerAbsenteeismDisabilityDocumentService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerAbsenteeismDisabilityDocumentDTO::parse($data, "2");
    ...
    public function users(){
        ...
        try {
            ...
            // extract info
            $result = CustomerAbsenteeismDisabilityDocumentDTO::parse($data, "3");
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerAbsenteeismDisabilityDocument::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerAbsenteeismDisabilityDocument::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerAbsenteeismDisabilityDocument::find($customer))) {
