...
use Wgroup\CertificateGradeCalendar\CertificateGradeCalendarService;
 ...
 * @author Andres Mejia
 */
class CertificateGradeCalendarController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CertificateGradeCalendarService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CertificateGradeCalendarDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CertificateGradeCalendarDTO::fillAndSaveModel($info);

            $result = CertificateGradeCalendarDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CertificateGradeCalendar::find($id))) {
    ...
    public function generateCertificate()
    {
        ...
        try {
            ...
            if (!($model = CertificateGradeCalendar::find($id))) {
                throw new Exception("CertificateGradeCalendar not found to delete.");
            }
...
*/
    ...
    public function export()
    {
        ...
        try {
            ...
            $model = CertificateGradeCalendarDTO::find($id);
