...
use Wgroup\ProgramPreventionDocument\ProgramPreventionDocument;
use Wgroup\ProgramPreventionDocument\ProgramPreventionDocumentDTO;
use Wgroup\ProgramPreventionDocument\ProgramPreventionDocumentService;
use Excel;
 ...
 * @author Andres Mejia
 */
class ProgramPreventionDocumentController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new ProgramPreventionDocumentService();
    ...
    public function index(){
        ...
        try {
            ...
            $data = $this->service->getAllBySearch(@$search['value'], $length, $currentPage, $orders, "");
            ...
            // extract info
            $result = ProgramPreventionDocumentDTO::parse($data, "2");
    ...
    public function filterQuestion(){
        ...
        try {
            ...
            // get all tracking by customer with pagination
            $data = $this->service->getAllBySearchQuestion(@$search['value'], $length, $currentPage, $orders, "", $questionId);

            // Counts
            $recordsTotal = $this->service->getQuestionCount("", $questionId);
            $recordsFiltered = $this->service->getQuestionCount(@$search['value'], $questionId);
    ...
    public function save() {
        ...
        try {
            ...
            $model = ProgramPreventionDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = ProgramPreventionDocumentDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = ProgramPreventionDocument::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = ProgramPreventionDocument::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = ProgramPreventionDocument::find($customer))) {
