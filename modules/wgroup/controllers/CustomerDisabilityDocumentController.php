 ...
 * @author Andres Mejia
 */
class CustomerDisabilityDocumentController extends BaseController {
    ...
    public function index(){
        ...
        try {
            ...
            $data = $this->service->getAllByPermission(@$search['value'], $length, $currentPage, $orders, "", $customerId, $this->user->id);

            //$data = array();

            //Log::info("Despues de");
            // Counts
            $recordsTotal = $this->service->getCount("", $customerId, $this->user->id);
