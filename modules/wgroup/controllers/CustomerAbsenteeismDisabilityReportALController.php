...
use Wgroup\CustomerAbsenteeismDisabilityReportAL\CustomerAbsenteeismDisabilityReportALDTO;
use Wgroup\CustomerAbsenteeismDisabilityReportAL\CustomerAbsenteeismDisabilityReportALService;
 ...
 * @author Andres Mejia
 */
class CustomerAbsenteeismDisabilityReportALController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerAbsenteeismDisabilityReportALService();
    ...
    public function index(){
        ...
        $customerDisabilityId = $this->request->get("disability_id", "0");
        ...
        try {
            ...
            $data = $this->service->getAllById(@$search['value'], $length, $currentPage, $orders, "", $customerDisabilityId);

            $recordsTotal = $this->service->getCount("", $customerDisabilityId);
            $recordsTotalFiltered = $this->service->getCount(@$search['value'], $customerDisabilityId);
            ...
            $this->response->setRecordsFiltered($recordsTotalFiltered);
        } catch (Exception $exc) {
    ...
    public function available(){
        ...
        try {
            ...
            // get all tracking by customer with pagination
            $data = $this->service->getAllByAvailable(@$search['value'], $length, $currentPage, $orders, "", $customerDisabilityId);

            $recordsTotal = $this->service->getAvailableCount("", $customerDisabilityId);
            $recordsTotalFiltered = $this->service->getAvailableCount(@$search['value'], $customerDisabilityId);
    ...
    public function users(){
        ...
        try {
            ...
            // extract info
            $result = CustomerAbsenteeismDisabilityReportALDTO::parse($data, "3");
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerAbsenteeismDisabilityReportALDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerAbsenteeismDisabilityReportALDTO::parse($model);
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerAbsenteeismDisabilityReportAL::find($document);
    ...
    public function get() {
        ...
        try {
            ...
            if (!($model = CustomerAbsenteeismDisabilityReportAL::find($id))) {
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerAbsenteeismDisabilityReportAL::find($customer))) {
