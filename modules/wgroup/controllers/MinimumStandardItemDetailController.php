...
use Wgroup\MinimumStandardItemDetail\MinimumStandardItemDetailService;
 ...
 * @author Andres Mejia
 */
class MinimumStandardItemDetailController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        //set service
        $this->service = new MinimumStandardItemDetailService();
    ...
    public function index()
    {
        ...
        try {
            ...
            // extract info
            $result = MinimumStandardItemDetailDTO::parse($data);
    ...
    public function save()
    {
        ...
        try {
            ...
            //Get data
            $model = MinimumStandardItemDetailDTO::fillAndSaveModel($info);

            $result = MinimumStandardItemDetailDTO::parse($model);
    ...
    public function get()
    {
        ...
        try {
            ...
            if ($id == "0") {
                $result = new MinimumStandardItemDetailDTO();
            } else {
                if (!($model = MinimumStandardItemDetail::find($id))) {
