...
use Wgroup\CustomerHealthDamageQualificationLostDocument\CustomerHealthDamageQualificationLostDocument;
use Wgroup\CustomerHealthDamageQualificationLostDocument\CustomerHealthDamageQualificationLostDocumentDTO;
use Wgroup\CustomerHealthDamageQualificationLostDocument\CustomerHealthDamageQualificationLostDocumentService;
...
class CustomerHealthDamageQualificationLostDocumentController extends BaseController
{
    ...
    public function index()
    {
        ...
        $customerHealthDamageQlId = $this->request->get("customer_health_damage_ql_id", "0");
        ...
        try {
            ...
            $data = $this->service->getAllBy(@$search['value'], $length, $currentPage, array(), $customerHealthDamageQlId, $entityCode, $entityId, $audit);

            // Counts
            //$recordsTotal = $this->service->getCount("", $customerId);
            //$recordsFiltered = $this->service->getCount(@$search['value'], $customerId);

            $recordsTotal = $this->service->getCount("", $customerHealthDamageQlId, $entityCode, $entityId, null);
            $recordsFiltered = $this->service->getCount(@$search['value'], $customerHealthDamageQlId, $entityCode, $entityId, $audit);

            // extract info
            $result = CustomerHealthDamageQualificationLostDocumentDTO::parse($data);
    ...
    public function indexAll()
    {
        ...
        try {
            ...
            // get all tracking by customer with pagination
            //$data = $this->service->getAll(@$search['value'], $length, $currentPage, $orders, "", $customerId);
            $data = $this->service->getAllByHealthDamageQl(@$search['value'], $length, $currentPage, array(), $customerHealthDamageQlId, $audit);

            // Counts
            //$recordsTotal = $this->service->getCount("", $customerId);
            //$recordsFiltered = $this->service->getCount(@$search['value'], $customerId);

            $recordsTotal = $this->service->getCountHealthDamageQl("", $customerHealthDamageQlId, null);
            $recordsFiltered = $this->service->getCountHealthDamageQl(@$search['value'], $customerHealthDamageQlId, $audit);
    ...
    public function save()
    {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostDocumentDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerHealthDamageQualificationLostDocumentDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerHealthDamageQualificationLostDocument::find($id))) {
    ...
    public function upload()
    {
        ...
        try {
            ...
            $model = CustomerHealthDamageQualificationLostDocument::find($document);
    ...
    public function downloadAll()
    {
        ...
        try {
            ...
            // $documents = CustomerHealthDamageQualificationLostDocument::whereCustomerHealthDamageQualificationLostId($id)->get();
            ...
            // $fileToDownload = "Anexos_Calificacion_Perdida" . $id . ".zip";
            ...
            //     $result = CustomerHealthDamageQualificationLostDocumentDTO::parse($document);
