...
use Wgroup\ProjectTaskType\ProjectTaskType;
use Wgroup\ProjectTaskType\ProjectTaskTypeDTO;
use Wgroup\ProjectTaskType\ProjectTaskTypeService;
 ...
 * @author Andres Mejia
 */
class ProjectTaskTypeController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new ProjectTaskTypeService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = ProjectTaskTypeDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = ProjectTaskTypeDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = ProjectTaskTypeDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = ProjectTaskType::find($id))) {
