...
use Wgroup\CustomerSafetyInspectionConfigListValidation\CustomerSafetyInspectionConfigListValidationService;
use Excel;
 ...
 * @author Andres Mejia
 */
class CustomerSafetyInspectionConfigListValidationController extends BaseController {
    ...
    public function __construct() {
        ...
        //set service
        $this->service = new CustomerSafetyInspectionConfigListValidationService();
    ...
    public function index(){
        ...
        try {
            ...
            // extract info
            $result = CustomerSafetyInspectionConfigListValidationDTO::parse($data);
    ...
    public function save() {
        ...
        try {
            ...
            $model = CustomerSafetyInspectionConfigListValidationDTO::fillAndSaveModel($info);

            // Parse to send on response
            $result = CustomerSafetyInspectionConfigListValidationDTO::parse($model);
    ...
    public function delete()
    {
        ...
        try {
            ...
            if (!($model = CustomerSafetyInspectionConfigListValidation::find($id))) {
