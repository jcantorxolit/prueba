 ...
 * Idea Model
 */
class customerContractDetailActionPlanRespTask extends Model
{

    /**
     * @var string The database table used by the model.
     */
    public $table = 'wg_customer_contract_detail_action_plan_resp_task';
    ...
    public $hasMany = [
        'tracking' => ['Wgroup\customerContractDetailActionPlanRespTask\customerContractDetailActionPlanRespTaskTracking'],
    ];
