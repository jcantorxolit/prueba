 ...
 * @author TeamCloud
 */
class ImprovementPlanCauseRepository
{
    ...
    protected $columns = array('wg_improvement_plan_cause.*');
    ...
    public function __construct(ImprovementPlanCause $model)
    {
        $this->model = $model;
    }
    ...
    {
        $query = $this->query();
        $query->select(['wg_improvement_plan_cause.*']);
