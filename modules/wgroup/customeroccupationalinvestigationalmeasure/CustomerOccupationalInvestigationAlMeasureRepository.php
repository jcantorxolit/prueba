 ...
 * @author TeamCloud
 */
class CustomerOccupationalInvestigationAlMeasureRepository
{
    ...
    protected $columns = array('wg_customer_occupational_investigation_al_measure.*');
    ...
    public function __construct(CustomerOccupationalInvestigationAlMeasure $model)
    {
        $this->model = $model;
    }
    ...
    {
        $query = $this->query();
        $query->select(['wg_customer_occupational_investigation_al_measure.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "")
    {
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_customer_occupational_investigation_al_measure.customer_occupational_investigation_id") {
