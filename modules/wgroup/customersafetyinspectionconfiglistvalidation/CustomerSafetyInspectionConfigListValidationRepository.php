 ...
 * @author TeamCloud
 */
class CustomerSafetyInspectionConfigListValidationRepository {
    ...
    protected $columns = array('wg_customer_safety_inspection_config_list_validation.*');
    ...
    public function __construct(CustomerSafetyInspectionConfigListValidation $model) {
        $this->model = $model;
    }
    ...
    public function getFiltereds($filter = array(), $join = "", $count = false) {
        $query = $this->query();
        $query->select(['wg_customer_safety_inspection_config_list_validation.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "") {
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_customer_safety_inspection_config_list_validation.customer_safety_inspection_config_list_id") {
