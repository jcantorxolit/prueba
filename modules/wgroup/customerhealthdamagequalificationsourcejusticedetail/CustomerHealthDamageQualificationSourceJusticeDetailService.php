...
class CustomerHealthDamageQualificationSourceJusticeDetailService
{
    ...
    public function getAllBy($search, $perPage = 10, $currentPage = 0, $sorting = array(), $customerHealthDamageId = 0)
    {
        ...
        $this->customerContractorRepository = new CustomerHealthDamageQualificationSourceJusticeDetailRepository($model);
        ...
        // sorting
        $columns = [
            'wg_customer_health_damage_qs_labor_justice_detail.id',
            'wg_customer_health_damage_qs_labor_justice_detail.diagnostic',
            'wg_customer_health_damage_qs_labor_justice_detail.qualifiedOrigin',
            'wg_customer_health_damage_qs_labor_justice_detail.controversyStatus',
        ];
        ...
        if (empty($sorting)) {
            $this->customerContractorRepository->sortBy('wg_customer_health_damage_qs_labor_justice_detail.id', 'desc');
        }

        $filters = array();

        $filters[] = array('wg_customer_health_damage_qs_labor_justice_detail.customer_health_damage_qs_labor_justice_id', $customerHealthDamageId);
        ...
        $this->customerContractorRepository->setColumns(['wg_customer_health_damage_qs_labor_justice_detail.*']);
