 ...
 * @author TeamCloud
 */
class CustomerMatrixEnvironmentalAspectImpactRepository
{
    ...
    protected $columns = array('wg_customer_matrix_environmental_aspect_impact.*');
    ...
    public function __construct(CustomerMatrixEnvironmentalAspectImpact $model)
    {
        $this->model = $model;
    }
    ...
    {
        $query = $this->query();
        $query->select(['wg_customer_matrix_environmental_aspect_impact.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "")
    {
        ...
        $query->join("wg_customer_matrix_environmental_impact", "wg_customer_matrix_environmental_impact.id", "=", "wg_customer_matrix_environmental_aspect_impact.customer_matrix_environmental_impact_id");
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_customer_matrix_environmental_aspect_impact.customer_matrix_environmental_aspect_id") {
