 ...
 * @author TeamCloud
 */
class CustomerUserSkillRepository {
    ...
    protected $columns = array('wg_customer_user.*');
    ...
    public function __construct(CustomerUserSkill $model) {
        $this->model = $model;
    }
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "") {
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_customer_user.customer_id") {
