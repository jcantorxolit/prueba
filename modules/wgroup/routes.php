...
App::before(function($request) {
    ...
    //         if (!$page || $isangular) {
    //             //Log::info("is angular or not exist page");
    ...
    Route::group(['prefix' => "api"], function() {
        ...
        Route::post('customer-employee-validity/delete', 'Wgroup\Controllers\CustomerEmployeeController@delete');
