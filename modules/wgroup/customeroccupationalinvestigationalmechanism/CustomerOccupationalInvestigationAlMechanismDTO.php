 ...
 * @author jdblandon
 */
class CustomerOccupationalInvestigationAlMechanismDTO {
    ...
    public static function  bulkInsert($object, $entityId)
    {
        ...
        try {
            foreach ($object as $record) {
                ...
                if ($record) {
                    if ($record->id) {
                        if (!($model = CustomerOccupationalInvestigationAlMechanism::find($record->id))) {
                            $isEdit = false;
                            $model = new CustomerOccupationalInvestigationAlMechanism();
                        } else {
                            if (!$record->isActive) {
                                $model->delete();
                            }
        ...
        return CustomerOccupationalInvestigationAlMechanism::find($model->id);
    }
