 ...
 * @author TeamCloud
 */
class CustomerSafetyInspectionListRepository {
    ...
    protected $columns = array('wg_customer_safety_inspection_list.*');
    ...
    public function __construct(CustomerSafetyInspectionList $model) {
        $this->model = $model;
    }
    ...
    public function getFiltereds($filter = array(), $join = "", $count = false) {
        $query = $this->query();
        $query->select(['wg_customer_safety_inspection_list.*']);
    ...
    public function getFilteredsOptional($filter = array(), $isCount = false, $join = "") {
        ...
        foreach ($filter as $key => $item) {
            try {
                ...
                if ($field == "wg_customer_safety_inspection_list.customer_safety_inspection_config_list_id") {
