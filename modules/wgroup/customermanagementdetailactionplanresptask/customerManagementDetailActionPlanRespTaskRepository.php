...
namespace Wgroup\customerManagementDetailActionPlanRespTask;
 ...
 * @author TeamCloud
 */
class customerManagementDetailActionPlanRespTaskRepository {
    ...
    public function __construct(customerManagementDetailActionPlanRespTask $model) {
        $this->model = $model;
    }
