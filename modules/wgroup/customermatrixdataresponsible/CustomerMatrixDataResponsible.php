 ...
 * Idea Model
 */
class CustomerMatrixDataResponsible extends Model
{

    /**
     * @var string The database table used by the model.
     */
    public $table = 'wg_customer_matrix_data_responsible';
    ...
    {
        return $this->getParameterByValue($this->responsible, 'matrix_responsible');
    }
